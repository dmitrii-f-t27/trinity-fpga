...
pub const templates = [_]Template{
    ...
    .{
        ...
        \\
        \\Implementation in Zig with FPGA backend: ~34 tok/s measured at 50 MHz on $30 XC7A100T (power not measured). Zero DSP usage.
        \\
    ...
    .{
        ...
        \\
        \\Our results:
        \\• ~34 tok/s measured at 50 MHz on $30 XC7A100T (power not measured)
    ...
    .{
        ...
        \\
        \\Results:
        \\• ~34 tok/s measured at 50 MHz (QMTech XC7A100T); power not measured
        \\• 0% DSP usage, 19.6% LUT
