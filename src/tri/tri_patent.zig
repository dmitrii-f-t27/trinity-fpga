...
fn showAnalysis() void {
    ...
    print("  {s}Zenodo{s}: 63 tok/s @ 92 MHz, ~1W (since qualified: ~34 tok/s measured @ 50 MHz, power not measured), 16 tokens autoregressive (seed=42)\n", .{ CYAN, RESET });
...
fn showZenodo() void {
    ...
    print("    Speed:    63 tok/s @ 92 MHz, ~1W (since qualified: 92 MHz projection; ~34 tok/s measured @ 50 MHz; power not measured)\n", .{});
