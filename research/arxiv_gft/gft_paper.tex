...
\emph{behaves} as having, measured band by band, recovers the declared width to
$0.01$ bits for every fixed-field format we tried and exposes tapering as a slope
--- posit16 sheds $0.254$ bits of significand per binade, takum16 $0.113$.
...
per binade ($R^2 = 0.999$) and takum16 sheds $0.113$ ($R^2 = 0.86$): over the
thirty binades of this sweep, $7.6$ and $3.4$ bits respectively. That is the
