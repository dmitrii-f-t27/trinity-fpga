...
\begin{table}[t]\centering
\caption{Accuracy across the rungs the metric can resolve, after the oracle fix
of Section~\ref{sec:limits}. GF-T32's figure is what 25 mantissa bits should
give; before the fix the same measurement returned $5.4\mathrm{e}{-1}$.}
\label{tab:rungacc}
\begin{tabular}{lrrr}
\toprule
rung & $|e|<8$ & $|e|\,8$--$20$ & $|e|\,20$--$38$ \\
\midrule
GF-T16 & $3.54\mathrm{e}{-4}$ & $3.55\mathrm{e}{-4}$ & $3.55\mathrm{e}{-4}$ \\
GF-T32 & $5.35\mathrm{e}{-9}$ & $5.47\mathrm{e}{-9}$ & $5.33\mathrm{e}{-9}$ \\
\bottomrule
\end{tabular}
\end{table}
