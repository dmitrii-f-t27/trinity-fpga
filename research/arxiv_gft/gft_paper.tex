...
no DSP. The round-trip column is decode plus encode.}
...
\midrule
unary, $\ell \propto |e|$ (posit)          & $403$ & $36.8$\,MHz  & $83$  & $211.2$\,MHz & $486$ \\
$\ell \propto \log_2|e|$ (takum)           & $\mathbf{30}$ & $\mathbf{805.8}$\,MHz & $\mathbf{58}$ & $\mathbf{285.1}$\,MHz & $\mathbf{88}$ \\
$\ell = \lceil\sqrt{|e|}\rceil$            & $417$ & $33.1$\,MHz  & $147$ & $96.4$\,MHz  & $564$ \\
\midrule
...
building. It is not: it costs $16\%$ more than the unary regime round trip, and
...
asymptotically optimal by Theorem~\ref{thm:floor}, $5.5\times$ smaller round trip,
...
costs $88$ LUTs at best and $486$ at worst on this device, against $0$ for a
format that declines it. This is the cost GF-T does not pay, and it is separate
from --- and larger than --- the accuracy advantage of
