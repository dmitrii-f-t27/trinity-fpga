...
catalogued format sits, and a regime spending one trit per tripling of $|e|$ ---
$\ell(e) \propto \log_3|e|$, natural on the fabric GF-T targets --- would occupy
it. We have not built one, and note it as the obvious next construction rather
than as a result.
