...
\emph{when formats fail}. We present the first systematic robustness
...
BF16 fails matrix multiply (10$\times$ worse max error). A training
...
typically 15--30\%. The scaling law ($1.55W^2$, $2.06W^2$) should hold
