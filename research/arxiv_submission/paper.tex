...
256+ & --- & --- & \multicolumn{3}{l}{estimated from 1.55W$^2$, exceeds FPGA} \\
\bottomrule
\end{tabular}
\end{table}

The scaling law ADD = 1.55W$^2$ (R$^2$=0.88) and MUL = 2.06W$^2$ (R$^2$=0.97)
hold across 4 orders of magnitude (W=4 to W=128, 15 measured points for ADD, 10
for MUL). GF128 (14,894 LUT ADD) is the largest format that fits comfortably on
