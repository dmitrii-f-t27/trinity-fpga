...
\item \textbf{A hardware-cost characterization.} The LUT cost of
  floating-point arithmetic follows $cW^2$ ($c_{\text{ADD}}{=}1.55$,
  $c_{\text{MUL}}{=}2.06$), verified across 15 measured widths
  ($W{=}4$--$128$, $R^2{\geq}0.88$). A native takum16 LNS multiplier
