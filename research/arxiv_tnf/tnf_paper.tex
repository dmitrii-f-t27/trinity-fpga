...
log-uniform workload over the visited span the uncovered share is
$1 - \log_3(b'+1)/\log_3(b+1)$, and every value in it overflows. The first branch
grows like $\log_3$ of the range ratio, the second is a share of the span and is
bounded by $1$ however large the shortfall, so a fixed additional cost buys
...
\log_3 2 = 0.3314$ positions of accuracy net of the range it returns, where
...
terms of Fibonacci number systems~\cite{hetenyi2026fibonacci} --- which is worth
