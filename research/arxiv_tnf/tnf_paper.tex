...
Every comparison of number formats we have read reports a verdict or a ratio. For
two of the four forms that shape is wrong. The form of the answer is not a
stylistic choice; it is fixed by the competitor's staircase, and a classification
introduced only to label formats turns out to settle it.
