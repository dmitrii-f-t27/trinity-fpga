...
\title{Ternary Network Floats: a fixed-field ladder with no regime to decode \\
...
(TNF), a ladder built for that role: the exponent is a balanced-ternary integer of
...
$0.82$ mantissa bits. The first exceeds TNF16's entire mantissa; the second is
...
the exponential. TNF's exponent path is wires. Theorem~\ref{thm:valuelaw} makes
...
regime is asymptotically optimal and nothing, TNF included, beats it beyond its
own range. Inside TNF16's range it is $3.70\times$ and $11.21\times$ more accurate
...
LUTs at $161.1$, $153.2$, $131.7$, $83.3$ and $48.2$\,MHz for TNF4 through
TNF64, one cycle of latency, no DSP blocks.
...
area for TNF64 that came in $1.57\times$ low, and each is retracted in place.
...
range and the side of the dichotomy, and the format is determined. TNF is what
