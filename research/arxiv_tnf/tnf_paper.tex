...
$\varphi$ is optimal at a budget, not everywhere. At four bits $\varphi$ and
supergolden differ by $2.7\%$ over twelve windows, which this measurement cannot
separate; the accurate statement is that they tie and supergolden costs a
register. One bit up, the plastic number wins by $28\%$.
