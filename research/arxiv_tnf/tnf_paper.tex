...
\subsection{Fineness costs registers, not adders}\label{sec:oneadder}
...
five, $1.110187$ against $1.110180$ at six. At eight bits the spectrum has a gap
and the optimum falls in it, but eight bits is four more than the range needs.
