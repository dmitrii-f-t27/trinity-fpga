...
| the takum oracle was cross-validated against **libtakum**, the format author's own C99 reference | exhaustive over all 65,536 takum16 codes, re-run 2026-08-03 against a freshly cloned and built libtakum | `takum_libtakum_crossval.t27`. **Positive half 32,768/32,768 EXACT; negative half diverges — 32,766 of 65,536 codes.** Reproduced today, matching the spec exactly, with the example divergence verbatim: `raw 32769 → oracle −1.8351858179575695e−77, libtakum −5.608679322432503e+76`. The retraction in `ARXIV_V2_CORRECTION_PACKAGE.md`, and its figure of *60485/60485*, are **not supported by measurement**. |
