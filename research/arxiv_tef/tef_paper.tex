...
own range. Inside TEF16's range it is $3.70\times$ and $11.37\times$ more accurate
...
$\mathbf{E_t{=}4}$, $\mathbf{M{=}11}$ (adopted) & $\mathbf{16}$ & $\mathbf{8.63\mathrm{e}{-5}}$ & $24$ & $\mathbf{22.28\times}$ \\
...
$3.70\times / 11.37\times / 22.28\times$, no longer losing the near bin. In
...
\item \textbf{Four of nine rungs are measured in hardware.} TEF4 through TEF32 fit the
device; TEF64 and TEF128 are within reach of a larger part and TEF256 upwards
