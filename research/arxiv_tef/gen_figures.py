...
# TEF16 at M = 9 and the label "tekum16" long after the rung moved to M = 11 and
...
_tef = T.TEFFormat(4, 11)          # M = 11 as adopted; see t27#2005
...
ax.bar(x,     tef,  w, label="TEF16 (M=11)", color="#0a7a4c")
...
print("tef_accuracy.pdf  ratios:", " ".join(f"{t/g:.2f}x" for g, t in zip(tef, tak)))

# ── 2. the ladder: area and frequency ───────────────────────────────────────
rungs = ["TEF4", "TEF8", "TEF16", "TEF32", "TEF64"]
