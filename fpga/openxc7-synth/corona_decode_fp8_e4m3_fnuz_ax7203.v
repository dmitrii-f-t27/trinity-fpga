...
`timescale 1ns / 1ps
// corona_decode_fp8_e4m3_fnuz_ax7203 — FP8 E4M3 FNUZ (AMD MI300 / CDNA3) decode on AX7203.
// FP8 E4M3 = 1S+4E+3M, bias=8, no inf. Uses mxfp8_e4m3_decode (identical encoding).
// Frame: AA 55 fmt code_lo code_hi trig -> A5 r0 r1 r2 r3 (32-bit decoded LE).
module corona_decode_fp8_e4m3_fnuz_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero, is_nan;
    fp8_e4m3_fnuz_decode u_dec (.e4m3_in(code_r[7:0]), .fp32_out(result),
