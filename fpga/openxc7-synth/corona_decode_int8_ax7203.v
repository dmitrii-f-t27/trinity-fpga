...
`timescale 1ns / 1ps
// corona_decode_int8_ax7203 — single-decoder (int8) decode-conformance on AX7203.
// Same frame/response as corona_decode_bf16 (corona_decode_host --fmt 2 compatible).
module corona_decode_int8_ax7203 (
