...
`timescale 1ns / 1ps
// corona_compute_gf24_mul_ax7203 — GoldenFloat24 MUL on AX7203.
// GF24: [S:1][E:9][M:14] = 24 bits, BIAS=255, HAS_INF=0.
module corona_compute_gf24_mul_ax7203 (
    ...
    wire comp_in_ready, comp_out_valid; wire [23:0] comp_result;
    gf_mul_param #(.EXP_BITS(9), .MANT_BITS(14), .HAS_INF(0)) u_comp (
        .clk(mclk), .rst(rst),
