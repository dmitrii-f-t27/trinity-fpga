...
`timescale 1ns / 1ps
// corona_compute_fp98_e5m92_fma_ax7203 — FP98_E5M92 FMA on AX7203.
module corona_compute_fp98_e5m92_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 92'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 92'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 97'b0};
