...
`timescale 1ns / 1ps
// corona_compute_fp115_e8m106_to_fp32_ax7203 — FP115_E8M106 TO_FP32 on AX7203.
module corona_compute_fp115_e8m106_to_fp32_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [114:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd17: begin a_r[114:112]<=rx_byte;frm<=5'd18; end
    ...
    reg [114:0] a_reg; reg conv_trigger;
    wire [114:0] fmt_a = a_reg;
