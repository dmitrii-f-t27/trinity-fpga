...
`timescale 1ns / 1ps
// corona_compute_binary128_fma_ax7203 — BINARY128 FMA on AX7203.
module corona_compute_binary128_fma_ax7203 (
    ...
    wire b128_sign_c = fmt_c[127];
    wire [14:0] b128_exp_c = fmt_c[126:112];
    wire [111:0] b128_mant_c = fmt_c[111:0];
    wire b128_zero_c = (b128_exp_c == 15'd0) && (b128_mant_c == 112'd0);
    wire b128_nan_c = (b128_exp_c == 15'h7FFF) && (|b128_mant_c);
    wire b128_inf_c = (b128_exp_c == 15'h7FFF) && (b128_mant_c == 112'd0);
    wire signed [15:0] b128_exp32_s_c = $signed({1'b0, b128_exp_c}) - 16'sd16383 + 16'sd127;
    wire [7:0] b128_exp32_c = b128_exp32_s_c[7:0];
