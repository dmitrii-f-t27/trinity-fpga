...
`timescale 1ns / 1ps
// corona_compute_fp125_e8m116_mul_ax7203 — FP125_E8M116 MUL on AX7203.
module corona_compute_fp125_e8m116_mul_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [124:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [124:0] a_reg,b_reg; reg comp_trigger;
