...
module corona_compute_fp127_e8m118_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[126];
    wire [7:0] f_exp_a = fmt_a_a[125:118];
    wire [117:0] f_mant_a = fmt_a_a[117:0];
    ...
    wire f_sign_b = fmt_b_b[126];
    wire [7:0] f_exp_b = fmt_b_b[125:118];
    wire [117:0] f_mant_b = fmt_b_b[117:0];
    ...
    wire f_sign_c = fmt_c_c[126];
    wire [7:0] f_exp_c = fmt_c_c[125:118];
    wire [117:0] f_mant_c = fmt_c_c[117:0];
