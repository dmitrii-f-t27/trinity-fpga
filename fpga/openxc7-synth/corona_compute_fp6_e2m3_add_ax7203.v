...
`timescale 1ns / 1ps
// corona_compute_fp6_e2m3_add_ax7203 — FP6_E2M3 ADD on AX7203.
module corona_compute_fp6_e2m3_add_ax7203 (
    ...
    wire comp_irdy,comp_ovld; wire [5:0] comp_result;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={{26{1'b0}},comp_result};
        end
    end
