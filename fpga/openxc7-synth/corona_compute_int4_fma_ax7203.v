...
`timescale 1ns / 1ps
// corona_compute_int4_fma_ax7203 — INT4 FMA on AX7203.
module corona_compute_int4_fma_ax7203 (
    ...
    wire signed [3:0] sa=a_reg, sb=b_reg, sc=c_reg;
    wire signed [3:0] sr = sa * sb + sc;
    always @(posedge mclk or posedge rst) begin
