...
`timescale 1ns / 1ps
// corona_compute_fp109_e13m95_fma_ax7203 — FP109_E13M95 FMA on AX7203.
module corona_compute_fp109_e13m95_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[107:95];
    ...
    wire [12:0] f_exp_b = fmt_b[107:95];
    ...
    wire [12:0] f_exp_c = fmt_c[107:95];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 95'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 95'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 108'b0};
