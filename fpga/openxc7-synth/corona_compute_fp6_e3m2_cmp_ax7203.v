...
`timescale 1ns / 1ps
// corona_compute_fp6_e3m2_cmp_ax7203 — FP6_E3M2 CMP on AX7203.
module corona_compute_fp6_e3m2_cmp_ax7203 (
    ...
    wire sa=a_reg[5]; wire [2:0] ea=a_reg[4:2]; wire [1:0] ma=a_reg[1:0];
    wire sb=b_reg[5]; wire [2:0] eb=b_reg[4:2]; wire [1:0] mb=b_reg[1:0];
    wire az=(ea==0)&&(ma==0); wire bz=(eb==0)&&(mb==0);
    wire an=(0)&&(ea=={3{1'b1}})&&(ma!=0); wire bn=(0)&&(eb=={3{1'b1}})&&(mb!=0);
    wire [4:0] aa={ea,ma}; wire [4:0] ab={eb,mb};
