...
`timescale 1ns / 1ps
// corona_compute_vax_f_fma_ax7203 — VAX_F FMA on AX7203.
module corona_compute_vax_f_fma_ax7203 (
    ...
    wire [31:0] vax_val_a = fmt_a;
    wire vax_sign_a = vax_val_a[31];
    wire [7:0] vax_exp_a = vax_val_a[30:23];
    wire [22:0] vax_mant_a = vax_val_a[22:0];
    ...
    wire [31:0] vax_val_b = fmt_b;
    wire vax_sign_b = vax_val_b[31];
    wire [7:0] vax_exp_b = vax_val_b[30:23];
    wire [22:0] vax_mant_b = vax_val_b[22:0];
    ...
    wire [31:0] vax_val_c = fmt_c;
    wire vax_sign_c = vax_val_c[31];
    wire [7:0] vax_exp_c = vax_val_c[30:23];
    wire [22:0] vax_mant_c = vax_val_c[22:0];
    wire vax_zero_c = (vax_val_c==32'h0);
    reg [31:0] fp32_c;
    always @(*) begin
        if(vax_zero_c) fp32_c={vax_sign_c, 31'b0};
        else if(vax_exp_c<=8'd1) fp32_c={vax_sign_c,31'b0};
        else fp32_c={vax_sign_c,vax_exp_c-8'd1,vax_mant_c};
    end
    ...
    always @(*) begin
        ...
        else if(q_exp>=8'd254) q_result={q_sign,8'hFF,q_mant};
