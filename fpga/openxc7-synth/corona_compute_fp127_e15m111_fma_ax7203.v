...
`timescale 1ns / 1ps
// corona_compute_fp127_e15m111_fma_ax7203 — FP127_E15M111 FMA on AX7203.
module corona_compute_fp127_e15m111_fma_ax7203 (
    ...
    wire [14:0] f_exp_a = fmt_a[125:111];
    ...
    wire [14:0] f_exp_b = fmt_b[125:111];
    ...
    wire [14:0] f_exp_c = fmt_c[125:111];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 15'd32767, 111'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 15'd32767, 111'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 126'b0};
