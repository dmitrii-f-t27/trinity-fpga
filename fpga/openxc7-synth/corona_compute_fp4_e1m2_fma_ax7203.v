...
`timescale 1ns / 1ps
// corona_compute_fp4_e1m2_fma_ax7203 — FP4_E1M2 FMA on AX7203.
module corona_compute_fp4_e1m2_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_exp >= 8'd128) q_result={q_sign, 1'd1, 2'd0};
