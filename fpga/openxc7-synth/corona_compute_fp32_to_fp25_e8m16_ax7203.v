...
`timescale 1ns / 1ps
// corona_compute_fp32_to_fp25_e8m16_ax7203 — FP25_E8M16 FP32_TO on AX7203.
module corona_compute_fp32_to_fp25_e8m16_ax7203 (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(conv_trigger) result_reg<={7'b0,q_result};
        end
    end
