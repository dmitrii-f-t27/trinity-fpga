...
module corona_compute_fp41_e8m32_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[40];
    wire [7:0] f_exp_a = fmt_a_a[39:32];
    wire [31:0] f_mant_a = fmt_a_a[31:0];
    ...
    wire f_sign_b = fmt_b_b[40];
    wire [7:0] f_exp_b = fmt_b_b[39:32];
    wire [31:0] f_mant_b = fmt_b_b[31:0];
    ...
    wire f_sign_c = fmt_c_c[40];
    wire [7:0] f_exp_c = fmt_c_c[39:32];
    wire [31:0] f_mant_c = fmt_c_c[31:0];
