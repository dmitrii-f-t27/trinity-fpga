...
`timescale 1ns / 1ps
// corona_compute_fp120_e15m104_fma_ax7203 — FP120_E15M104 FMA on AX7203.
module corona_compute_fp120_e15m104_fma_ax7203 (
    ...
    wire [14:0] f_exp_a = fmt_a[118:104];
    ...
    wire [14:0] f_exp_b = fmt_b[118:104];
    ...
    wire [14:0] f_exp_c = fmt_c[118:104];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 15'd32767, 104'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 15'd32767, 104'd0};
