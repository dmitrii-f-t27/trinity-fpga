...
module corona_compute_fp105_e8m96_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[104];
    wire [7:0] f_exp_a = fmt_a_a[103:96];
    wire [95:0] f_mant_a = fmt_a_a[95:0];
    ...
    wire f_sign_b = fmt_b_b[104];
    wire [7:0] f_exp_b = fmt_b_b[103:96];
    wire [95:0] f_mant_b = fmt_b_b[95:0];
    ...
    wire f_sign_c = fmt_c_c[104];
    wire [7:0] f_exp_c = fmt_c_c[103:96];
    wire [95:0] f_mant_c = fmt_c_c[95:0];
