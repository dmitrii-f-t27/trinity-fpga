...
`timescale 1ns / 1ps
// corona_compute_int16_fma_ax7203 — INT16 FMA on AX7203.
module corona_compute_int16_fma_ax7203 (
    ...
    wire signed [15:0] sr = $signed(a_reg) * $signed(b_reg) + $signed(c_reg);
    always @(posedge mclk or posedge rst) begin
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_trigger) result_reg<={{16{1'b0}},sr};
        end
    end
