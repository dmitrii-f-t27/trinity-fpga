...
module corona_compute_fp92_e8m83_mul_ax7203 (
    ...
    wire f_sign_a = fmt_a[91];
    wire [7:0] f_exp_a = fmt_a[90:83];
    wire [82:0] f_mant_a = fmt_a[82:0];
    ...
    wire f_sign_b = fmt_b[91];
    wire [7:0] f_exp_b = fmt_b[90:83];
    wire [82:0] f_mant_b = fmt_b[82:0];
