...
`timescale 1ns / 1ps
// corona_compute_fp61_e9m51_mul_ax7203 — FP61_E9M51 MUL on AX7203.
module corona_compute_fp61_e9m51_mul_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [60:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [60:0] a_reg,b_reg; reg comp_trigger;
