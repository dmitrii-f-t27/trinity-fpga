...
`timescale 1ns / 1ps
// corona_compute_fp32_e5m26_fma_ax7203 — FP32_E5M26 FMA on AX7203.
module corona_compute_fp32_e5m26_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 26'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 26'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 31'b0};
