...
`timescale 1ns / 1ps
// corona_decode_gf_lns_hybrid_ax7203 — IEEE 754 gf_lns_hybrid (half) decode on AX7203.
// gf_lns_hybrid_decode is authored in-repo and EXHAUSTIVELY verified (65536/65536 vs
// the C-library gf_lns_hybrid via struct 'e'). Single-decoder build: CFGMCLK clock,
...
module corona_decode_gf_lns_hybrid_ax7203 (
