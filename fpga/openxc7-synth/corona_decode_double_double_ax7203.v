...
`timescale 1ns / 1ps
// corona_decode_double_double_ax7203 — Bailey/Hida double-double (2x FP64) decode on AX7203.
...
module corona_decode_double_double_ax7203 (
    ...
    wire [31:0] result;
    double_double_decode u_dec (.dd(code_r[127:0]), .fp32_out(result));
    assign led[2] = |result;
