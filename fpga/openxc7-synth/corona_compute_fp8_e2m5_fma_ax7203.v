...
`timescale 1ns / 1ps
// corona_compute_fp8_e2m5_fma_ax7203 — FP8_E2M5 FMA on AX7203.
module corona_compute_fp8_e2m5_fma_ax7203 (
    ...
    wire signed [9:0] f_de_a = $signed({1'b0, f_exp_a}) - 10'sd1 + 10'sd127;
    ...
    wire signed [9:0] f_de_b = $signed({1'b0, f_exp_b}) - 10'sd1 + 10'sd127;
    ...
    wire signed [9:0] f_de_c = $signed({1'b0, f_exp_c}) - 10'sd1 + 10'sd127;
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 2'd3, 5'd0};
        else if(q_exp >= 8'd130) q_result={q_sign, 2'd3, 5'd0};
        else if(q_exp < 8'd127) q_result={q_sign, 7'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 2'b0, q_mant[22:18]};
        else q_result={q_sign, tgt_exp_s[1:0], q_mant[22:18]};
    end
