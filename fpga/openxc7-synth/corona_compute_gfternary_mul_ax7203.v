...
`timescale 1ns / 1ps
// corona_compute_gfternary_mul_ax7203 — GFTERNARY MUL on AX7203.
module corona_compute_gfternary_mul_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [1:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [1:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={30'b0,q_result};
        end
    end
