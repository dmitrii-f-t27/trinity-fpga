...
`timescale 1ns / 1ps
// corona_compute_int8_add_ax7203 — INT8 ADD on AX7203.
module corona_compute_int8_add_ax7203 (
    ...
    wire signed [7:0] sa_reg = a_reg; wire signed [7:0] sb_reg = b_reg;
    wire signed [7:0] sr = sa_reg + sb_reg;
    always @(posedge mclk or posedge rst) begin
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_trigger) result_reg<={{24{1'b0}},sr};
        end
    end
