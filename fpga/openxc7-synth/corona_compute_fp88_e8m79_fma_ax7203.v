...
module corona_compute_fp88_e8m79_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[87];
    wire [7:0] f_exp_a = fmt_a_a[86:79];
    ...
    wire f_sign_b = fmt_b_b[87];
    wire [7:0] f_exp_b = fmt_b_b[86:79];
    ...
    wire f_sign_c = fmt_c_c[87];
    wire [7:0] f_exp_c = fmt_c_c[86:79];
