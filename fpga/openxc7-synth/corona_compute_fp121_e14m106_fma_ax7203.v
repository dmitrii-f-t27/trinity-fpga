...
`timescale 1ns / 1ps
// corona_compute_fp121_e14m106_fma_ax7203 — FP121_E14M106 FMA on AX7203.
module corona_compute_fp121_e14m106_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[119:106];
    ...
    wire [13:0] f_exp_b = fmt_b[119:106];
    ...
    wire [13:0] f_exp_c = fmt_c[119:106];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 106'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 106'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 120'b0};
