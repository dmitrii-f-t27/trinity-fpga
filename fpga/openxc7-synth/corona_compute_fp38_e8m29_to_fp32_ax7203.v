...
`timescale 1ns / 1ps
// corona_compute_fp38_e8m29_to_fp32_ax7203 — FP38_E8M29 TO_FP32 on AX7203.
module corona_compute_fp38_e8m29_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [37:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [37:0] a_reg; reg conv_trigger;
    wire [37:0] fmt_a = a_reg;
