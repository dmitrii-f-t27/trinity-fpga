...
`timescale 1ns / 1ps
// corona_compute_fp106_e12m93_fma_ax7203 — FP106_E12M93 FMA on AX7203.
module corona_compute_fp106_e12m93_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[104:93];
    wire [92:0] f_mant_a = fmt_a[92:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -70'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[104:93];
    wire [92:0] f_mant_b = fmt_b[92:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -70'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[104:93];
    wire [92:0] f_mant_c = fmt_c[92:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -70'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 93'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 93'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 105'b0};
