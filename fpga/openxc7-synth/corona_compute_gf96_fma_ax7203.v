...
module corona_compute_gf96_fma_ax7203 (
    ...
    // Stage 1: MUL
    reg [95:0] a_reg, b_reg; reg mul_trigger;
    wire mul_in_ready, mul_out_valid; wire [95:0] mul_result;
    ...
    // Stage 2: ADD
    reg [95:0] c_reg; reg add_trigger;
    wire add_in_ready, add_out_valid; wire [95:0] add_result;
