...
`timescale 1ns / 1ps
// corona_compute_fp117_e8m108_alu_ax7203 — FP117_E8M108 ALU on AX7203.
module corona_compute_fp117_e8m108_alu_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r,op_r; reg [116:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                6'd18: begin a_r[116:112]<=rx_byte;frm<=6'd19; end
                ...
                6'd33: begin b_r[116:112]<=rx_byte;frm<=6'd34; end
    ...
    reg [116:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
