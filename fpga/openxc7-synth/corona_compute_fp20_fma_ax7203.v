...
`timescale 1ns / 1ps
// corona_compute_fp20_fma_ax7203 — FP20 FMA on AX7203.
module corona_compute_fp20_fma_ax7203 (
    ...
    wire signed [9:0] f_de_a = $signed({1'b0, f_exp_a}) - 10'sd15 + 10'sd127;
    ...
    wire signed [9:0] f_de_b = $signed({1'b0, f_exp_b}) - 10'sd15 + 10'sd127;
    ...
    wire signed [9:0] f_de_c = $signed({1'b0, f_exp_c}) - 10'sd15 + 10'sd127;
    ...
    wire signed [9:0] tgt_exp_s = $signed({1'b0, q_exp}) - 10'sd127 + 10'sd15;
    reg [19:0] q_result;
    always @(*) begin
        if(q_nan) q_result=20'd0;
        else if(q_zero) q_result=20'd0;
        else if(q_inf) q_result={q_sign, 5'd31, 14'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 14'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 19'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 5'b0, q_mant[22:9]};
        else q_result={q_sign, tgt_exp_s[4:0], q_mant[22:9]};
    end
