...
`timescale 1ns / 1ps
// corona_compute_fp39_e10m28_fma_ax7203 — FP39_E10M28 FMA on AX7203.
module corona_compute_fp39_e10m28_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 28'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 28'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 38'b0};
