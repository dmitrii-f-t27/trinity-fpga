...
`timescale 1ns / 1ps
// corona_compute_quad_double_fma_ax7203 — QUAD_DOUBLE FMA on AX7203.
module corona_compute_quad_double_fma_ax7203 (
    ...
    wire qd_sign_c = fmt_c[63];
    wire [10:0] qd_exp_c = fmt_c[62:52];
    wire [51:0] qd_mant_c = fmt_c[51:0];
    wire qd_zero_c = (qd_exp_c == 11'd0) && (qd_mant_c == 52'd0);
    wire qd_special_c = (qd_exp_c == 11'h7FF);
    wire signed [12:0] qd_de_c = $signed({1'b0, qd_exp_c}) - 13'sd1023 + 13'sd127;
    wire [7:0] qd_exp32_c = qd_de_c[7:0];
