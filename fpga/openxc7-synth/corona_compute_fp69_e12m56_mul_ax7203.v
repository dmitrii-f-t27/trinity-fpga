...
`timescale 1ns / 1ps
// corona_compute_fp69_e12m56_mul_ax7203 — FP69_E12M56 MUL on AX7203.
module corona_compute_fp69_e12m56_mul_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [68:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [68:0] a_reg,b_reg; reg comp_trigger;
