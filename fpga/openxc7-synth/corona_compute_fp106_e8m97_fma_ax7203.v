...
module corona_compute_fp106_e8m97_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[105];
    wire [7:0] f_exp_a = fmt_a_a[104:97];
    wire [96:0] f_mant_a = fmt_a_a[96:0];
    ...
    wire f_sign_b = fmt_b_b[105];
    wire [7:0] f_exp_b = fmt_b_b[104:97];
    wire [96:0] f_mant_b = fmt_b_b[96:0];
    ...
    wire f_sign_c = fmt_c_c[105];
    wire [7:0] f_exp_c = fmt_c_c[104:97];
    wire [96:0] f_mant_c = fmt_c_c[96:0];
