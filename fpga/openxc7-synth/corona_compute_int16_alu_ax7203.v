...
`timescale 1ns / 1ps
// corona_compute_int16_alu_ax7203 — INT16 ALU on AX7203.
module corona_compute_int16_alu_ax7203 (
    ...
    wire signed [15:0] sa=a_reg, sb=b_reg;
    wire [15:0] add_r = sa + sb;
    wire [15:0] mul_r = sa * sb;
    wire [15:0] ar = (op_reg==8'h00)?add_r:mul_r;
    always @(posedge mclk or posedge rst) begin
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_trigger) result_reg<={{16{1'b0}},ar};
        end
    end
