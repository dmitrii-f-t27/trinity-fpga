...
`timescale 1ns / 1ps
// corona_compute_fp58_e9m48_mul_ax7203 — FP58_E9M48 MUL on AX7203.
module corona_compute_fp58_e9m48_mul_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [57:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [57:0] a_reg,b_reg; reg comp_trigger;
