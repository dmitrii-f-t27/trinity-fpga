...
`timescale 1ns / 1ps
// corona_compute_fp28_e11m16_fma_ax7203 — FP28_E11M16 FMA on AX7203.
module corona_compute_fp28_e11m16_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 16'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 16'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 27'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 11'b0, q_mant[22:7]};
        else q_result={q_sign, tgt_exp_s[10:0], q_mant[22:7]};
    end
