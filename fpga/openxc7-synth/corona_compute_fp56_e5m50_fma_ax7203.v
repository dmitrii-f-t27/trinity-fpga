...
`timescale 1ns / 1ps
// corona_compute_fp56_e5m50_fma_ax7203 — FP56_E5M50 FMA on AX7203.
module corona_compute_fp56_e5m50_fma_ax7203 (
    ...
    wire [4:0] f_exp_a = fmt_a[54:50];
    wire [49:0] f_mant_a = fmt_a[49:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -27'b0};
    ...
    wire [4:0] f_exp_b = fmt_b[54:50];
    wire [49:0] f_mant_b = fmt_b[49:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -27'b0};
    ...
    wire [4:0] f_exp_c = fmt_c[54:50];
    wire [49:0] f_mant_c = fmt_c[49:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -27'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 50'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 50'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 55'b0};
