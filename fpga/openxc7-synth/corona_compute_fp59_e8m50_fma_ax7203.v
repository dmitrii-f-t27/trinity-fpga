...
module corona_compute_fp59_e8m50_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[58];
    wire [7:0] f_exp_a = fmt_a_a[57:50];
    ...
    wire f_sign_b = fmt_b_b[58];
    wire [7:0] f_exp_b = fmt_b_b[57:50];
    ...
    wire f_sign_c = fmt_c_c[58];
    wire [7:0] f_exp_c = fmt_c_c[57:50];
