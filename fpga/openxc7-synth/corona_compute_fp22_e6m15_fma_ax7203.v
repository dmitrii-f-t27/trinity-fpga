...
module corona_compute_fp22_e6m15_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[21];
    wire [5:0] f_exp_a = fmt_a_a[20:15];
    wire [14:0] f_mant_a = fmt_a_a[14:0];
    ...
    wire f_sign_b = fmt_b_b[21];
    wire [5:0] f_exp_b = fmt_b_b[20:15];
    wire [14:0] f_mant_b = fmt_b_b[14:0];
    ...
    wire f_sign_c = fmt_c_c[21];
    wire [5:0] f_exp_c = fmt_c_c[20:15];
    wire [14:0] f_mant_c = fmt_c_c[14:0];
