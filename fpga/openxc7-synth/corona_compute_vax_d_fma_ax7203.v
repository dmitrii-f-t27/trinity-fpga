...
`timescale 1ns / 1ps
// corona_compute_vax_d_fma_ax7203 — VAX_D FMA on AX7203.
module corona_compute_vax_d_fma_ax7203 (
    ...
    wire vd_sign_c = fmt_c[63];
    wire [7:0] vd_exp_c = fmt_c[62:55];
    wire [54:0] vd_mant_c = fmt_c[54:0];
    wire vd_zero_c = (vd_exp_c == 8'd0);
    wire [7:0] vd_exp32_c = vd_exp_c - 8'd1;
    wire [22:0] vd_mant32_c = vd_mant_c[54:32];
    reg [31:0] fp32_c;
    always @(*) begin
        if(vd_zero_c) fp32_c={vd_sign_c, 31'b0};
        else fp32_c={vd_sign_c, vd_exp32_c, vd_mant32_c};
    end
