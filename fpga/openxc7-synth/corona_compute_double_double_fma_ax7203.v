...
`timescale 1ns / 1ps
// corona_compute_double_double_fma_ax7203 — DOUBLE_DOUBLE FMA on AX7203.
module corona_compute_double_double_fma_ax7203 (
    ...
    reg [31:0] fp32_a;
    always @(*) begin
        if(dd_zero_a) fp32_a=32'h00000000;
    ...
    reg [31:0] fp32_b;
    always @(*) begin
        if(dd_zero_b) fp32_b=32'h00000000;
    ...
    wire dd_sign_c = fmt_c[63];
    wire [10:0] dd_exp_c = fmt_c[62:52];
    wire [51:0] dd_mant_c = fmt_c[51:0];
    wire dd_zero_c = (fmt_c[63:0] == 64'd0);
    wire dd_nan_c = (dd_exp_c == 11'h7FF) && (|dd_mant_c);
    wire dd_inf_c = (dd_exp_c == 11'h7FF) && (dd_mant_c == 52'd0);
    wire signed [11:0] dd_exp32_s_c = $signed({1'b0, dd_exp_c}) - 12'sd896;
    wire [7:0] dd_exp32_c = dd_exp32_s_c[7:0];
