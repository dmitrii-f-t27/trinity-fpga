...
`timescale 1ns / 1ps
// corona_compute_binary64_fma_ax7203 — BINARY64 FMA on AX7203.
module corona_compute_binary64_fma_ax7203 (
    ...
    wire mul_irdy,mul_ovld; wire [63:0] mul_result;
    wire add_irdy,add_ovld; wire [63:0] add_result;
