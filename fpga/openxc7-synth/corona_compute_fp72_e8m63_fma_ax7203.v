...
module corona_compute_fp72_e8m63_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[71];
    wire [7:0] f_exp_a = fmt_a_a[70:63];
    wire [62:0] f_mant_a = fmt_a_a[62:0];
    ...
    wire f_sign_b = fmt_b_b[71];
    wire [7:0] f_exp_b = fmt_b_b[70:63];
    wire [62:0] f_mant_b = fmt_b_b[62:0];
    ...
    wire f_sign_c = fmt_c_c[71];
    wire [7:0] f_exp_c = fmt_c_c[70:63];
    wire [62:0] f_mant_c = fmt_c_c[62:0];
