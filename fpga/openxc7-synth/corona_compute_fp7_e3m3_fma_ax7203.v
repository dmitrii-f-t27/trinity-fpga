...
`timescale 1ns / 1ps
// corona_compute_fp7_e3m3_fma_ax7203 — FP7_E3M3 FMA on AX7203.
module corona_compute_fp7_e3m3_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 3'd7, 3'd0};
        else if(q_exp >= 8'd132) q_result={q_sign, 3'd7, 3'd0};
        else if(q_exp < 8'd125) q_result={q_sign, 6'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 3'b0, q_mant[22:20]};
        else q_result={q_sign, tgt_exp_s[2:0], q_mant[22:20]};
    end
