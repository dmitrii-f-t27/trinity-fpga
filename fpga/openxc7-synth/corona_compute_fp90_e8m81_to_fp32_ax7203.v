...
`timescale 1ns / 1ps
// corona_compute_fp90_e8m81_to_fp32_ax7203 — FP90_E8M81 TO_FP32 on AX7203.
module corona_compute_fp90_e8m81_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [89:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd11: begin a_r[71:64]<=rx_byte;frm<=4'd12; end
                4'd12: begin a_r[79:72]<=rx_byte;frm<=4'd13; end
                4'd13: begin a_r[87:80]<=rx_byte;frm<=4'd14; end
                4'd14: begin a_r[89:88]<=rx_byte;frm<=4'd15; end
    ...
    reg [89:0] a_reg; reg conv_trigger;
    wire [89:0] fmt_a = a_reg;
