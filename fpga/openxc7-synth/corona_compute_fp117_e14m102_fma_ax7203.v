...
`timescale 1ns / 1ps
// corona_compute_fp117_e14m102_fma_ax7203 — FP117_E14M102 FMA on AX7203.
module corona_compute_fp117_e14m102_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[115:102];
    ...
    wire [13:0] f_exp_b = fmt_b[115:102];
    ...
    wire [13:0] f_exp_c = fmt_c[115:102];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 102'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 102'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 116'b0};
