...
`timescale 1ns / 1ps
// corona_compute_fp110_e13m96_fma_ax7203 — FP110_E13M96 FMA on AX7203.
module corona_compute_fp110_e13m96_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[108:96];
    ...
    wire [12:0] f_exp_b = fmt_b[108:96];
    ...
    wire [12:0] f_exp_c = fmt_c[108:96];
    wire [95:0] f_mant_c = fmt_c[95:0];
    wire f_zero_c = (f_exp_c == 0) && ((f_mant_c == 0));
    wire f_inf_c = (f_exp_c == 8191) && ((f_mant_c == 0));
    wire f_nan_c = (f_exp_c == 8191) && ((f_mant_c != 0));
    wire f_sub_c = (f_exp_c == 0) && ((f_mant_c != 0));
    wire signed [22:0] f_de_c = $signed({1'b0, f_exp_c}) - 23'sd4095 + 23'sd127;
    wire [7:0] f_exp32_c = (f_de_c > 23'sd254) ? 8'd254 : (f_de_c < 0) ? 8'd0 : f_de_c[7:0];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 96'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 96'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 109'b0};
