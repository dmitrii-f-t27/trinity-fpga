...
`timescale 1ns / 1ps
// corona_decode_decimal64_ax7203 — IEEE 754 decimal64 (BID) decode on AX7203.
// 64-bit decode frame: AA 55 fmt code[0..7] trig (12 bytes) -> A5 FP32 LE.
// Infrastructure identical to corona_decode_binary64_ax7203; only the decoder differs
// (decimal64_decode: value = (-1)^s * C * 10^(E-398), RNE to binary32).
module corona_decode_decimal64_ax7203 (
    ...
    wire [31:0] result;
    decimal64_decode u_dec (.bid(code_r[63:0]), .fp32_out(result));
    assign led[2] = |result;
