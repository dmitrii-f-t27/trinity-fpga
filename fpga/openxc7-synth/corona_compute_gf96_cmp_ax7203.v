...
`timescale 1ns / 1ps
// corona_compute_gf96_cmp_ax7203 — GoldenFloat96 comparison on AX7203.
// GF96: [S:1][E:36][M:59] = 96 bits, HAS_INF=1.
// op: 0x00=EQ, 0x01=LT, 0x02=LE
module corona_compute_gf96_cmp_ax7203 (
    ...
    wire sa = a_reg[95];
    wire [35:0] ea = a_reg[94:59];
    wire [58:0] ma = a_reg[58:0];
    wire sb = b_reg[95];
    wire [35:0] eb = b_reg[94:59];
    wire [58:0] mb = b_reg[58:0];
    wire a_zero = (ea == 0) && (ma == 0);
    wire b_zero = (eb == 0) && (mb == 0);
    wire a_nan = (ea == {36{1'b1}}) && (ma != 0);
    wire b_nan = (eb == {36{1'b1}}) && (mb != 0);
    wire [94:0] abs_a = {ea, ma};
    wire [94:0] abs_b = {eb, mb};
    ...
    // TX: buffer+mux (no conflicting NBA — fixes tx race). 5 bytes sliced from tx_load[103:0].
