...
`timescale 1ns / 1ps
// corona_compute_fp118_e14m103_fma_ax7203 — FP118_E14M103 FMA on AX7203.
module corona_compute_fp118_e14m103_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[116:103];
    ...
    wire [13:0] f_exp_b = fmt_b[116:103];
    ...
    wire [13:0] f_exp_c = fmt_c[116:103];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 103'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 103'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 117'b0};
