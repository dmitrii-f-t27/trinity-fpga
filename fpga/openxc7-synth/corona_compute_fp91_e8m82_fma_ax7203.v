...
`timescale 1ns / 1ps
// corona_compute_fp91_e8m82_fma_ax7203 — FP91_E8M82 FMA on AX7203.
module corona_compute_fp91_e8m82_fma_ax7203 (
    ...
    wire f_sign_c = fmt_c[90];
    wire [7:0] f_exp_c = fmt_c[89:82];
    wire [81:0] f_mant_c = fmt_c[81:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -59'b0};
