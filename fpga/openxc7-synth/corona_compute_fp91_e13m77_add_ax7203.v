...
`timescale 1ns / 1ps
// corona_compute_fp91_e13m77_add_ax7203 — FP91_E13M77 ADD on AX7203.
module corona_compute_fp91_e13m77_add_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 77'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 77'd0};
