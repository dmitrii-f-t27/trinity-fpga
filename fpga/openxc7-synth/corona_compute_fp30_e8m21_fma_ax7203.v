...
module corona_compute_fp30_e8m21_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[29];
    wire [7:0] f_exp_a = fmt_a_a[28:21];
    wire [20:0] f_mant_a = fmt_a_a[20:0];
    ...
    wire f_sign_b = fmt_b_b[29];
    wire [7:0] f_exp_b = fmt_b_b[28:21];
    wire [20:0] f_mant_b = fmt_b_b[20:0];
    ...
    wire f_sign_c = fmt_c_c[29];
    wire [7:0] f_exp_c = fmt_c_c[28:21];
    wire [20:0] f_mant_c = fmt_c_c[20:0];
