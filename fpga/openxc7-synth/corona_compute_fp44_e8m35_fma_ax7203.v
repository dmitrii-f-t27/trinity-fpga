...
module corona_compute_fp44_e8m35_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[43];
    wire [7:0] f_exp_a = fmt_a_a[42:35];
    wire [34:0] f_mant_a = fmt_a_a[34:0];
    ...
    wire f_sign_b = fmt_b_b[43];
    wire [7:0] f_exp_b = fmt_b_b[42:35];
    wire [34:0] f_mant_b = fmt_b_b[34:0];
    ...
    wire f_sign_c = fmt_c_c[43];
    wire [7:0] f_exp_c = fmt_c_c[42:35];
    wire [34:0] f_mant_c = fmt_c_c[34:0];
