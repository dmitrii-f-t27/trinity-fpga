...
`timescale 1ns / 1ps
// corona_compute_fp5_e2m2_fma_ax7203 — FP5_E2M2 FMA on AX7203.
module corona_compute_fp5_e2m2_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_exp < 8'd127) q_result={q_sign, 4'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 2'b0, q_mant[22:21]};
