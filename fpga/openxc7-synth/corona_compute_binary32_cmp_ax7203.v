...
`timescale 1ns / 1ps
// corona_compute_binary32_cmp_ax7203 — BINARY32 CMP on AX7203.
module corona_compute_binary32_cmp_ax7203 (
    ...
    wire sa=a_reg[31]; wire [7:0] ea=a_reg[30:23]; wire [22:0] ma=a_reg[22:0];
    wire sb=b_reg[31]; wire [7:0] eb=b_reg[30:23]; wire [22:0] mb=b_reg[22:0];
    wire az=(ea==0)&&(ma==0); wire bz=(eb==0)&&(mb==0);
    wire an=(1)&&(ea=={8{1'b1}})&&(ma!=0); wire bn=(1)&&(eb=={8{1'b1}})&&(mb!=0);
    wire [30:0] aa={ea,ma}; wire [30:0] ab={eb,mb};
