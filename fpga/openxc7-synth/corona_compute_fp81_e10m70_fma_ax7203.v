...
`timescale 1ns / 1ps
// corona_compute_fp81_e10m70_fma_ax7203 — FP81_E10M70 FMA on AX7203.
module corona_compute_fp81_e10m70_fma_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a[79:70];
    wire [69:0] f_mant_a = fmt_a[69:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -47'b0};
    ...
    wire [9:0] f_exp_b = fmt_b[79:70];
    wire [69:0] f_mant_b = fmt_b[69:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -47'b0};
    ...
    wire [9:0] f_exp_c = fmt_c[79:70];
    wire [69:0] f_mant_c = fmt_c[69:0];
    wire f_zero_c = (f_exp_c == 0) && ((f_mant_c == 0));
    wire f_inf_c = (f_exp_c == 1023) && ((f_mant_c == 0));
    wire f_nan_c = (f_exp_c == 1023) && ((f_mant_c != 0));
    wire f_sub_c = (f_exp_c == 0) && ((f_mant_c != 0));
    wire signed [19:0] f_de_c = $signed({1'b0, f_exp_c}) - 20'sd511 + 20'sd127;
    wire [7:0] f_exp32_c = (f_de_c > 20'sd254) ? 8'd254 : (f_de_c < 0) ? 8'd0 : f_de_c[7:0];
    wire [22:0] f_mant32_c = {f_mant_c, -47'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 70'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 70'd0};
