...
`timescale 1ns / 1ps
// corona_compute_fp126_e15m110_fma_ax7203 — FP126_E15M110 FMA on AX7203.
module corona_compute_fp126_e15m110_fma_ax7203 (
    ...
    wire [14:0] f_exp_a = fmt_a[124:110];
    ...
    wire [14:0] f_exp_b = fmt_b[124:110];
    ...
    wire [14:0] f_exp_c = fmt_c[124:110];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 15'd32767, 110'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 15'd32767, 110'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 125'b0};
