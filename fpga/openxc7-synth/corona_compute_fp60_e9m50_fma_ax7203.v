...
module corona_compute_fp60_e9m50_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[59];
    wire [8:0] f_exp_a = fmt_a_a[58:50];
    ...
    wire f_sign_b = fmt_b_b[59];
    wire [8:0] f_exp_b = fmt_b_b[58:50];
    ...
    wire f_sign_c = fmt_c_c[59];
    wire [8:0] f_exp_c = fmt_c_c[58:50];
