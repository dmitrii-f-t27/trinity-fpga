...
module corona_compute_fp98_e8m89_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[97];
    wire [7:0] f_exp_a = fmt_a_a[96:89];
    wire [88:0] f_mant_a = fmt_a_a[88:0];
    ...
    wire f_sign_b = fmt_b_b[97];
    wire [7:0] f_exp_b = fmt_b_b[96:89];
    wire [88:0] f_mant_b = fmt_b_b[88:0];
    ...
    wire f_sign_c = fmt_c_c[97];
    wire [7:0] f_exp_c = fmt_c_c[96:89];
    wire [88:0] f_mant_c = fmt_c_c[88:0];
