...
module corona_compute_fp107_e8m98_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[105:98];
    wire [97:0] f_mant_a = fmt_a_a[97:0];
    ...
    wire f_sign_b = fmt_b_b[106];
    wire [7:0] f_exp_b = fmt_b_b[105:98];
    wire [97:0] f_mant_b = fmt_b_b[97:0];
    ...
    wire f_sign_c = fmt_c_c[106];
    wire [7:0] f_exp_c = fmt_c_c[105:98];
    wire [97:0] f_mant_c = fmt_c_c[97:0];
