...
`timescale 1ns / 1ps
// corona_compute_fp24_e8m15_alu_ax7203 — FP24_E8M15 ALU on AX7203.
module corona_compute_fp24_e8m15_alu_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r,op_r; reg [23:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [23:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(ovld) result_reg<={8'b0,q_result};
        end
    end
