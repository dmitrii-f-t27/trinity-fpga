...
module corona_compute_fp57_e8m48_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[56];
    wire [7:0] f_exp_a = fmt_a_a[55:48];
    ...
    wire f_sign_b = fmt_b_b[56];
    wire [7:0] f_exp_b = fmt_b_b[55:48];
    ...
    wire f_sign_c = fmt_c_c[56];
    wire [7:0] f_exp_c = fmt_c_c[55:48];
