...
`timescale 1ns / 1ps
// corona_compute_fp39_e8m30_alu_ax7203 — FP39_E8M30 ALU on AX7203.
module corona_compute_fp39_e8m30_alu_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r,op_r; reg [38:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd8: begin a_r[38:32]<=rx_byte;frm<=4'd9; end
                ...
                4'd13: begin b_r[38:32]<=rx_byte;frm<=4'd14; end
    ...
    reg [38:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [38:0] fmt_a=a_reg, fmt_b=b_reg;
