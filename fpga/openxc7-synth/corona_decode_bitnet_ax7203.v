...
`timescale 1ns / 1ps
// corona_decode_bitnet_ax7203 — BitNet 1.58b ternary decode on AX7203.
...
// (bitnet_decode: 2-bit ternary {0,+1,-1,NaN} -> FP32 LUT, uses code_r[1:0]).
module corona_decode_bitnet_ax7203 (
    ...
    bitnet_decode u_dec (.ternary_in(code_r[1:0]), .fp32_out(result),
                         .is_zero(is_zero), .is_reserved(is_reserved));
    assign led[2] = is_zero;
