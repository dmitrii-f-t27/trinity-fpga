...
`timescale 1ns / 1ps
// corona_compute_fp113_e8m104_add_ax7203 — FP113_E8M104 ADD on AX7203.
module corona_compute_fp113_e8m104_add_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [112:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [112:0] a_reg,b_reg; reg comp_trigger;
    wire [112:0] fmt_a=a_reg, fmt_b=b_reg;
