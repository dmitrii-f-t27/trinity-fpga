...
`timescale 1ns / 1ps
// corona_compute_fp17_e10m6_fma_ax7203 — FP17_E10M6 FMA on AX7203.
module corona_compute_fp17_e10m6_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 6'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 6'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 16'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 10'b0, q_mant[22:17]};
        else q_result={q_sign, tgt_exp_s[9:0], q_mant[22:17]};
    end
