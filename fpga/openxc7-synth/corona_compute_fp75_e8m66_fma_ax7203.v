...
module corona_compute_fp75_e8m66_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[74];
    wire [7:0] f_exp_a = fmt_a[73:66];
    wire [65:0] f_mant_a = fmt_a[65:0];
    ...
    wire f_sign_b = fmt_b[74];
    wire [7:0] f_exp_b = fmt_b[73:66];
    wire [65:0] f_mant_b = fmt_b[65:0];
    ...
    wire f_sign_c = fmt_c[74];
    wire [7:0] f_exp_c = fmt_c[73:66];
    wire [65:0] f_mant_c = fmt_c[65:0];
