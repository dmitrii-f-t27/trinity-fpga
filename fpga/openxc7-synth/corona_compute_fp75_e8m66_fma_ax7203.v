...
`timescale 1ns / 1ps
// corona_compute_fp75_e8m66_fma_ax7203 — FP75_E8M66 FMA on AX7203.
module corona_compute_fp75_e8m66_fma_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [74:0] a_r,b_r,c_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;c_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                6'd12: begin a_r[74:72]<=rx_byte;frm<=6'd13; end
                ...
                6'd22: begin b_r[74:72]<=rx_byte;frm<=6'd23; end
                ...
                6'd32: begin c_r[74:72]<=rx_byte;frm<=6'd33; end
    ...
    reg [74:0] a_reg,b_reg,c_reg; reg comp_trigger;
    wire [74:0] fmt_a=a_reg, fmt_b=b_reg, fmt_c=c_reg;
    ...
    wire f_sign_c = fmt_c_c[74];
    wire [7:0] f_exp_c = fmt_c_c[73:66];
    wire [65:0] f_mant_c = fmt_c_c[65:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -43'b0};
