...
`timescale 1ns / 1ps
// corona_compute_fp82_e13m68_fma_ax7203 — FP82_E13M68 FMA on AX7203.
module corona_compute_fp82_e13m68_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 68'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 68'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 81'b0};
