...
`timescale 1ns / 1ps
// corona_decode_binary64_ax7203 — binary64 (FP64) decode on AX7203.
// NEW 64-bit decode frame: AA 55 fmt code[0..7] trig (12 bytes) -> A5 FP32 LE.
module corona_decode_binary64_ax7203 (
    ...
    binary64_decode u_dec (.fp64_in(code_r[63:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
