...
`timescale 1ns / 1ps
// corona_compute_fp57_e10m46_fma_ax7203 — FP57_E10M46 FMA on AX7203.
module corona_compute_fp57_e10m46_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 46'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 46'd0};
