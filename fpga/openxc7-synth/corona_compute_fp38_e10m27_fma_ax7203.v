...
`timescale 1ns / 1ps
// corona_compute_fp38_e10m27_fma_ax7203 — FP38_E10M27 FMA on AX7203.
module corona_compute_fp38_e10m27_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 27'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 27'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 37'b0};
