...
`timescale 1ns / 1ps
// corona_compute_fp97_e12m84_fma_ax7203 — FP97_E12M84 FMA on AX7203.
module corona_compute_fp97_e12m84_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[95:84];
    wire [83:0] f_mant_a = fmt_a[83:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -61'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[95:84];
    wire [83:0] f_mant_b = fmt_b[83:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -61'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[95:84];
    wire [83:0] f_mant_c = fmt_c[83:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -61'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 84'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 84'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 96'b0};
