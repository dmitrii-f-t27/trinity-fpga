...
`timescale 1ns / 1ps
// corona_compute_fp61_e8m52_fma_ax7203 — FP61_E8M52 FMA on AX7203.
module corona_compute_fp61_e8m52_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 52'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 52'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 60'b0};
