...
`timescale 1ns / 1ps
// corona_compute_fp119_e15m103_mul_ax7203 — FP119_E15M103 MUL on AX7203.
module corona_compute_fp119_e15m103_mul_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [118:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [118:0] a_reg,b_reg; reg comp_trigger;
    wire [118:0] fmt_a=a_reg, fmt_b=b_reg;
