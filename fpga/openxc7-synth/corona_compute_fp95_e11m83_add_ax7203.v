...
`timescale 1ns / 1ps
// corona_compute_fp95_e11m83_add_ax7203 — FP95_E11M83 ADD on AX7203.
module corona_compute_fp95_e11m83_add_ax7203 (
    ...
    wire [10:0] f_exp_a = fmt_a_a[93:83];
    ...
    wire [10:0] f_exp_b = fmt_b_b[93:83];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 83'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 83'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 94'b0};
