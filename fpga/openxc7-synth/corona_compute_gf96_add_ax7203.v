...
`timescale 1ns / 1ps
// corona_compute_gf96_add_ax7203 — GoldenFloat96 ADD on AX7203.
// GF96: [S:1][E:36][M:59] = 96 bits, BIAS=34359738367, HAS_INF=1.
// 12 bytes per operand, 28-byte frame.
module corona_compute_gf96_add_ax7203 (
    ...
    wire comp_in_ready, comp_out_valid; wire [95:0] comp_result;
    gf_adder_param #(.EXP_BITS(36), .MANT_BITS(59), .HAS_INF(1)) u_comp (
        .clk(mclk), .rst(rst),
