...
`timescale 1ns / 1ps
// corona_compute_fp15_e6m8_to_fp32_ax7203 — FP15_E6M8 TO_FP32 on AX7203.
module corona_compute_fp15_e6m8_to_fp32_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [14:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [14:0] a_reg; reg conv_trigger;
    wire [14:0] fmt_a = a_reg;
