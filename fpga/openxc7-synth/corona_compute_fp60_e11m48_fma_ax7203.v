...
`timescale 1ns / 1ps
// corona_compute_fp60_e11m48_fma_ax7203 — FP60_E11M48 FMA on AX7203.
module corona_compute_fp60_e11m48_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 48'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 48'd0};
