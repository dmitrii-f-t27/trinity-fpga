...
`timescale 1ns / 1ps
// corona_compute_fp41_e11m29_fma_ax7203 — FP41_E11M29 FMA on AX7203.
module corona_compute_fp41_e11m29_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 29'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 29'd0};
