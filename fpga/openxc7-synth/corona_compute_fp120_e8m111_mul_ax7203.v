...
`timescale 1ns / 1ps
// corona_compute_fp120_e8m111_mul_ax7203 — FP120_E8M111 MUL on AX7203.
module corona_compute_fp120_e8m111_mul_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [119:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [119:0] a_reg,b_reg; reg comp_trigger;
