...
`timescale 1ns / 1ps
// corona_decode_lns16_ax7203 — 16-bit LNS decode on AX7203.
...
// lns16_decode: 1 sign + 15-bit signed log (scale 128) -> FP32 via 128-entry LUT.
module corona_decode_lns16_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero;
    lns16_decode u_dec (.lns_in(code_r[15:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
