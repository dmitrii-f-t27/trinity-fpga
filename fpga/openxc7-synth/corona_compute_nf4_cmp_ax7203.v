...
`timescale 1ns / 1ps
// corona_compute_nf4_cmp_ax7203 — NF4 CMP on AX7203.
module corona_compute_nf4_cmp_ax7203 (
    ...
    // Convert NF4 to FP32 for comparison
    ...
    wire sa=fp32_a[31]; wire sb=fp32_b[31];
    wire [30:0] abs_a=fp32_a[30:0]; wire [30:0] abs_b=fp32_b[30:0];
    wire ce = (fp32_a == fp32_b);
    wire cl = (sa && ~sb) ? 1'b1 : (~sa && sb) ? 1'b0 :
              (sa && sb) ? (abs_a > abs_b) : (abs_a < abs_b);
    wire cd = cl | ce;
    always @(posedge mclk or posedge rst) begin
