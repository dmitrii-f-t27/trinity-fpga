...
`timescale 1ns / 1ps
// corona_compute_fp125_e14m110_fma_ax7203 — FP125_E14M110 FMA on AX7203.
module corona_compute_fp125_e14m110_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[123:110];
    ...
    wire [13:0] f_exp_b = fmt_b[123:110];
    ...
    wire [13:0] f_exp_c = fmt_c[123:110];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 110'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 110'd0};
