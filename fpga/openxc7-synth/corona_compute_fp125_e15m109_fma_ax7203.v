...
`timescale 1ns / 1ps
// corona_compute_fp125_e15m109_fma_ax7203 — FP125_E15M109 FMA on AX7203.
module corona_compute_fp125_e15m109_fma_ax7203 (
    ...
    wire [14:0] f_exp_b = fmt_b[123:109];
    ...
    wire [14:0] f_exp_c = fmt_c[123:109];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 15'd32767, 109'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 15'd32767, 109'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 124'b0};
