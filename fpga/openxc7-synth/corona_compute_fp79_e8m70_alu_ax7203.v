...
`timescale 1ns / 1ps
// corona_compute_fp79_e8m70_alu_ax7203 — FP79_E8M70 ALU on AX7203.
module corona_compute_fp79_e8m70_alu_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[77:70];
    ...
    wire [7:0] f_exp_b = fmt_b_b[77:70];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 70'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 70'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 78'b0};
