...
`timescale 1ns / 1ps
// corona_compute_fp9_e5m3_fma_ax7203 — FP9_E5M3 FMA on AX7203.
module corona_compute_fp9_e5m3_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 3'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 3'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 8'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 5'b0, q_mant[22:20]};
        else q_result={q_sign, tgt_exp_s[4:0], q_mant[22:20]};
    end
