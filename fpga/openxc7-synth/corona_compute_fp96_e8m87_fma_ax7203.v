...
module corona_compute_fp96_e8m87_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[95];
    wire [7:0] f_exp_a = fmt_a_a[94:87];
    wire [86:0] f_mant_a = fmt_a_a[86:0];
    ...
    wire f_sign_b = fmt_b_b[95];
    wire [7:0] f_exp_b = fmt_b_b[94:87];
    wire [86:0] f_mant_b = fmt_b_b[86:0];
    ...
    wire f_sign_c = fmt_c_c[95];
    wire [7:0] f_exp_c = fmt_c_c[94:87];
    wire [86:0] f_mant_c = fmt_c_c[86:0];
