...
`timescale 1ns / 1ps
// corona_compute_fp39_e11m27_fma_ax7203 — FP39_E11M27 FMA on AX7203.
module corona_compute_fp39_e11m27_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 27'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 27'd0};
