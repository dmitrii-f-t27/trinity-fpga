...
`timescale 1ns / 1ps
// corona_compute_binary16_mul_ax7203 — BINARY16 MUL on AX7203.
module corona_compute_binary16_mul_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(5),.MANT_BITS(10),.HAS_INF(1)) u_comp (
