...
`timescale 1ns / 1ps
// corona_compute_gf10_cmp_ax7203 — GoldenFloat10 comparison on AX7203.
...
module corona_compute_gf10_cmp_ax7203 (
    ...
    wire        sa = a_reg[9];
    wire [2:0] ea = a_reg[8:6];
    wire [5:0] ma = a_reg[5:0];
    wire        sb = b_reg[9];
    wire [2:0] eb = b_reg[8:6];
    ...
    wire [8:0] abs_a = {ea, ma};
    wire [8:0] abs_b = {eb, mb};
