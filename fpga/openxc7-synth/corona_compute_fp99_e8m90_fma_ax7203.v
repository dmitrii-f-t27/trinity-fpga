...
module corona_compute_fp99_e8m90_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[98];
    wire [7:0] f_exp_a = fmt_a_a[97:90];
    wire [89:0] f_mant_a = fmt_a_a[89:0];
    ...
    wire f_sign_b = fmt_b_b[98];
    wire [7:0] f_exp_b = fmt_b_b[97:90];
    wire [89:0] f_mant_b = fmt_b_b[89:0];
    ...
    wire f_sign_c = fmt_c_c[98];
    wire [7:0] f_exp_c = fmt_c_c[97:90];
    wire [89:0] f_mant_c = fmt_c_c[89:0];
