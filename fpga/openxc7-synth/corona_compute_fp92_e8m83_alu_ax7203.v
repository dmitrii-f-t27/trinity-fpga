...
`timescale 1ns / 1ps
// corona_compute_fp92_e8m83_alu_ax7203 — FP92_E8M83 ALU on AX7203.
module corona_compute_fp92_e8m83_alu_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r,op_r; reg [91:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd15: begin a_r[91:88]<=rx_byte;frm<=5'd16; end
                ...
                5'd27: begin b_r[91:88]<=rx_byte;frm<=5'd28; end
    ...
    reg [91:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
