...
`timescale 1ns / 1ps
// corona_compute_fp73_e12m60_alu_ax7203 — FP73_E12M60 ALU on AX7203.
module corona_compute_fp73_e12m60_alu_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 60'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 60'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 72'b0};
