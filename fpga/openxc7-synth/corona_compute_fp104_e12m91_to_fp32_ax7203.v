...
`timescale 1ns / 1ps
// corona_compute_fp104_e12m91_to_fp32_ax7203 — FP104_E12M91 TO_FP32 on AX7203.
module corona_compute_fp104_e12m91_to_fp32_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [103:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [103:0] a_reg; reg conv_trigger;
    wire [103:0] fmt_a = a_reg;
