...
`timescale 1ns / 1ps
// corona_compute_fp112_e8m103_to_fp32_ax7203 — FP112_E8M103 TO_FP32 on AX7203.
module corona_compute_fp112_e8m103_to_fp32_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [111:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [111:0] a_reg; reg conv_trigger;
    wire [111:0] fmt_a = a_reg;
