...
`timescale 1ns / 1ps
// corona_compute_takum8_fma_ax7203 — TAKUM8 FMA on AX7203.
module corona_compute_takum8_fma_ax7203 (
...
8'd0: fp32_b=32'h00000000;
    ...
    wire [7:0] tk_val_c = fmt_c;
    wire tk_zero_c = (tk_val_c <= 8'd7) || (tk_val_c >= 8'd248);
    wire tk_nar_c = (tk_val_c == 8'd80);
    reg [31:0] fp32_c;
    always @(*) begin
        case(tk_val_c)
