...
`timescale 1ns / 1ps
// corona_compute_fp40_e9m30_to_fp32_ax7203 — FP40_E9M30 TO_FP32 on AX7203.
module corona_compute_fp40_e9m30_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [39:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [39:0] a_reg; reg conv_trigger;
    wire [39:0] fmt_a = a_reg;
