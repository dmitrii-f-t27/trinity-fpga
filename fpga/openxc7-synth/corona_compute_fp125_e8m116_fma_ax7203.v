...
module corona_compute_fp125_e8m116_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[124];
    wire [7:0] f_exp_a = fmt_a_a[123:116];
    wire [115:0] f_mant_a = fmt_a_a[115:0];
    ...
    wire f_sign_b = fmt_b_b[124];
    wire [7:0] f_exp_b = fmt_b_b[123:116];
    wire [115:0] f_mant_b = fmt_b_b[115:0];
    ...
    wire f_sign_c = fmt_c_c[124];
    wire [7:0] f_exp_c = fmt_c_c[123:116];
    wire [115:0] f_mant_c = fmt_c_c[115:0];
