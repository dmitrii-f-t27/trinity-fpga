...
`timescale 1ns / 1ps
// corona_compute_fp67_e12m54_fma_ax7203 — FP67_E12M54 FMA on AX7203.
module corona_compute_fp67_e12m54_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[65:54];
    wire [53:0] f_mant_a = fmt_a[53:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -31'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[65:54];
    wire [53:0] f_mant_b = fmt_b[53:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -31'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[65:54];
    wire [53:0] f_mant_c = fmt_c[53:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -31'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 54'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 54'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 66'b0};
