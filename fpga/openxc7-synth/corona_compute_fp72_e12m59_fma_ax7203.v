...
`timescale 1ns / 1ps
// corona_compute_fp72_e12m59_fma_ax7203 — FP72_E12M59 FMA on AX7203.
module corona_compute_fp72_e12m59_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 59'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 59'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 71'b0};
