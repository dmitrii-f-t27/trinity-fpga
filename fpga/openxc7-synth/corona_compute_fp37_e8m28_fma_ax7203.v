...
module corona_compute_fp37_e8m28_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[36];
    wire [7:0] f_exp_a = fmt_a_a[35:28];
    wire [27:0] f_mant_a = fmt_a_a[27:0];
    ...
    wire f_sign_b = fmt_b_b[36];
    wire [7:0] f_exp_b = fmt_b_b[35:28];
    wire [27:0] f_mant_b = fmt_b_b[27:0];
    ...
    wire f_sign_c = fmt_c_c[36];
    wire [7:0] f_exp_c = fmt_c_c[35:28];
    wire [27:0] f_mant_c = fmt_c_c[27:0];
