...
`timescale 1ns / 1ps
// corona_decode_vax_h_ax7203 — VAX H → FP32 decode on AX7203.
// 16-byte code frame (128-bit input).
module corona_decode_vax_h_ax7203 (
    ...
    vax_h_decode u_dec (.vax_in(code_r), .fp32_out(result), .is_zero(zero_flag));
    assign led[2] = |result;
