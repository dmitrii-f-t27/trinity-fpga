...
module corona_compute_fp114_e8m105_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[113];
    wire [7:0] f_exp_a = fmt_a_a[112:105];
    wire [104:0] f_mant_a = fmt_a_a[104:0];
    ...
    wire f_sign_b = fmt_b_b[113];
    wire [7:0] f_exp_b = fmt_b_b[112:105];
    wire [104:0] f_mant_b = fmt_b_b[104:0];
    ...
    wire f_sign_c = fmt_c_c[113];
    wire [7:0] f_exp_c = fmt_c_c[112:105];
    wire [104:0] f_mant_c = fmt_c_c[104:0];
