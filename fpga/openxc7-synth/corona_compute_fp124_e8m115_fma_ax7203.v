...
module corona_compute_fp124_e8m115_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[122:115];
    wire [114:0] f_mant_a = fmt_a_a[114:0];
    ...
    wire f_sign_b = fmt_b_b[123];
    wire [7:0] f_exp_b = fmt_b_b[122:115];
    wire [114:0] f_mant_b = fmt_b_b[114:0];
    ...
    wire f_sign_c = fmt_c_c[123];
    wire [7:0] f_exp_c = fmt_c_c[122:115];
    wire [114:0] f_mant_c = fmt_c_c[114:0];
