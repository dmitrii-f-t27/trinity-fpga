...
`timescale 1ns / 1ps
// corona_decode_gf10_ax7203 — GoldenFloat10 (1S+3E+6M) decode on AX7203.
...
// Identical infrastructure to corona_decode_gf14_ax7203; only the decoder differs
// (gf10_decode: GF10 code[9:0] -> FP32, standard IEEE-like unpack, no Inf).
module corona_decode_gf10_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero;
    gf10_decode u_dec (.gf10_in(code_r[9:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
