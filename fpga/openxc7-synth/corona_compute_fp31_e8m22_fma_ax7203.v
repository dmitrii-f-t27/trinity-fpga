...
module corona_compute_fp31_e8m22_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[30];
    wire [7:0] f_exp_a = fmt_a_a[29:22];
    ...
    wire f_sign_b = fmt_b_b[30];
    wire [7:0] f_exp_b = fmt_b_b[29:22];
    ...
    wire f_sign_c = fmt_c_c[30];
    wire [7:0] f_exp_c = fmt_c_c[29:22];
