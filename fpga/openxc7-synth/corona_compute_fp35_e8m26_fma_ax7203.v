...
module corona_compute_fp35_e8m26_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[34];
    wire [7:0] f_exp_a = fmt_a_a[33:26];
    wire [25:0] f_mant_a = fmt_a_a[25:0];
    ...
    wire f_sign_b = fmt_b_b[34];
    wire [7:0] f_exp_b = fmt_b_b[33:26];
    wire [25:0] f_mant_b = fmt_b_b[25:0];
    ...
    wire f_sign_c = fmt_c_c[34];
    wire [7:0] f_exp_c = fmt_c_c[33:26];
    wire [25:0] f_mant_c = fmt_c_c[25:0];
