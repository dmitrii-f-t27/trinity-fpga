...
module corona_compute_fp84_e8m75_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[83];
    wire [7:0] f_exp_a = fmt_a_a[82:75];
    wire [74:0] f_mant_a = fmt_a_a[74:0];
    ...
    wire f_sign_b = fmt_b_b[83];
    wire [7:0] f_exp_b = fmt_b_b[82:75];
    wire [74:0] f_mant_b = fmt_b_b[74:0];
    ...
    wire f_sign_c = fmt_c_c[83];
    wire [7:0] f_exp_c = fmt_c_c[82:75];
    wire [74:0] f_mant_c = fmt_c_c[74:0];
