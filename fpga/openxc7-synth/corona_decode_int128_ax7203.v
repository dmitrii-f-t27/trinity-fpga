...
`timescale 1ns / 1ps
// corona_decode_int128_ax7203 — signed int128 → FP32 decode on AX7203.
// 16-byte code frame (128-bit input).
module corona_decode_int128_ax7203 (
    ...
    int128_decode u_dec (.int128_in(code_r), .fp32_out(result), .is_zero_o(zero_flag), .is_inf_o(inf_flag));
    assign led[2] = |result;
