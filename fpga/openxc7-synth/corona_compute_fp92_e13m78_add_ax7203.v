...
`timescale 1ns / 1ps
// corona_compute_fp92_e13m78_add_ax7203 — FP92_E13M78 ADD on AX7203.
module corona_compute_fp92_e13m78_add_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a_a[90:78];
    ...
    wire [12:0] f_exp_b = fmt_b_b[90:78];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 78'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 78'd0};
