...
module corona_compute_fp116_e8m107_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[115];
    wire [7:0] f_exp_a = fmt_a_a[114:107];
    wire [106:0] f_mant_a = fmt_a_a[106:0];
    ...
    wire f_sign_b = fmt_b_b[115];
    wire [7:0] f_exp_b = fmt_b_b[114:107];
    wire [106:0] f_mant_b = fmt_b_b[106:0];
    ...
    wire f_sign_c = fmt_c_c[115];
    wire [7:0] f_exp_c = fmt_c_c[114:107];
    wire [106:0] f_mant_c = fmt_c_c[106:0];
