...
`timescale 1ns / 1ps
// corona_compute_fp33_e8m24_to_fp32_ax7203 — FP33_E8M24 TO_FP32 on AX7203.
module corona_compute_fp33_e8m24_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [32:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [32:0] a_reg; reg conv_trigger;
    wire [32:0] fmt_a = a_reg;
