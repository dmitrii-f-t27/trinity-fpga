...
module corona_compute_fp111_e8m102_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[110];
    wire [7:0] f_exp_a = fmt_a_a[109:102];
    wire [101:0] f_mant_a = fmt_a_a[101:0];
    ...
    wire f_sign_b = fmt_b_b[110];
    wire [7:0] f_exp_b = fmt_b_b[109:102];
    wire [101:0] f_mant_b = fmt_b_b[101:0];
    ...
    wire f_sign_c = fmt_c_c[110];
    wire [7:0] f_exp_c = fmt_c_c[109:102];
    wire [101:0] f_mant_c = fmt_c_c[101:0];
