...
`timescale 1ns / 1ps
// corona_compute_fp103_e12m90_fma_ax7203 — FP103_E12M90 FMA on AX7203.
module corona_compute_fp103_e12m90_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[101:90];
    ...
    wire [11:0] f_exp_b = fmt_b[101:90];
    ...
    wire [11:0] f_exp_c = fmt_c[101:90];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 90'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 90'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 102'b0};
