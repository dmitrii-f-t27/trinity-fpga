...
`timescale 1ns / 1ps
// corona_compute_fp99_e12m86_fma_ax7203 — FP99_E12M86 FMA on AX7203.
module corona_compute_fp99_e12m86_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[97:86];
    wire [85:0] f_mant_a = fmt_a[85:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -63'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[97:86];
    wire [85:0] f_mant_b = fmt_b[85:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -63'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[97:86];
    wire [85:0] f_mant_c = fmt_c[85:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -63'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 86'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 86'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 98'b0};
