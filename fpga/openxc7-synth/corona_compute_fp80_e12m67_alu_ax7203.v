...
`timescale 1ns / 1ps
// corona_compute_fp80_e12m67_alu_ax7203 — FP80_E12M67 ALU on AX7203.
module corona_compute_fp80_e12m67_alu_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r,op_r; reg [79:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [79:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [79:0] fmt_a=a_reg, fmt_b=b_reg;
    wire f_sign_a = fmt_a_a[79];
    wire [11:0] f_exp_a = fmt_a_a[78:67];
    ...
    wire f_sign_b = fmt_b_b[79];
    wire [11:0] f_exp_b = fmt_b_b[78:67];
    ...
    reg [79:0] q_result;
    always @(*) begin
        if(q_nan) q_result=80'd0;
        else if(q_zero) q_result=80'd0;
        else if(q_inf) q_result={q_sign, 12'd4095, 67'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 67'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 79'b0};
