...
`timescale 1ns / 1ps
// corona_compute_fp73_e10m62_alu_ax7203 — FP73_E10M62 ALU on AX7203.
module corona_compute_fp73_e10m62_alu_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[71:62];
    ...
    wire [9:0] f_exp_b = fmt_b_b[71:62];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 62'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 62'd0};
