...
`timescale 1ns / 1ps
// corona_decode_int64_ax7203 — signed int64 → FP32 decode on AX7203.
// int64_decode is authored in-repo. 8-byte code frame (64-bit input).
// Frame: AA 55 fmt b0 b1 b2 b3 b4 b5 b6 b7 trig -> A5 r0 r1 r2 r3.
module corona_decode_int64_ax7203 (
    ...
    int64_decode u_dec (.int64_in(code_r), .fp32_out(result), .is_zero_o(zero_flag), .is_inf_o(inf_flag));
    assign led[2] = |result;
