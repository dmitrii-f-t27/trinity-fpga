...
`timescale 1ns / 1ps
// corona_compute_fp45_e10m34_fma_ax7203 — FP45_E10M34 FMA on AX7203.
module corona_compute_fp45_e10m34_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 34'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 34'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 44'b0};
