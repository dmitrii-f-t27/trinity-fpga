...
`timescale 1ns / 1ps
// corona_compute_nf4_to_fp32_ax7203 — NF4 TO_FP32 on AX7203.
module corona_compute_nf4_to_fp32_ax7203 (
    ...
    reg [3:0] a_reg; reg conv_trigger;
    wire [3:0] code = a_reg;
    reg [31:0] fp32_val;
    always @(*) begin
        casez(code)
            4'd0: fp32_val = 32'hBF800000;
            4'd1: fp32_val = 32'hBF327000;
            4'd2: fp32_val = 32'hBF066000;
            4'd3: fp32_val = 32'hBECA4000;
            4'd4: fp32_val = 32'hBE91A000;
            4'd5: fp32_val = 32'hBE3D3000;
            4'd6: fp32_val = 32'hBDBA8000;
            4'd7: fp32_val = 32'h00000000;
            4'd8: fp32_val = 32'h3DA30000;
            4'd9: fp32_val = 32'h3E24F000;
            4'd10: fp32_val = 32'h3E7BF000;
            4'd11: fp32_val = 32'h3EAD2000;
            4'd12: fp32_val = 32'h3EE17000;
            4'd13: fp32_val = 32'h3F101000;
            4'd14: fp32_val = 32'h3F391000;
            4'd15: fp32_val = 32'h3F800000;
            default: fp32_val = 32'h00000000;
        endcase
    end
    always @(posedge mclk or posedge rst) begin
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(conv_trigger) result_reg<=fp32_val;
        end
    end
