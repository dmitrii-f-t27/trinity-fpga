...
`timescale 1ns / 1ps
// corona_compute_fp17_e8m8_mul_ax7203 — FP17_E8M8 MUL on AX7203.
module corona_compute_fp17_e8m8_mul_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [16:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [16:0] a_reg,b_reg; reg comp_trigger;
    wire [16:0] fmt_a=a_reg, fmt_b=b_reg;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={15'b0,q_result};
        end
    end
