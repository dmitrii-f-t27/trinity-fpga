...
`timescale 1ns / 1ps
// corona_compute_fp23_e8m14_fma_ax7203 — FP23_E8M14 FMA on AX7203.
module corona_compute_fp23_e8m14_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 14'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 14'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 22'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 8'b0, q_mant[22:9]};
        else q_result={q_sign, tgt_exp_s[7:0], q_mant[22:9]};
    end
