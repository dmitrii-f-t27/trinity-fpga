...
module corona_compute_fp77_e8m68_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[76];
    wire [7:0] f_exp_a = fmt_a[75:68];
    ...
    wire f_sign_b = fmt_b[76];
    wire [7:0] f_exp_b = fmt_b[75:68];
    ...
    wire f_sign_c = fmt_c[76];
    wire [7:0] f_exp_c = fmt_c[75:68];
