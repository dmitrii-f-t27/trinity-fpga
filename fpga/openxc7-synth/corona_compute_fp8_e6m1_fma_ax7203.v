...
`timescale 1ns / 1ps
// corona_compute_fp8_e6m1_fma_ax7203 — FP8_E6M1 FMA on AX7203.
module corona_compute_fp8_e6m1_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 6'd63, 1'd0};
        else if(q_exp >= 8'd160) q_result={q_sign, 6'd63, 1'd0};
        else if(q_exp < 8'd97) q_result={q_sign, 7'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 6'b0, q_mant[22:22]};
        else q_result={q_sign, tgt_exp_s[5:0], q_mant[22:22]};
    end
