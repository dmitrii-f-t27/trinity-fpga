...
`timescale 1ns / 1ps
// corona_decode_vax_g_ax7203 — VAX G_floating (64-bit) decode on AX7203.
// 64-bit decode frame: AA 55 fmt code[0..7] trig (12 bytes) -> A5 FP32 LE.
module corona_decode_vax_g_ax7203 (
    ...
    vax_g_decode u_dec (.vax_in(code_r[63:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
