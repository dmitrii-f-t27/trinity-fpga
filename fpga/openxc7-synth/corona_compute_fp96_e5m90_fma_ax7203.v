...
`timescale 1ns / 1ps
// corona_compute_fp96_e5m90_fma_ax7203 — FP96_E5M90 FMA on AX7203.
module corona_compute_fp96_e5m90_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 90'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 90'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 95'b0};
