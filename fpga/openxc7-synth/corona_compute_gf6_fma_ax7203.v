...
`timescale 1ns / 1ps
// corona_compute_gf6_fma_ax7203 — GoldenFloat6 FMA (y = a*b + c) on AX7203.
...
module corona_compute_gf6_fma_ax7203 (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;c_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                3'd4: begin b_r[5:0]<=rx_byte[5:0];frm<=3'd5; end
                3'd5: begin c_r[5:0]<=rx_byte[5:0];frm<=3'd6; end
