...
`timescale 1ns / 1ps
// corona_compute_gf24_add_ax7203 — GoldenFloat24 ADD on AX7203.
// GF24: [S:1][E:9][M:14] = 24 bits, BIAS=255, HAS_INF=0.
// 3 byte(s) per operand, 10-byte frame.
//
...
module corona_compute_gf24_add_ax7203 (
    ...
    wire [23:0] comp_result;

    gf_adder_param #(.EXP_BITS(9), .MANT_BITS(14), .HAS_INF(0)) u_comp (
        .clk(mclk), .rst(rst),
