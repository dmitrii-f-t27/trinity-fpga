...
`timescale 1ns / 1ps
// corona_compute_fp74_e8m65_alu_ax7203 — FP74_E8M65 ALU on AX7203.
module corona_compute_fp74_e8m65_alu_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[72:65];
    ...
    wire [7:0] f_exp_b = fmt_b_b[72:65];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 65'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 65'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 73'b0};
