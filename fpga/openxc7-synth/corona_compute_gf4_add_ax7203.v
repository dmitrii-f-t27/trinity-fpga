...
`timescale 1ns / 1ps
// corona_compute_gf4_add_ax7203 — GoldenFloat4 ADD on AX7203.
// GF4: [S:1][E:1][M:2] = 4 bits, BIAS=0, HAS_INF=0.
// 1 byte(s) per operand, 6-byte frame.
//
...
module corona_compute_gf4_add_ax7203 (
    ...
    gf_adder_param #(.EXP_BITS(1), .MANT_BITS(2), .HAS_INF(0)) u_comp (
        .clk(mclk), .rst(rst),
