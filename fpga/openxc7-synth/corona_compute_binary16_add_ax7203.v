...
`timescale 1ns / 1ps
// corona_compute_binary16_add_ax7203 — BINARY16 ADD on AX7203.
module corona_compute_binary16_add_ax7203 (
    ...
    wire comp_irdy,comp_ovld; wire [15:0] comp_result;
    gf_adder_param #(.EXP_BITS(5),.MANT_BITS(10),.HAS_INF(1)) u_comp (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={{16{1'b0}},comp_result};
        end
    end
