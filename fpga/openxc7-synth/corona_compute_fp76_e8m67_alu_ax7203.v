...
`timescale 1ns / 1ps
// corona_compute_fp76_e8m67_alu_ax7203 — FP76_E8M67 ALU on AX7203.
module corona_compute_fp76_e8m67_alu_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[74:67];
    wire [66:0] f_mant_a = fmt_a_a[66:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -44'b0};
    ...
    wire [7:0] f_exp_b = fmt_b_b[74:67];
    wire [66:0] f_mant_b = fmt_b_b[66:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -44'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 67'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 67'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 75'b0};
