...
module corona_compute_fp119_e8m110_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[118];
    wire [7:0] f_exp_a = fmt_a_a[117:110];
    wire [109:0] f_mant_a = fmt_a_a[109:0];
    ...
    wire f_sign_b = fmt_b_b[118];
    wire [7:0] f_exp_b = fmt_b_b[117:110];
    wire [109:0] f_mant_b = fmt_b_b[109:0];
    ...
    wire f_sign_c = fmt_c_c[118];
    wire [7:0] f_exp_c = fmt_c_c[117:110];
    wire [109:0] f_mant_c = fmt_c_c[109:0];
