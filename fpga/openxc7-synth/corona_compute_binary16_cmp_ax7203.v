...
`timescale 1ns / 1ps
// corona_compute_binary16_cmp_ax7203 — BINARY16 CMP on AX7203.
module corona_compute_binary16_cmp_ax7203 (
    ...
    wire sa=a_reg[15]; wire [4:0] ea=a_reg[14:10]; wire [9:0] ma=a_reg[9:0];
    wire sb=b_reg[15]; wire [4:0] eb=b_reg[14:10]; wire [9:0] mb=b_reg[9:0];
    wire az=(ea==0)&&(ma==0); wire bz=(eb==0)&&(mb==0);
    wire an=(1)&&(ea=={5{1'b1}})&&(ma!=0); wire bn=(1)&&(eb=={5{1'b1}})&&(mb!=0);
    wire [14:0] aa={ea,ma}; wire [14:0] ab={eb,mb};
