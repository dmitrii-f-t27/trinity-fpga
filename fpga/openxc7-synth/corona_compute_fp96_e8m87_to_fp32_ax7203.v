...
`timescale 1ns / 1ps
// corona_compute_fp96_e8m87_to_fp32_ax7203 — FP96_E8M87 TO_FP32 on AX7203.
module corona_compute_fp96_e8m87_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [95:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd14: begin a_r[95:88]<=rx_byte;frm<=4'd15; end
