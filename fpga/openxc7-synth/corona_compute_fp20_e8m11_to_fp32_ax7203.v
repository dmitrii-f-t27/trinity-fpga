...
`timescale 1ns / 1ps
// corona_compute_fp20_e8m11_to_fp32_ax7203 — FP20_E8M11 TO_FP32 on AX7203.
module corona_compute_fp20_e8m11_to_fp32_ax7203 (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                3'd5: begin a_r[19:16]<=rx_byte;frm<=3'd6; end
    ...
    reg [19:0] a_reg; reg conv_trigger;
    wire [19:0] fmt_a = a_reg;
