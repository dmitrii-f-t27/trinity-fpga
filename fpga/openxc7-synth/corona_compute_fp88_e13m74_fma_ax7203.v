...
`timescale 1ns / 1ps
// corona_compute_fp88_e13m74_fma_ax7203 — FP88_E13M74 FMA on AX7203.
module corona_compute_fp88_e13m74_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 74'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 74'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 87'b0};
