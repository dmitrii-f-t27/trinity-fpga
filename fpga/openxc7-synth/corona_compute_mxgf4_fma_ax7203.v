...
`timescale 1ns / 1ps
// corona_compute_mxgf4_fma_ax7203 — MXGF4 FMA on AX7203.
module corona_compute_mxgf4_fma_ax7203 (
    ...
    always @(*) begin
        case(fmt_a[3:0])
            4'd0: fp32_a=32'h00000000;
            4'd1: fp32_a=32'h3f000000;
            4'd2: fp32_a=32'h3f800000;
            4'd3: fp32_a=32'h3fc00000;
            4'd4: fp32_a=32'h40000000;
            4'd5: fp32_a=32'h40200000;
            4'd6: fp32_a=32'h40400000;
            4'd7: fp32_a=32'h40600000;
            4'd8: fp32_a=32'h80000000;
            4'd9: fp32_a=32'hbf000000;
            4'd10: fp32_a=32'hbf800000;
            4'd11: fp32_a=32'hbfc00000;
            4'd12: fp32_a=32'hc0000000;
            4'd13: fp32_a=32'hc0200000;
            4'd14: fp32_a=32'hc0400000;
            4'd15: fp32_a=32'hc0600000;
    ...
    always @(*) begin
        case(fmt_b[3:0])
            4'd0: fp32_b=32'h00000000;
            4'd1: fp32_b=32'h3f000000;
            4'd2: fp32_b=32'h3f800000;
            4'd3: fp32_b=32'h3fc00000;
            4'd4: fp32_b=32'h40000000;
            4'd5: fp32_b=32'h40200000;
            4'd6: fp32_b=32'h40400000;
            4'd7: fp32_b=32'h40600000;
            4'd8: fp32_b=32'h80000000;
            4'd9: fp32_b=32'hbf000000;
            4'd10: fp32_b=32'hbf800000;
            4'd11: fp32_b=32'hbfc00000;
            4'd12: fp32_b=32'hc0000000;
            4'd13: fp32_b=32'hc0200000;
            4'd14: fp32_b=32'hc0400000;
            4'd15: fp32_b=32'hc0600000;
    ...
    always @(*) begin
        case(fmt_c[3:0])
            4'd0: fp32_c=32'h00000000;
            4'd1: fp32_c=32'h3f000000;
            4'd2: fp32_c=32'h3f800000;
            4'd3: fp32_c=32'h3fc00000;
            4'd4: fp32_c=32'h40000000;
            4'd5: fp32_c=32'h40200000;
            4'd6: fp32_c=32'h40400000;
            4'd7: fp32_c=32'h40600000;
            4'd8: fp32_c=32'h80000000;
            4'd9: fp32_c=32'hbf000000;
            4'd10: fp32_c=32'hbf800000;
            4'd11: fp32_c=32'hbfc00000;
            4'd12: fp32_c=32'hc0000000;
            4'd13: fp32_c=32'hc0200000;
            4'd14: fp32_c=32'hc0400000;
            4'd15: fp32_c=32'hc0600000;
    ...
    always @(*) begin
        ...
        else if(q_exp >= 8'd129) q_result={q_sign, 3'd7};
        else if(q_exp < 8'd128) q_result={q_sign, 3'd0};
