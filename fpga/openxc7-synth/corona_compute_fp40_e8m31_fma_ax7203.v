...
`timescale 1ns / 1ps
// corona_compute_fp40_e8m31_fma_ax7203 — FP40_E8M31 FMA on AX7203.
module corona_compute_fp40_e8m31_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a[38:31];
    wire [30:0] f_mant_a = fmt_a[30:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -8'b0};
    ...
    wire [7:0] f_exp_b = fmt_b[38:31];
    wire [30:0] f_mant_b = fmt_b[30:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -8'b0};
    ...
    wire [7:0] f_exp_c = fmt_c[38:31];
    wire [30:0] f_mant_c = fmt_c[30:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -8'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 31'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 31'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 39'b0};
