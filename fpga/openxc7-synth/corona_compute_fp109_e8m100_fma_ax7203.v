...
module corona_compute_fp109_e8m100_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[108];
    wire [7:0] f_exp_a = fmt_a_a[107:100];
    wire [99:0] f_mant_a = fmt_a_a[99:0];
    ...
    wire f_sign_b = fmt_b_b[108];
    wire [7:0] f_exp_b = fmt_b_b[107:100];
    wire [99:0] f_mant_b = fmt_b_b[99:0];
    ...
    wire f_sign_c = fmt_c_c[108];
    wire [7:0] f_exp_c = fmt_c_c[107:100];
    wire [99:0] f_mant_c = fmt_c_c[99:0];
