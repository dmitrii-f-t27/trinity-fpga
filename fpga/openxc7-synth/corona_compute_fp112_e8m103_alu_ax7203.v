...
`timescale 1ns / 1ps
// corona_compute_fp112_e8m103_alu_ax7203 — FP112_E8M103 ALU on AX7203.
module corona_compute_fp112_e8m103_alu_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r,op_r; reg [111:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [111:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [111:0] fmt_a=a_reg, fmt_b=b_reg;
