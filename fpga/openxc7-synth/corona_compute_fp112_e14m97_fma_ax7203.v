...
`timescale 1ns / 1ps
// corona_compute_fp112_e14m97_fma_ax7203 — FP112_E14M97 FMA on AX7203.
module corona_compute_fp112_e14m97_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[110:97];
    ...
    wire [13:0] f_exp_b = fmt_b[110:97];
    wire [96:0] f_mant_b = fmt_b[96:0];
    wire f_zero_b = (f_exp_b == 0) && ((f_mant_b == 0));
    wire f_inf_b = (f_exp_b == 16383) && ((f_mant_b == 0));
    wire f_nan_b = (f_exp_b == 16383) && ((f_mant_b != 0));
    wire f_sub_b = (f_exp_b == 0) && ((f_mant_b != 0));
    wire signed [23:0] f_de_b = $signed({1'b0, f_exp_b}) - 24'sd8191 + 24'sd127;
    wire [7:0] f_exp32_b = (f_de_b > 24'sd254) ? 8'd254 : (f_de_b < 0) ? 8'd0 : f_de_b[7:0];
    ...
    wire [13:0] f_exp_c = fmt_c[110:97];
    wire [96:0] f_mant_c = fmt_c[96:0];
    wire f_zero_c = (f_exp_c == 0) && ((f_mant_c == 0));
    wire f_inf_c = (f_exp_c == 16383) && ((f_mant_c == 0));
    wire f_nan_c = (f_exp_c == 16383) && ((f_mant_c != 0));
    wire f_sub_c = (f_exp_c == 0) && ((f_mant_c != 0));
    wire signed [23:0] f_de_c = $signed({1'b0, f_exp_c}) - 24'sd8191 + 24'sd127;
    wire [7:0] f_exp32_c = (f_de_c > 24'sd254) ? 8'd254 : (f_de_c < 0) ? 8'd0 : f_de_c[7:0];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 97'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 97'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 111'b0};
