...
`timescale 1ns / 1ps
// corona_compute_fp75_e8m66_alu_ax7203 — FP75_E8M66 ALU on AX7203.
module corona_compute_fp75_e8m66_alu_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[73:66];
    ...
    wire [7:0] f_exp_b = fmt_b_b[73:66];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 66'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 66'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 74'b0};
