...
`timescale 1ns / 1ps
// corona_compute_fp63_e11m51_fma_ax7203 — FP63_E11M51 FMA on AX7203.
module corona_compute_fp63_e11m51_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 51'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 51'd0};
