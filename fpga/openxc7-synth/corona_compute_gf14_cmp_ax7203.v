...
`timescale 1ns / 1ps
// corona_compute_gf14_cmp_ax7203 — GoldenFloat14 comparison on AX7203.
...
module corona_compute_gf14_cmp_ax7203 (
    ...
    wire        sa = a_reg[13];
    wire [4:0] ea = a_reg[12:8];
    wire [7:0] ma = a_reg[7:0];
    wire        sb = b_reg[13];
    wire [4:0] eb = b_reg[12:8];
    wire [7:0] mb = b_reg[7:0];
    ...
    wire [12:0] abs_a = {ea, ma};
    wire [12:0] abs_b = {eb, mb};
