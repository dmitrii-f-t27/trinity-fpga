...
module corona_compute_fp7_e4m2_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[6];
    wire [3:0] f_exp_a = fmt_a[5:2];
    ...
    wire f_sign_b = fmt_b[6];
    wire [3:0] f_exp_b = fmt_b[5:2];
    ...
    wire f_sign_c = fmt_c[6];
    wire [3:0] f_exp_c = fmt_c[5:2];
    wire [1:0] f_mant_c = fmt_c[1:0];
