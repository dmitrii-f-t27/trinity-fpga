...
`timescale 1ns / 1ps
// corona_compute_fp101_e12m88_fma_ax7203 — FP101_E12M88 FMA on AX7203.
module corona_compute_fp101_e12m88_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 88'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 88'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 100'b0};
