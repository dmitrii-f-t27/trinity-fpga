...
module corona_compute_fp43_e8m34_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[42];
    wire [7:0] f_exp_a = fmt_a_a[41:34];
    wire [33:0] f_mant_a = fmt_a_a[33:0];
    ...
    wire f_sign_b = fmt_b_b[42];
    wire [7:0] f_exp_b = fmt_b_b[41:34];
    wire [33:0] f_mant_b = fmt_b_b[33:0];
    ...
    wire f_sign_c = fmt_c_c[42];
    wire [7:0] f_exp_c = fmt_c_c[41:34];
    wire [33:0] f_mant_c = fmt_c_c[33:0];
