...
`timescale 1ns / 1ps
// corona_decode_x87_fp80_ax7203 — x87 80-bit → FP32 decode on AX7203.
// 16-byte code frame (128-bit input).
module corona_decode_x87_fp80_ax7203 (
    ...
    x87_fp80_decode u_dec (.x87_in(code_r[79:0]), .fp32_out(result), .is_zero(zero_flag));
    assign led[2] = |result;
