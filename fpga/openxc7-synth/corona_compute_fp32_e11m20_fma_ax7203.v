...
`timescale 1ns / 1ps
// corona_compute_fp32_e11m20_fma_ax7203 — FP32_E11M20 FMA on AX7203.
module corona_compute_fp32_e11m20_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 20'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 20'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 31'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 11'b0, q_mant[22:3]};
        else q_result={q_sign, tgt_exp_s[10:0], q_mant[22:3]};
    end
