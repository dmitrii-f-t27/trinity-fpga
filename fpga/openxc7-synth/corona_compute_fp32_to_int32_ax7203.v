...
`timescale 1ns / 1ps
// corona_compute_fp32_to_int32_ax7203 — INT32 FP32_TO on AX7203.
module corona_compute_fp32_to_int32_ax7203 (
    ...
    always @(*) begin
        if(is_zero||is_nan) int_result=0;
            ...
            int_result = sign_v ? -$signed(tmp_mant[31:0]) : $signed(tmp_mant[31:0]);
        end
    end
    always @(posedge mclk or posedge rst) begin
