...
`timescale 1ns / 1ps
// corona_compute_fp94_e10m83_add_ax7203 — FP94_E10M83 ADD on AX7203.
module corona_compute_fp94_e10m83_add_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[92:83];
    ...
    wire [9:0] f_exp_b = fmt_b_b[92:83];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 83'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 83'd0};
