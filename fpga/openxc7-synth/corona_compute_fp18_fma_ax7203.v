...
`timescale 1ns / 1ps
// corona_compute_fp18_fma_ax7203 — FP18 FMA on AX7203.
module corona_compute_fp18_fma_ax7203 (
    ...
    wire signed [9:0] f_de_a = $signed({1'b0, f_exp_a}) - 10'sd31 + 10'sd127;
    ...
    wire signed [9:0] f_de_b = $signed({1'b0, f_exp_b}) - 10'sd31 + 10'sd127;
    ...
    wire signed [9:0] f_de_c = $signed({1'b0, f_exp_c}) - 10'sd31 + 10'sd127;
    ...
    wire signed [9:0] tgt_exp_s = $signed({1'b0, q_exp}) - 10'sd127 + 10'sd31;
    reg [17:0] q_result;
    always @(*) begin
        if(q_nan) q_result=18'd0;
        else if(q_zero) q_result=18'd0;
        else if(q_inf) q_result={q_sign, 6'd63, 11'd0};
        else if(q_exp >= 8'd160) q_result={q_sign, 6'd63, 11'd0};
        else if(q_exp < 8'd97) q_result={q_sign, 17'b0};
