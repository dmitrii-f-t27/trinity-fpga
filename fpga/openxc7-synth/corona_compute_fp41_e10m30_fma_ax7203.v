...
`timescale 1ns / 1ps
// corona_compute_fp41_e10m30_fma_ax7203 — FP41_E10M30 FMA on AX7203.
module corona_compute_fp41_e10m30_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 30'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 30'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 40'b0};
