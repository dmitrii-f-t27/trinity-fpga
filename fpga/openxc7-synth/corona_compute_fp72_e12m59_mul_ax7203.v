...
`timescale 1ns / 1ps
// corona_compute_fp72_e12m59_mul_ax7203 — FP72_E12M59 MUL on AX7203.
module corona_compute_fp72_e12m59_mul_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [71:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [71:0] a_reg,b_reg; reg comp_trigger;
