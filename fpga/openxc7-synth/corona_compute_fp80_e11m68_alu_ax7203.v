...
`timescale 1ns / 1ps
// corona_compute_fp80_e11m68_alu_ax7203 — FP80_E11M68 ALU on AX7203.
module corona_compute_fp80_e11m68_alu_ax7203 (
    ...
    wire [10:0] f_exp_a = fmt_a_a[78:68];
    ...
    wire [10:0] f_exp_b = fmt_b_b[78:68];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 68'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 68'd0};
