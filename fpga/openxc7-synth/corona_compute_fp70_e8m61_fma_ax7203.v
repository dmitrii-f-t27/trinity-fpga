...
module corona_compute_fp70_e8m61_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[69];
    wire [7:0] f_exp_a = fmt_a_a[68:61];
    wire [60:0] f_mant_a = fmt_a_a[60:0];
    ...
    wire f_sign_b = fmt_b_b[69];
    wire [7:0] f_exp_b = fmt_b_b[68:61];
    wire [60:0] f_mant_b = fmt_b_b[60:0];
    ...
    wire f_sign_c = fmt_c_c[69];
    wire [7:0] f_exp_c = fmt_c_c[68:61];
    wire [60:0] f_mant_c = fmt_c_c[60:0];
