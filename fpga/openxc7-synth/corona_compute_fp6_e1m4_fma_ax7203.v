...
`timescale 1ns / 1ps
// corona_compute_fp6_e1m4_fma_ax7203 — FP6_E1M4 FMA on AX7203.
module corona_compute_fp6_e1m4_fma_ax7203 (
    ...
    wire signed [10:0] f_de_a = $signed({1'b0, f_exp_a}) - 11'sd1 + 11'sd127;
    ...
    wire signed [10:0] f_de_b = $signed({1'b0, f_exp_b}) - 11'sd1 + 11'sd127;
    ...
    wire signed [10:0] f_de_c = $signed({1'b0, f_exp_c}) - 11'sd1 + 11'sd127;
    ...
    always @(*) begin
        ...
        else if(f_sub_c) fp32_c={f_sign_c, 8'd127, f_mant32_norm_c};
    ...
    wire signed [10:0] tgt_exp_s = $signed({1'b0, q_exp}) - 11'sd127 + 11'sd1;
    reg [5:0] q_result;
    always @(*) begin
        if(q_nan) q_result=6'd0;
        else if(q_zero) q_result=6'd0;
        else if(q_inf) q_result={q_sign, 1'd1, 4'd0};
        else if(q_exp >= 8'd128) q_result={q_sign, 1'd1, 4'd0};
        else if(q_exp < 8'd127) q_result={q_sign, 5'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 1'b0, q_mant[22:19]};
        else q_result={q_sign, tgt_exp_s[0:0], q_mant[22:19]};
    end
