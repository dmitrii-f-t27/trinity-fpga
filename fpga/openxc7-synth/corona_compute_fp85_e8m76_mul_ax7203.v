...
`timescale 1ns / 1ps
// corona_compute_fp85_e8m76_mul_ax7203 — FP85_E8M76 MUL on AX7203.
module corona_compute_fp85_e8m76_mul_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [84:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd13: begin a_r[84:80]<=rx_byte;frm<=5'd14; end
                ...
                5'd24: begin b_r[84:80]<=rx_byte;frm<=5'd25; end
    ...
    reg [84:0] a_reg,b_reg; reg comp_trigger;
