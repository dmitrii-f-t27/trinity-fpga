...
module corona_compute_fp10_e6m3_fma_ax7203 (
    ...
    wire [5:0] f_exp_a = fmt_a_a[8:3];
    wire [2:0] f_mant_a = fmt_a_a[2:0];
    ...
    wire [5:0] f_exp_b = fmt_b_b[8:3];
    wire [2:0] f_mant_b = fmt_b_b[2:0];
    ...
    wire [5:0] f_exp_c = fmt_c_c[8:3];
    wire [2:0] f_mant_c = fmt_c_c[2:0];
