...
`timescale 1ns / 1ps
// corona_compute_fp10_e6m3_fma_ax7203 — FP10_E6M3 FMA on AX7203.
module corona_compute_fp10_e6m3_fma_ax7203 (
    ...
    wire [5:0] f_exp_a = fmt_a[8:3];
    wire [2:0] f_mant_a = fmt_a[2:0];
    ...
    wire [22:0] f_mant32_norm_a = {1'b0, f_mant_a, 19'b0};
    reg [31:0] fp32_a;
    always @(*) begin
    ...
    wire [5:0] f_exp_b = fmt_b[8:3];
    wire [2:0] f_mant_b = fmt_b[2:0];
    ...
    wire [22:0] f_mant32_norm_b = {1'b0, f_mant_b, 19'b0};
    reg [31:0] fp32_b;
    always @(*) begin
    ...
    wire [5:0] f_exp_c = fmt_c[8:3];
    wire [2:0] f_mant_c = fmt_c[2:0];
    ...
    wire [22:0] f_mant32_norm_c = {1'b0, f_mant_c, 19'b0};
    reg [31:0] fp32_c;
    always @(*) begin
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 6'd63, 3'd0};
        else if(q_exp >= 8'd160) q_result={q_sign, 6'd63, 3'd0};
        else if(q_exp < 8'd97) q_result={q_sign, 9'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 6'b0, q_mant[22:20]};
        else q_result={q_sign, tgt_exp_s[5:0], q_mant[22:20]};
    end
