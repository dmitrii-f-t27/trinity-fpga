...
module corona_compute_fp21_e6m14_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[20];
    wire [5:0] f_exp_a = fmt_a_a[19:14];
    wire [13:0] f_mant_a = fmt_a_a[13:0];
    ...
    wire f_sign_b = fmt_b_b[20];
    wire [5:0] f_exp_b = fmt_b_b[19:14];
    wire [13:0] f_mant_b = fmt_b_b[13:0];
    ...
    wire f_sign_c = fmt_c_c[20];
    wire [5:0] f_exp_c = fmt_c_c[19:14];
    wire [13:0] f_mant_c = fmt_c_c[13:0];
