...
`timescale 1ns / 1ps
// corona_compute_fp27_e8m18_alu_ax7203 — FP27_E8M18 ALU on AX7203.
module corona_compute_fp27_e8m18_alu_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r,op_r; reg [26:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd7: begin a_r[26:24]<=rx_byte;frm<=4'd8; end
                ...
                4'd11: begin b_r[26:24]<=rx_byte;frm<=4'd12; end
    ...
    reg [26:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(ovld) result_reg<={5'b0,q_result};
        end
    end
