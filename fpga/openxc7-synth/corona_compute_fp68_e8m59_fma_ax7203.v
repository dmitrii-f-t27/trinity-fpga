...
`timescale 1ns / 1ps
// corona_compute_fp68_e8m59_fma_ax7203 — FP68_E8M59 FMA on AX7203.
module corona_compute_fp68_e8m59_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a[66:59];
    wire [58:0] f_mant_a = fmt_a[58:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -36'b0};
    ...
    wire [7:0] f_exp_b = fmt_b[66:59];
    wire [58:0] f_mant_b = fmt_b[58:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -36'b0};
    ...
    wire [7:0] f_exp_c = fmt_c[66:59];
    wire [58:0] f_mant_c = fmt_c[58:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -36'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 59'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 59'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 67'b0};
