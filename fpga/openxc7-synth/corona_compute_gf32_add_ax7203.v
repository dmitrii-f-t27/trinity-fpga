...
`timescale 1ns / 1ps
// corona_compute_gf32_add_ax7203 — GoldenFloat32 ADD on AX7203.
...
module corona_compute_gf32_add_ax7203 (
    ...
    gf_adder_param #(.EXP_BITS(12), .MANT_BITS(19), .HAS_INF(0)) u_comp (
        .clk(mclk), .rst(rst),
