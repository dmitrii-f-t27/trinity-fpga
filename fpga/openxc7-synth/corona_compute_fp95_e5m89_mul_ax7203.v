...
`timescale 1ns / 1ps
// corona_compute_fp95_e5m89_mul_ax7203 — FP95_E5M89 MUL on AX7203.
module corona_compute_fp95_e5m89_mul_ax7203 (
    ...
    wire [4:0] f_exp_a = fmt_a_a[93:89];
    ...
    wire [4:0] f_exp_b = fmt_b_b[93:89];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 89'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 89'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 94'b0};
