...
module corona_compute_fp9_e4m4_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[8];
    wire [3:0] f_exp_a = fmt_a[7:4];
    ...
    wire f_sign_b = fmt_b[8];
    wire [3:0] f_exp_b = fmt_b[7:4];
    ...
    wire f_sign_c = fmt_c[8];
    wire [3:0] f_exp_c = fmt_c[7:4];
    wire [3:0] f_mant_c = fmt_c[3:0];
