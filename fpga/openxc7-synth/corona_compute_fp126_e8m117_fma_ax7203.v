...
module corona_compute_fp126_e8m117_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[125];
    wire [7:0] f_exp_a = fmt_a_a[124:117];
    wire [116:0] f_mant_a = fmt_a_a[116:0];
    ...
    wire f_sign_b = fmt_b_b[125];
    wire [7:0] f_exp_b = fmt_b_b[124:117];
    wire [116:0] f_mant_b = fmt_b_b[116:0];
    ...
    wire f_sign_c = fmt_c_c[125];
    wire [7:0] f_exp_c = fmt_c_c[124:117];
    wire [116:0] f_mant_c = fmt_c_c[116:0];
