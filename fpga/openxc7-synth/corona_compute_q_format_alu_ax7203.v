...
`timescale 1ns / 1ps
// corona_compute_q_format_alu_ax7203 — Q_FORMAT ALU on AX7203.
module corona_compute_q_format_alu_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r,op_r; reg [15:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
