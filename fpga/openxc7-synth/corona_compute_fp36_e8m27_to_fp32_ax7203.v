...
`timescale 1ns / 1ps
// corona_compute_fp36_e8m27_to_fp32_ax7203 — FP36_E8M27 TO_FP32 on AX7203.
module corona_compute_fp36_e8m27_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [35:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [35:0] a_reg; reg conv_trigger;
    wire [35:0] fmt_a = a_reg;
