...
`timescale 1ns / 1ps
// corona_compute_fp85_e13m71_fma_ax7203 — FP85_E13M71 FMA on AX7203.
module corona_compute_fp85_e13m71_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[83:71];
    wire [70:0] f_mant_a = fmt_a[70:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -48'b0};
    ...
    wire [12:0] f_exp_b = fmt_b[83:71];
    wire [70:0] f_mant_b = fmt_b[70:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -48'b0};
    ...
    wire [12:0] f_exp_c = fmt_c[83:71];
    wire [70:0] f_mant_c = fmt_c[70:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -48'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 71'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 71'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 84'b0};
