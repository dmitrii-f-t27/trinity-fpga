...
`timescale 1ns / 1ps
// corona_decode_decimal32_ax7203 — IEEE 754 decimal32 (BID) decode on AX7203.
// 32-bit decode frame: AA 55 fmt code[3:0] trig (8 bytes) -> A5 FP32 LE.
// Infrastructure identical to corona_decode_binary32_ax7203; only the decoder differs
// (decimal32_decode: value = (-1)^s * C * 10^(E-101), RNE to binary32).
module corona_decode_decimal32_ax7203 (
    ...
    wire [31:0] result;
    decimal32_decode u_dec (.bid32(code_r[31:0]), .fp32_out(result));
    assign led[2] = |result;
