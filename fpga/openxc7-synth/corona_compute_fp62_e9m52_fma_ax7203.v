...
module corona_compute_fp62_e9m52_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[61];
    wire [8:0] f_exp_a = fmt_a_a[60:52];
    ...
    wire f_sign_b = fmt_b_b[61];
    wire [8:0] f_exp_b = fmt_b_b[60:52];
    ...
    wire f_sign_c = fmt_c_c[61];
    wire [8:0] f_exp_c = fmt_c_c[60:52];
