...
module corona_compute_fp3_e1m1_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[2];
    wire [0:0] f_exp_a = fmt_a_a[1:1];
    wire [0:0] f_mant_a = fmt_a_a[0:0];
    ...
    wire f_sign_b = fmt_b_b[2];
    wire [0:0] f_exp_b = fmt_b_b[1:1];
    wire [0:0] f_mant_b = fmt_b_b[0:0];
    ...
    wire f_sign_c = fmt_c_c[2];
    wire [0:0] f_exp_c = fmt_c_c[1:1];
    wire [0:0] f_mant_c = fmt_c_c[0:0];
