...
`timescale 1ns / 1ps
// corona_compute_fp85_e8m76_to_fp32_ax7203 — FP85_E8M76 TO_FP32 on AX7203.
module corona_compute_fp85_e8m76_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [84:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd13: begin a_r[84:80]<=rx_byte;frm<=4'd14; end
    ...
    reg [84:0] a_reg; reg conv_trigger;
    wire [84:0] fmt_a = a_reg;
