...
module corona_compute_fp94_e8m85_add_ax7203 (
    ...
    wire f_sign_a = fmt_a[93];
    wire [7:0] f_exp_a = fmt_a[92:85];
    wire [84:0] f_mant_a = fmt_a[84:0];
    ...
    wire f_sign_b = fmt_b[93];
    wire [7:0] f_exp_b = fmt_b[92:85];
    wire [84:0] f_mant_b = fmt_b[84:0];
