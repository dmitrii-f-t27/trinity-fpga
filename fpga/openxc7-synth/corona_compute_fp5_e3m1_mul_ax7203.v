...
`timescale 1ns / 1ps
// corona_compute_fp5_e3m1_mul_ax7203 — FP5_E3M1 MUL on AX7203.
module corona_compute_fp5_e3m1_mul_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [4:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [4:0] a_reg,b_reg; reg comp_trigger;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={27'b0,q_result};
        end
    end
