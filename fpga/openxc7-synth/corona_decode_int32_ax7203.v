...
`timescale 1ns / 1ps
// corona_decode_int32_ax7203 — INT32 decode on AX7203 (32-bit decode frame).
// Same 32-bit decode frame as binary32 (4 code bytes). INT32 = identity (already 32-bit).
module corona_decode_int32_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero;
    int32_decode u_dec (.int32_in(code_r[31:0]), .int32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
