...
`timescale 1ns / 1ps
// corona_compute_fp123_e14m108_fma_ax7203 — FP123_E14M108 FMA on AX7203.
module corona_compute_fp123_e14m108_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[121:108];
    ...
    wire [13:0] f_exp_b = fmt_b[121:108];
    ...
    wire [13:0] f_exp_c = fmt_c[121:108];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 108'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 108'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 122'b0};
