...
`timescale 1ns / 1ps
// corona_compute_fp77_e10m66_alu_ax7203 — FP77_E10M66 ALU on AX7203.
module corona_compute_fp77_e10m66_alu_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[75:66];
    ...
    wire [9:0] f_exp_b = fmt_b_b[75:66];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 66'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 66'd0};
