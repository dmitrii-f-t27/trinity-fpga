...
`timescale 1ns / 1ps
// corona_compute_binary16_fma_ax7203 — BINARY16 FMA on AX7203.
module corona_compute_binary16_fma_ax7203 (
    ...
    wire mul_irdy,mul_ovld; wire [15:0] mul_result;
    wire add_irdy,add_ovld; wire [15:0] add_result;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(add_ovld) result_reg<={{16{1'b0}},add_result};
        end
    end
