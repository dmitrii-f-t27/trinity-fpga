...
`timescale 1ns / 1ps
// corona_compute_fp122_e14m107_fma_ax7203 — FP122_E14M107 FMA on AX7203.
module corona_compute_fp122_e14m107_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[120:107];
    ...
    wire [13:0] f_exp_b = fmt_b[120:107];
    ...
    wire [13:0] f_exp_c = fmt_c[120:107];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 107'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 107'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 121'b0};
