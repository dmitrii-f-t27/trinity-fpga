...
`timescale 1ns / 1ps
// corona_compute_fp76_e10m65_alu_ax7203 — FP76_E10M65 ALU on AX7203.
module corona_compute_fp76_e10m65_alu_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[74:65];
    ...
    wire [9:0] f_exp_b = fmt_b_b[74:65];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 65'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 65'd0};
