...
module corona_compute_fp63_e9m53_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[62];
    wire [8:0] f_exp_a = fmt_a_a[61:53];
    wire [52:0] f_mant_a = fmt_a_a[52:0];
    ...
    wire f_sign_b = fmt_b_b[62];
    wire [8:0] f_exp_b = fmt_b_b[61:53];
    wire [52:0] f_mant_b = fmt_b_b[52:0];
    ...
    wire f_sign_c = fmt_c_c[62];
    wire [8:0] f_exp_c = fmt_c_c[61:53];
    wire [52:0] f_mant_c = fmt_c_c[52:0];
