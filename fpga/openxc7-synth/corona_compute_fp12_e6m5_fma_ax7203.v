...
module corona_compute_fp12_e6m5_fma_ax7203 (
    ...
    wire [5:0] f_exp_a = fmt_a_a[10:5];
    wire [4:0] f_mant_a = fmt_a_a[4:0];
    ...
    wire [5:0] f_exp_b = fmt_b_b[10:5];
    wire [4:0] f_mant_b = fmt_b_b[4:0];
    ...
    wire [5:0] f_exp_c = fmt_c_c[10:5];
    wire [4:0] f_mant_c = fmt_c_c[4:0];
