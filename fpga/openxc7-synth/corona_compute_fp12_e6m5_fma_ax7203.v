...
`timescale 1ns / 1ps
// corona_compute_fp12_e6m5_fma_ax7203 — FP12_E6M5 FMA on AX7203.
module corona_compute_fp12_e6m5_fma_ax7203 (
    ...
    wire [5:0] f_exp_a = fmt_a[10:5];
    wire [4:0] f_mant_a = fmt_a[4:0];
    ...
    wire [22:0] f_mant32_norm_a = {1'b0, f_mant_a, 17'b0};
    reg [31:0] fp32_a;
    always @(*) begin
    ...
    wire [5:0] f_exp_b = fmt_b[10:5];
    wire [4:0] f_mant_b = fmt_b[4:0];
    ...
    wire [22:0] f_mant32_norm_b = {1'b0, f_mant_b, 17'b0};
    reg [31:0] fp32_b;
    always @(*) begin
    ...
    wire [5:0] f_exp_c = fmt_c[10:5];
    wire [4:0] f_mant_c = fmt_c[4:0];
    ...
    wire [22:0] f_mant32_norm_c = {1'b0, f_mant_c, 17'b0};
    reg [31:0] fp32_c;
    always @(*) begin
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 6'd63, 5'd0};
        else if(q_exp >= 8'd160) q_result={q_sign, 6'd63, 5'd0};
        else if(q_exp < 8'd97) q_result={q_sign, 11'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 6'b0, q_mant[22:18]};
        else q_result={q_sign, tgt_exp_s[5:0], q_mant[22:18]};
    end
