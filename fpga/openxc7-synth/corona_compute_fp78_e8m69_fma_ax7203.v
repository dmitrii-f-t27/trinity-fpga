...
module corona_compute_fp78_e8m69_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[77];
    wire [7:0] f_exp_a = fmt_a[76:69];
    ...
    wire f_sign_b = fmt_b[77];
    wire [7:0] f_exp_b = fmt_b[76:69];
    ...
    wire f_sign_c = fmt_c[77];
    wire [7:0] f_exp_c = fmt_c[76:69];
