...
`timescale 1ns / 1ps
// corona_compute_fp75_e12m62_add_ax7203 — FP75_E12M62 ADD on AX7203.
module corona_compute_fp75_e12m62_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [74:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd12: begin a_r[74:72]<=rx_byte;frm<=5'd13; end
                ...
                5'd22: begin b_r[74:72]<=rx_byte;frm<=5'd23; end
    ...
    reg [74:0] a_reg,b_reg; reg comp_trigger;
