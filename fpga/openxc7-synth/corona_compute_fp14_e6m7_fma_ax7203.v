...
module corona_compute_fp14_e6m7_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[13];
    wire [5:0] f_exp_a = fmt_a_a[12:7];
    ...
    wire f_sign_b = fmt_b_b[13];
    wire [5:0] f_exp_b = fmt_b_b[12:7];
    ...
    wire f_sign_c = fmt_c_c[13];
    wire [5:0] f_exp_c = fmt_c_c[12:7];
