...
module corona_compute_fp112_e8m103_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[111];
    wire [7:0] f_exp_a = fmt_a_a[110:103];
    wire [102:0] f_mant_a = fmt_a_a[102:0];
    ...
    wire f_sign_b = fmt_b_b[111];
    wire [7:0] f_exp_b = fmt_b_b[110:103];
    wire [102:0] f_mant_b = fmt_b_b[102:0];
    ...
    wire f_sign_c = fmt_c_c[111];
    wire [7:0] f_exp_c = fmt_c_c[110:103];
    wire [102:0] f_mant_c = fmt_c_c[102:0];
