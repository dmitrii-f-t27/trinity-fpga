...
module corona_compute_fp23_e9m13_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[22];
    wire [8:0] f_exp_a = fmt_a_a[21:13];
    wire [12:0] f_mant_a = fmt_a_a[12:0];
    ...
    wire f_sign_b = fmt_b_b[22];
    wire [8:0] f_exp_b = fmt_b_b[21:13];
    wire [12:0] f_mant_b = fmt_b_b[12:0];
    ...
    wire f_sign_c = fmt_c_c[22];
    wire [8:0] f_exp_c = fmt_c_c[21:13];
    wire [12:0] f_mant_c = fmt_c_c[12:0];
