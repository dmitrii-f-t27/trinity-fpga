...
`timescale 1ns / 1ps
// corona_compute_binary256_fma_ax7203 — BINARY256 FMA on AX7203.
module corona_compute_binary256_fma_ax7203 (
    ...
    reg [255:0] a_reg,b_reg,c_reg; reg comp_trigger;
    wire [255:0] fmt_a=a_reg, fmt_b=b_reg, fmt_c=c_reg;
    ...
    wire b256_sign_c = fmt_c[255];
    wire [18:0] b256_exp_c = fmt_c[254:236];
    wire [235:0] b256_mant_c = fmt_c[235:0];
    wire b256_zero_c = (b256_exp_c == 19'd0) && (b256_mant_c == 236'd0);
    wire b256_special_c = (b256_exp_c == 19'h7FFFF);
    wire signed [20:0] b256_de_c = $signed({1'b0, b256_exp_c}) - 21'sd262112 + 21'sd127;
    wire [7:0] b256_exp32_c = b256_de_c[7:0];
    wire [22:0] b256_mant32_c = b256_mant_c[235:213];
    reg [31:0] fp32_c;
    always @(*) begin
        if(b256_zero_c) fp32_c={b256_sign_c, 31'b0};
        else if(b256_special_c) fp32_c=32'h7FC00000;
        else fp32_c={b256_sign_c, b256_exp32_c, b256_mant32_c};
    end
