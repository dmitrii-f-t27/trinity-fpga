...
`timescale 1ns / 1ps
// corona_compute_fp24_e7m16_fma_ax7203 — FP24_E7M16 FMA on AX7203.
module corona_compute_fp24_e7m16_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_exp >= 8'd128) q_result={q_sign, 7'd127, 16'd0};
