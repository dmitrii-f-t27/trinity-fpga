...
`timescale 1ns / 1ps
// corona_compute_fp70_e8m61_add_ax7203 — FP70_E8M61 ADD on AX7203.
module corona_compute_fp70_e8m61_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [69:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [69:0] a_reg,b_reg; reg comp_trigger;
