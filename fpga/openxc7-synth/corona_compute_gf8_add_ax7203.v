...
`timescale 1ns / 1ps
// corona_compute_gf8_add_ax7203 — GoldenFloat8 ADD on AX7203.
// GF8 format: [S:1][E:4][M:3] = 8 bits, BIAS=7, no Inf/NaN (saturate).
//
...
module corona_compute_gf8_add_ax7203 (
    ...
    gf_adder_param #(.EXP_BITS(3), .MANT_BITS(4), .HAS_INF(0)) u_comp (
        .clk(mclk), .rst(rst),
