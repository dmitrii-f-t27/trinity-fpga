...
module gf16_mul (
    ...
    DSP48E1 #(
        ...
        .CLK(clk),
        .RSTA(rst_n ? 1'b0 : 1'b1),
        .RSTALLCARRYIN(rst_n ? 1'b0 : 1'b1),
        .RSTALUMODE(rst_n ? 1'b0 : 1'b1),
        .RSTB(rst_n ? 1'b0 : 1'b1),
        .RSTC(rst_n ? 1'b0 : 1'b1),
        .RSTCTRL(rst_n ? 1'b0 : 1'b1),
        .RSTD(rst_n ? 1'b0 : 1'b1),
        .RSTINMODE(rst_n ? 1'b0 : 1'b1),
        .RSTM(rst_n ? 1'b0 : 1'b1),
        .RSTP(rst_n ? 1'b0 : 1'b1),
