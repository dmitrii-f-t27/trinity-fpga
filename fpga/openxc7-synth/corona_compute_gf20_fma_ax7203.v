...
`timescale 1ns / 1ps
// corona_compute_gf20_fma_ax7203 — GoldenFloat20 FMA (y = a*b + c) on AX7203.
...
module corona_compute_gf20_fma_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(7), .MANT_BITS(12), .HAS_INF(1)) u_mul (
        .clk(mclk), .rst(rst),
    ...
    gf_adder_param #(.EXP_BITS(7), .MANT_BITS(12), .HAS_INF(1)) u_add (
        .clk(mclk), .rst(rst),
