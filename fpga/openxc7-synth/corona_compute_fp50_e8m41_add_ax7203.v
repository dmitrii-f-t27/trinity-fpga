...
`timescale 1ns / 1ps
// corona_compute_fp50_e8m41_add_ax7203 — FP50_E8M41 ADD on AX7203.
module corona_compute_fp50_e8m41_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [49:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [49:0] a_reg,b_reg; reg comp_trigger;
    wire [49:0] fmt_a=a_reg, fmt_b=b_reg;
