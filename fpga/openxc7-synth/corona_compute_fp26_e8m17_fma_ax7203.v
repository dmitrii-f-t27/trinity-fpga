...
module corona_compute_fp26_e8m17_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[25];
    wire [7:0] f_exp_a = fmt_a_a[24:17];
    wire [16:0] f_mant_a = fmt_a_a[16:0];
    ...
    wire f_sign_b = fmt_b_b[25];
    wire [7:0] f_exp_b = fmt_b_b[24:17];
    wire [16:0] f_mant_b = fmt_b_b[16:0];
    ...
    wire f_sign_c = fmt_c_c[25];
    wire [7:0] f_exp_c = fmt_c_c[24:17];
    wire [16:0] f_mant_c = fmt_c_c[16:0];
