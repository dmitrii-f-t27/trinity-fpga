...
`timescale 1ns / 1ps
// corona_compute_fp55_e8m46_mul_ax7203 — FP55_E8M46 MUL on AX7203.
module corona_compute_fp55_e8m46_mul_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [54:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [54:0] a_reg,b_reg; reg comp_trigger;
    wire [54:0] fmt_a=a_reg, fmt_b=b_reg;
