...
`timescale 1ns / 1ps
// corona_compute_gf24_cmp_ax7203 — GoldenFloat24 comparison on AX7203.
...
module corona_compute_gf24_cmp_ax7203 (
    ...
    wire        sa = a_reg[23];
    wire [8:0] ea = a_reg[22:14];
    wire [13:0] ma = a_reg[13:0];
    wire        sb = b_reg[23];
    wire [8:0] eb = b_reg[22:14];
    wire [13:0] mb = b_reg[13:0];
    ...
    wire [22:0] abs_a = {ea, ma};
    wire [22:0] abs_b = {eb, mb};
