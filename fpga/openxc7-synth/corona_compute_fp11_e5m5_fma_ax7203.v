...
`timescale 1ns / 1ps
// corona_compute_fp11_e5m5_fma_ax7203 — FP11_E5M5 FMA on AX7203.
module corona_compute_fp11_e5m5_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 5'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 5'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 10'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 5'b0, q_mant[22:18]};
        else q_result={q_sign, tgt_exp_s[4:0], q_mant[22:18]};
    end
