...
`timescale 1ns / 1ps
// corona_compute_fp56_e8m47_alu_ax7203 — FP56_E8M47 ALU on AX7203.
module corona_compute_fp56_e8m47_alu_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r,op_r; reg [55:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [55:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
