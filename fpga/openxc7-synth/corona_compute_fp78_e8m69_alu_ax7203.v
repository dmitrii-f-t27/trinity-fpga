...
`timescale 1ns / 1ps
// corona_compute_fp78_e8m69_alu_ax7203 — FP78_E8M69 ALU on AX7203.
module corona_compute_fp78_e8m69_alu_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[76:69];
    ...
    wire [7:0] f_exp_b = fmt_b_b[76:69];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 69'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 69'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 77'b0};
