...
`timescale 1ns / 1ps
// corona_decode_takum8_ax7203 — Takum8 (8-bit logarithmic) decode on AX7203.
// Full 256-entry LUT (pure lookup). Frame: AA 55 fmt code_lo code_hi trig -> A5 FP32 LE.
module corona_decode_takum8_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero;
    takum8_decode u_dec (.takum_in(code_r[7:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
