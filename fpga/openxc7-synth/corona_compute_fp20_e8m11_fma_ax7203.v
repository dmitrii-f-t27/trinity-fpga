...
module corona_compute_fp20_e8m11_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[19];
    wire [7:0] f_exp_a = fmt_a_a[18:11];
    ...
    wire f_sign_b = fmt_b_b[19];
    wire [7:0] f_exp_b = fmt_b_b[18:11];
    ...
    wire f_sign_c = fmt_c_c[19];
    wire [7:0] f_exp_c = fmt_c_c[18:11];
