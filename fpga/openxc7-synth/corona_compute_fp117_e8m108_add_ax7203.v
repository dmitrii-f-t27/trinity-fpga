...
`timescale 1ns / 1ps
// corona_compute_fp117_e8m108_add_ax7203 — FP117_E8M108 ADD on AX7203.
module corona_compute_fp117_e8m108_add_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [116:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [116:0] a_reg,b_reg; reg comp_trigger;
    wire [116:0] fmt_a=a_reg, fmt_b=b_reg;
