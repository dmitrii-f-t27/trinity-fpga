...
module corona_compute_fp123_e8m114_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[122];
    wire [7:0] f_exp_a = fmt_a_a[121:114];
    wire [113:0] f_mant_a = fmt_a_a[113:0];
    ...
    wire f_sign_b = fmt_b_b[122];
    wire [7:0] f_exp_b = fmt_b_b[121:114];
    wire [113:0] f_mant_b = fmt_b_b[113:0];
    ...
    wire f_sign_c = fmt_c_c[122];
    wire [7:0] f_exp_c = fmt_c_c[121:114];
    wire [113:0] f_mant_c = fmt_c_c[113:0];
