...
`timescale 1ns / 1ps
// corona_compute_takum16_alu_ax7203 — TAKUM16 ALU on AX7203.
module corona_compute_takum16_alu_ax7203 (
    ...
    wire [7:0] tk_idx_a = fmt_a_a[15:8];
    reg [31:0] fp32_a;
    always @(*) begin
        case(tk_idx_a)
    ...
    wire [7:0] tk_idx_b = fmt_b_b[15:8];
    reg [31:0] fp32_b;
    always @(*) begin
        case(tk_idx_b)
