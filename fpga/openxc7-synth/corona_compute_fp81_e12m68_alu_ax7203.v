...
`timescale 1ns / 1ps
// corona_compute_fp81_e12m68_alu_ax7203 — FP81_E12M68 ALU on AX7203.
module corona_compute_fp81_e12m68_alu_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r,op_r; reg [80:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd14: begin a_r[80:80]<=rx_byte;frm<=5'd15; end
                5'd15: begin b_r[7:0]<=rx_byte;frm<=5'd16; end
                5'd16: begin b_r[15:8]<=rx_byte;frm<=5'd17; end
                5'd17: begin b_r[23:16]<=rx_byte;frm<=5'd18; end
                5'd18: begin b_r[31:24]<=rx_byte;frm<=5'd19; end
                5'd19: begin b_r[39:32]<=rx_byte;frm<=5'd20; end
                5'd20: begin b_r[47:40]<=rx_byte;frm<=5'd21; end
                5'd21: begin b_r[55:48]<=rx_byte;frm<=5'd22; end
                5'd22: begin b_r[63:56]<=rx_byte;frm<=5'd23; end
                5'd23: begin b_r[71:64]<=rx_byte;frm<=5'd24; end
                5'd24: begin b_r[79:72]<=rx_byte;frm<=5'd25; end
                5'd25: begin b_r[80:80]<=rx_byte;frm<=5'd26; end
                5'd26: begin frame_valid<=1;frm<=0; end
            endcase end
        end
    end
    assign led[1]=frame_valid;

    reg [80:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [80:0] fmt_a=a_reg, fmt_b=b_reg;
