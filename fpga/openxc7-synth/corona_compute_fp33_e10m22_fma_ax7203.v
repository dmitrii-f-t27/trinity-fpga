...
`timescale 1ns / 1ps
// corona_compute_fp33_e10m22_fma_ax7203 — FP33_E10M22 FMA on AX7203.
module corona_compute_fp33_e10m22_fma_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a[31:22];
    wire [21:0] f_mant_a = fmt_a[21:0];
    ...
    wire [22:0] f_mant32_norm_a = {1'b0, f_mant_a};
    reg [31:0] fp32_a;
    always @(*) begin
    ...
    wire [9:0] f_exp_b = fmt_b[31:22];
    wire [21:0] f_mant_b = fmt_b[21:0];
    ...
    wire [22:0] f_mant32_norm_b = {1'b0, f_mant_b};
    reg [31:0] fp32_b;
    always @(*) begin
    ...
    wire [9:0] f_exp_c = fmt_c[31:22];
    wire [21:0] f_mant_c = fmt_c[21:0];
    ...
    wire [22:0] f_mant32_norm_c = {1'b0, f_mant_c};
    reg [31:0] fp32_c;
    always @(*) begin
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 22'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 22'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 32'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 10'b0, q_mant[22:1]};
        else q_result={q_sign, tgt_exp_s[9:0], q_mant[22:1]};
    end
