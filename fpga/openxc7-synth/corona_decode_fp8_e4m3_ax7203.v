...
`timescale 1ns / 1ps
// corona_decode_fp8_e4m3_ax7203 — FP8 E4M3 (OCP standard) decode on AX7203.
// FP8 E4M3 = 1S+4E+3M, bias=7. Uses mxfp8_e4m3_decode (identical encoding).
// Frame: AA 55 fmt code_lo code_hi trig -> A5 r0 r1 r2 r3 (32-bit decoded LE).
module corona_decode_fp8_e4m3_ax7203 (
