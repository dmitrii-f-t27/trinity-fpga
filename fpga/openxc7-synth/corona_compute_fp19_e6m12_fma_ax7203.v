...
module corona_compute_fp19_e6m12_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[18];
    wire [5:0] f_exp_a = fmt_a_a[17:12];
    wire [11:0] f_mant_a = fmt_a_a[11:0];
    ...
    wire f_sign_b = fmt_b_b[18];
    wire [5:0] f_exp_b = fmt_b_b[17:12];
    wire [11:0] f_mant_b = fmt_b_b[11:0];
    ...
    wire f_sign_c = fmt_c_c[18];
    wire [5:0] f_exp_c = fmt_c_c[17:12];
    wire [11:0] f_mant_c = fmt_c_c[11:0];
