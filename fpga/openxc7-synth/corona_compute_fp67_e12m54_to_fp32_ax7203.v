...
`timescale 1ns / 1ps
// corona_compute_fp67_e12m54_to_fp32_ax7203 — FP67_E12M54 TO_FP32 on AX7203.
module corona_compute_fp67_e12m54_to_fp32_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [66:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd11: begin a_r[66:64]<=rx_byte;frm<=4'd12; end
    ...
    reg [66:0] a_reg; reg conv_trigger;
    wire [66:0] fmt_a = a_reg;
