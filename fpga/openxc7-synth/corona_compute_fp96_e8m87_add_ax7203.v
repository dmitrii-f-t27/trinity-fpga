...
`timescale 1ns / 1ps
// corona_compute_fp96_e8m87_add_ax7203 — FP96_E8M87 ADD on AX7203.
module corona_compute_fp96_e8m87_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [95:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd26: begin b_r[95:88]<=rx_byte;frm<=5'd27; end
    ...
    wire [95:0] fmt_a=a_reg, fmt_b=b_reg;
