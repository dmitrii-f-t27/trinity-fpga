...
module corona_compute_fp65_e8m56_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[64];
    wire [7:0] f_exp_a = fmt_a_a[63:56];
    wire [55:0] f_mant_a = fmt_a_a[55:0];
    ...
    wire f_sign_b = fmt_b_b[64];
    wire [7:0] f_exp_b = fmt_b_b[63:56];
    wire [55:0] f_mant_b = fmt_b_b[55:0];
    ...
    wire f_sign_c = fmt_c_c[64];
    wire [7:0] f_exp_c = fmt_c_c[63:56];
    wire [55:0] f_mant_c = fmt_c_c[55:0];
