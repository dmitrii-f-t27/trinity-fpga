...
module corona_compute_fp67_e8m58_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[66];
    wire [7:0] f_exp_a = fmt_a_a[65:58];
    ...
    wire f_sign_b = fmt_b_b[66];
    wire [7:0] f_exp_b = fmt_b_b[65:58];
    ...
    wire f_sign_c = fmt_c_c[66];
    wire [7:0] f_exp_c = fmt_c_c[65:58];
