...
`timescale 1ns / 1ps
// corona_decode_mxint8_ax7203 — OCP MX INT8 decode on AX7203.
...
// (mxint8_decode: int8 x 2^-6 -> FP32, leading-one normalize, -128 reserved -> NaN).
module corona_decode_mxint8_ax7203 (
    ...
    mxint8_decode u_dec (.mxint8_in(code_r[7:0]), .fp32_out(result),
