...
`timescale 1ns / 1ps
// corona_compute_gf256_add_ax7203 — GoldenFloat256 ADD on AX7203.
// GF256: [S:1][E:97][M:158] = 256 bits, BIAS=79228162514264337593543950335, HAS_INF=0.
// 32 bytes per operand, 68-byte frame.
module corona_compute_gf256_add_ax7203 (
    ...
    wire comp_in_ready, comp_out_valid; wire [255:0] comp_result;
    gf_adder_param #(.EXP_BITS(97), .MANT_BITS(158), .HAS_INF(0)) u_comp (
        .clk(mclk), .rst(rst),
