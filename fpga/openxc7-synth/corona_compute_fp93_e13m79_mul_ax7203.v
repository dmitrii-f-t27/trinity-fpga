...
`timescale 1ns / 1ps
// corona_compute_fp93_e13m79_mul_ax7203 — FP93_E13M79 MUL on AX7203.
module corona_compute_fp93_e13m79_mul_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 79'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 79'd0};
