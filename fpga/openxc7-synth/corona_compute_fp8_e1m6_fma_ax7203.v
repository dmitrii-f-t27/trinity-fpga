...
`timescale 1ns / 1ps
// corona_compute_fp8_e1m6_fma_ax7203 — FP8_E1M6 FMA on AX7203.
module corona_compute_fp8_e1m6_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[7];
    wire [0:0] f_exp_a = fmt_a_a[6:6];
    ...
    wire f_sign_b = fmt_b_b[7];
    wire [0:0] f_exp_b = fmt_b_b[6:6];
    ...
    wire f_sign_c = fmt_c_c[7];
    wire [0:0] f_exp_c = fmt_c_c[6:6];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 1'd1, 6'd0};
        else if(q_exp >= 8'd128) q_result={q_sign, 1'd1, 6'd0};
        else if(q_exp < 8'd127) q_result={q_sign, 7'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 1'b0, q_mant[22:17]};
        else q_result={q_sign, tgt_exp_s[0:0], q_mant[22:17]};
    end
