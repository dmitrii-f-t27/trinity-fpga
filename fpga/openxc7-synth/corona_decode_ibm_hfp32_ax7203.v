...
`timescale 1ns / 1ps
// corona_decode_ibm_hfp32_ax7203 — IBM HFP32 decode on AX7203 (32-bit decode frame).
module corona_decode_ibm_hfp32_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero;
    ibm_hfp32_decode u_dec (.ibm_in(code_r[31:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
