...
`timescale 1ns / 1ps
// corona_compute_gf24_alu_ax7203 — GoldenFloat24 ALU (ADD+MUL) on AX7203.
...
//
// Frame protocol (11 bytes TX):
//   AA 55 fmt op a0 a1 a2 b0 b1 b2 trig
//   op: 0x00=ADD, 0x01=MUL
// Response (5 bytes RX):
//   A5 r0 r1 r2 00

module corona_compute_gf24_alu_ax7203 (
    ...
    // ---- Frame FSM ----
    reg [3:0] frm; reg [7:0] fmt_r; reg [7:0] op_r; reg [23:0] a_r, b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    wire [23:0] comp_result = is_mul ? mul_result : add_result;
