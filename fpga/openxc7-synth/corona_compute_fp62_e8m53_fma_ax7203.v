...
`timescale 1ns / 1ps
// corona_compute_fp62_e8m53_fma_ax7203 — FP62_E8M53 FMA on AX7203.
module corona_compute_fp62_e8m53_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 53'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 53'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 61'b0};
