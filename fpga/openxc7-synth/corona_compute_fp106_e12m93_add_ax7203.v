...
`timescale 1ns / 1ps
// corona_compute_fp106_e12m93_add_ax7203 — FP106_E12M93 ADD on AX7203.
module corona_compute_fp106_e12m93_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [105:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd16: begin a_r[105:104]<=rx_byte;frm<=5'd17; end
                5'd17: begin b_r[7:0]<=rx_byte;frm<=5'd18; end
                5'd18: begin b_r[15:8]<=rx_byte;frm<=5'd19; end
                5'd19: begin b_r[23:16]<=rx_byte;frm<=5'd20; end
                5'd20: begin b_r[31:24]<=rx_byte;frm<=5'd21; end
                5'd21: begin b_r[39:32]<=rx_byte;frm<=5'd22; end
                5'd22: begin b_r[47:40]<=rx_byte;frm<=5'd23; end
                5'd23: begin b_r[55:48]<=rx_byte;frm<=5'd24; end
                5'd24: begin b_r[63:56]<=rx_byte;frm<=5'd25; end
                5'd25: begin b_r[71:64]<=rx_byte;frm<=5'd26; end
                5'd26: begin b_r[79:72]<=rx_byte;frm<=5'd27; end
                5'd27: begin b_r[87:80]<=rx_byte;frm<=5'd28; end
                5'd28: begin b_r[95:88]<=rx_byte;frm<=5'd29; end
                5'd29: begin b_r[103:96]<=rx_byte;frm<=5'd30; end
                5'd30: begin b_r[105:104]<=rx_byte;frm<=5'd31; end
                5'd31: begin frame_valid<=1;frm<=0; end
            endcase end
        end
    end
    assign led[1]=frame_valid;

    reg [105:0] a_reg,b_reg; reg comp_trigger;
