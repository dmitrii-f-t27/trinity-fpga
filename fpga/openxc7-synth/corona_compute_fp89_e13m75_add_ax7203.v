...
`timescale 1ns / 1ps
// corona_compute_fp89_e13m75_add_ax7203 — FP89_E13M75 ADD on AX7203.
module corona_compute_fp89_e13m75_add_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a_a[87:75];
    ...
    wire [12:0] f_exp_b = fmt_b_b[87:75];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 75'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 75'd0};
