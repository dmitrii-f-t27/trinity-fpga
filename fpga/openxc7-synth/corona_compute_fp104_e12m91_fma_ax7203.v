...
`timescale 1ns / 1ps
// corona_compute_fp104_e12m91_fma_ax7203 — FP104_E12M91 FMA on AX7203.
module corona_compute_fp104_e12m91_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[102:91];
    ...
    wire [11:0] f_exp_b = fmt_b[102:91];
    ...
    wire [11:0] f_exp_c = fmt_c[102:91];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 91'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 91'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 103'b0};
