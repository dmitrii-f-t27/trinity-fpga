...
`timescale 1ns / 1ps
// corona_compute_fp8_e5m2_cmp_ax7203 — FP8_E5M2 CMP on AX7203.
module corona_compute_fp8_e5m2_cmp_ax7203 (
    ...
    wire sa=a_reg[7]; wire [4:0] ea=a_reg[6:2]; wire [1:0] ma=a_reg[1:0];
    wire sb=b_reg[7]; wire [4:0] eb=b_reg[6:2]; wire [1:0] mb=b_reg[1:0];
