...
`timescale 1ns / 1ps
// corona_compute_fp74_e10m63_alu_ax7203 — FP74_E10M63 ALU on AX7203.
module corona_compute_fp74_e10m63_alu_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[72:63];
    ...
    wire [9:0] f_exp_b = fmt_b_b[72:63];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 63'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 63'd0};
