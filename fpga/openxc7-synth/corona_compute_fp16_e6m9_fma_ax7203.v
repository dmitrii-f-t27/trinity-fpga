...
`timescale 1ns / 1ps
// corona_compute_fp16_e6m9_fma_ax7203 — FP16_E6M9 FMA on AX7203.
module corona_compute_fp16_e6m9_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_exp >= 8'd160) q_result={q_sign, 6'd63, 9'd0};
        else if(q_exp < 8'd97) q_result={q_sign, 15'b0};
