...
`timescale 1ns / 1ps
// corona_compute_fp32_to_fp30_e8m21_ax7203 — FP30_E8M21 FP32_TO on AX7203.
module corona_compute_fp32_to_fp30_e8m21_ax7203 (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(conv_trigger) result_reg<={2'b0,q_result};
        end
    end
