...
module corona_compute_fp47_e8m38_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[46];
    wire [7:0] f_exp_a = fmt_a_a[45:38];
    wire [37:0] f_mant_a = fmt_a_a[37:0];
    ...
    wire f_sign_b = fmt_b_b[46];
    wire [7:0] f_exp_b = fmt_b_b[45:38];
    wire [37:0] f_mant_b = fmt_b_b[37:0];
    ...
    wire f_sign_c = fmt_c_c[46];
    wire [7:0] f_exp_c = fmt_c_c[45:38];
    wire [37:0] f_mant_c = fmt_c_c[37:0];
