...
`timescale 1ns / 1ps
// corona_compute_fp8_e4m3_cmp_ax7203 — FP8_E4M3 CMP on AX7203.
module corona_compute_fp8_e4m3_cmp_ax7203 (
    ...
    wire sa=a_reg[7]; wire [3:0] ea=a_reg[6:3]; wire [2:0] ma=a_reg[2:0];
    wire sb=b_reg[7]; wire [3:0] eb=b_reg[6:3]; wire [2:0] mb=b_reg[2:0];
    wire az=(ea==0)&&(ma==0); wire bz=(eb==0)&&(mb==0);
    wire an=(0)&&(ea=={4{1'b1}})&&(ma!=0); wire bn=(0)&&(eb=={4{1'b1}})&&(mb!=0);
    wire [6:0] aa={ea,ma}; wire [6:0] ab={eb,mb};
