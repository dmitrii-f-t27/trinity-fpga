...
`timescale 1ns / 1ps
// corona_compute_fp14_e5m8_fma_ax7203 — FP14_E5M8 FMA on AX7203.
module corona_compute_fp14_e5m8_fma_ax7203 (
    ...
    wire signed [14:0] f_de_c = $signed({1'b0, f_exp_c}) - 15'sd31 + 15'sd127;
    ...
    always @(*) begin
        ...
        else if(q_exp >= 8'd128) q_result={q_sign, 5'd31, 8'd0};
