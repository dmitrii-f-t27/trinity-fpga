...
`timescale 1ns / 1ps
// corona_compute_fp80_e8m71_alu_ax7203 — FP80_E8M71 ALU on AX7203.
module corona_compute_fp80_e8m71_alu_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[78:71];
    ...
    wire [7:0] f_exp_b = fmt_b_b[78:71];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 71'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 71'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 79'b0};
