...
`timescale 1ns / 1ps
// corona_compute_fp78_e10m67_alu_ax7203 — FP78_E10M67 ALU on AX7203.
module corona_compute_fp78_e10m67_alu_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[76:67];
    ...
    wire [9:0] f_exp_b = fmt_b_b[76:67];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 67'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 67'd0};
