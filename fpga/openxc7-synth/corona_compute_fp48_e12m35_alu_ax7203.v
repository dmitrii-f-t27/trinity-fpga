...
`timescale 1ns / 1ps
// corona_compute_fp48_e12m35_alu_ax7203 — FP48_E12M35 ALU on AX7203.
module corona_compute_fp48_e12m35_alu_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r,op_r; reg [47:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [47:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [47:0] fmt_a=a_reg, fmt_b=b_reg;
