...
`timescale 1ns / 1ps
// corona_compute_minifloat_mul_ax7203 — MINIFLOAT MUL on AX7203.
module corona_compute_minifloat_mul_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(3), .MANT_BITS(4), .HAS_INF(1)) u_comp (
