...
module corona_compute_fp64_e8m55_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[63];
    wire [7:0] f_exp_a = fmt_a_a[62:55];
    wire [54:0] f_mant_a = fmt_a_a[54:0];
    ...
    wire f_sign_b = fmt_b_b[63];
    wire [7:0] f_exp_b = fmt_b_b[62:55];
    wire [54:0] f_mant_b = fmt_b_b[54:0];
    ...
    wire f_sign_c = fmt_c_c[63];
    wire [7:0] f_exp_c = fmt_c_c[62:55];
    wire [54:0] f_mant_c = fmt_c_c[54:0];
