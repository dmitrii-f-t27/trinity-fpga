...
`timescale 1ns / 1ps
// corona_compute_fp64_e8m55_fma_ax7203 — FP64_E8M55 FMA on AX7203.
module corona_compute_fp64_e8m55_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[63];
    wire [7:0] f_exp_a = fmt_a[62:55];
    wire [54:0] f_mant_a = fmt_a[54:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -32'b0};
    ...
    wire f_sign_b = fmt_b[63];
    wire [7:0] f_exp_b = fmt_b[62:55];
    wire [54:0] f_mant_b = fmt_b[54:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -32'b0};
    ...
    wire f_sign_c = fmt_c[63];
    wire [7:0] f_exp_c = fmt_c[62:55];
    wire [54:0] f_mant_c = fmt_c[54:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -32'b0};
    ...
    reg [63:0] q_result;
    always @(*) begin
        if(q_nan) q_result=64'd0;
        else if(q_zero) q_result=64'd0;
        else if(q_inf) q_result={q_sign, 8'd255, 55'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 55'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 63'b0};
