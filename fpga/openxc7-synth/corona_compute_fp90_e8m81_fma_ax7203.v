...
`timescale 1ns / 1ps
// corona_compute_fp90_e8m81_fma_ax7203 — FP90_E8M81 FMA on AX7203.
module corona_compute_fp90_e8m81_fma_ax7203 (
    ...
    wire f_sign_c = fmt_c_c[89];
    wire [7:0] f_exp_c = fmt_c_c[88:81];
    wire [80:0] f_mant_c = fmt_c_c[80:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -58'b0};
