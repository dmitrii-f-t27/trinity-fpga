...
module corona_compute_fp24_e8m15_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[23];
    wire [7:0] f_exp_a = fmt_a_a[22:15];
    ...
    wire f_sign_b = fmt_b_b[23];
    wire [7:0] f_exp_b = fmt_b_b[22:15];
    ...
    wire f_sign_c = fmt_c_c[23];
    wire [7:0] f_exp_c = fmt_c_c[22:15];
