...
`timescale 1ns / 1ps
// corona_compute_fp100_e8m91_add_ax7203 — FP100_E8M91 ADD on AX7203.
module corona_compute_fp100_e8m91_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [99:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd15: begin a_r[99:96]<=rx_byte;frm<=5'd16; end
                ...
                5'd28: begin b_r[99:96]<=rx_byte;frm<=5'd29; end
    ...
    reg [99:0] a_reg,b_reg; reg comp_trigger;
