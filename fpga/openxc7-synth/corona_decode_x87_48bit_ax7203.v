...
`timescale 1ns / 1ps
// corona_decode_x87_48bit_ax7203 — x87 48-bit float decode on AX7203.
// Frame: AA 55 fmt b0 b1 b2 b3 b4 b5 trig -> A5 r0 r1 r2 r3.
module corona_decode_x87_48bit_ax7203 (
    ...
    x87_48bit_decode u_dec (.x87_in(code_r), .fp32_out(result),
