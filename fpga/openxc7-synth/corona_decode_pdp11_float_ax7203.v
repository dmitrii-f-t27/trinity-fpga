...
`timescale 1ns / 1ps
// corona_decode_pdp11_float_ax7203 — PDP-11 FIS 32-bit float decode on AX7203.
// Frame: AA 55 fmt b0 b1 b2 b3 trig -> A5 r0 r1 r2 r3 (32-bit FP32 LE).
module corona_decode_pdp11_float_ax7203 (
    ...
    // Frame: AA 55 fmt b0 b1 b2 b3 trig (7 bytes total for 32-bit)
    ...
    pdp11_float_decode u_dec (.pdp11_in(code_r), .fp32_out(result),
