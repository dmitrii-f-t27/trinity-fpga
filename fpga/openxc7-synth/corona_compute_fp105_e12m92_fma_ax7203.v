...
`timescale 1ns / 1ps
// corona_compute_fp105_e12m92_fma_ax7203 — FP105_E12M92 FMA on AX7203.
module corona_compute_fp105_e12m92_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[103:92];
    wire [91:0] f_mant_a = fmt_a[91:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -69'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[103:92];
    wire [91:0] f_mant_b = fmt_b[91:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -69'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[103:92];
    wire [91:0] f_mant_c = fmt_c[91:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -69'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 92'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 92'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 104'b0};
