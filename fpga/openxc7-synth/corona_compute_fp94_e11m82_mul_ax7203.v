...
`timescale 1ns / 1ps
// corona_compute_fp94_e11m82_mul_ax7203 — FP94_E11M82 MUL on AX7203.
module corona_compute_fp94_e11m82_mul_ax7203 (
    ...
    wire [10:0] f_exp_a = fmt_a_a[92:82];
    ...
    wire [10:0] f_exp_b = fmt_b_b[92:82];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 82'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 82'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 93'b0};
