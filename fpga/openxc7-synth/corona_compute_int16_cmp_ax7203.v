...
`timescale 1ns / 1ps
// corona_compute_int16_cmp_ax7203 — INT16 CMP on AX7203.
module corona_compute_int16_cmp_ax7203 (
    ...
    wire ce=($signed(a_reg)==$signed(b_reg));
    wire cl=($signed(a_reg)<$signed(b_reg)); wire cd=cl|ce;
    always @(posedge mclk or posedge rst) begin
