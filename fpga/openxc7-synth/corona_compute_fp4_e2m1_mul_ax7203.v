...
`timescale 1ns / 1ps
// corona_compute_fp4_e2m1_mul_ax7203 — FP4_E2M1 MUL on AX7203.
module corona_compute_fp4_e2m1_mul_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(2),.MANT_BITS(1),.HAS_INF(0)) u_comp (
