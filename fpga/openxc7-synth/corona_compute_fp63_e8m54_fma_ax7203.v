...
`timescale 1ns / 1ps
// corona_compute_fp63_e8m54_fma_ax7203 — FP63_E8M54 FMA on AX7203.
module corona_compute_fp63_e8m54_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 54'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 54'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 62'b0};
