...
module corona_compute_fp97_e8m88_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[96];
    wire [7:0] f_exp_a = fmt_a_a[95:88];
    wire [87:0] f_mant_a = fmt_a_a[87:0];
    ...
    wire f_sign_b = fmt_b_b[96];
    wire [7:0] f_exp_b = fmt_b_b[95:88];
    wire [87:0] f_mant_b = fmt_b_b[87:0];
    ...
    wire f_sign_c = fmt_c_c[96];
    wire [7:0] f_exp_c = fmt_c_c[95:88];
    wire [87:0] f_mant_c = fmt_c_c[87:0];
