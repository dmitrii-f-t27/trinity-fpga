...
`timescale 1ns / 1ps
// corona_compute_fp8_e3m4_fma_ax7203 — FP8_E3M4 FMA on AX7203.
module corona_compute_fp8_e3m4_fma_ax7203 (
    ...
    wire signed [9:0] f_de_a = $signed({1'b0, f_exp_a}) - 10'sd3 + 10'sd127;
    ...
    wire signed [9:0] f_de_b = $signed({1'b0, f_exp_b}) - 10'sd3 + 10'sd127;
    ...
    wire signed [9:0] f_de_c = $signed({1'b0, f_exp_c}) - 10'sd3 + 10'sd127;
