...
`timescale 1ns / 1ps
// corona_compute_fp32_to_fp11_e7m3_ax7203 — FP11_E7M3 FP32_TO on AX7203.
module corona_compute_fp32_to_fp11_e7m3_ax7203 (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(conv_trigger) result_reg<={21'b0,q_result};
        end
    end
