...
module corona_compute_fp101_e8m92_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[100];
    wire [7:0] f_exp_a = fmt_a_a[99:92];
    ...
    wire f_sign_b = fmt_b_b[100];
    wire [7:0] f_exp_b = fmt_b_b[99:92];
    ...
    wire f_sign_c = fmt_c_c[100];
    wire [7:0] f_exp_c = fmt_c_c[99:92];
