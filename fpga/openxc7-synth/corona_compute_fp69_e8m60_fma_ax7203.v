...
`timescale 1ns / 1ps
// corona_compute_fp69_e8m60_fma_ax7203 — FP69_E8M60 FMA on AX7203.
module corona_compute_fp69_e8m60_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a[67:60];
    wire [59:0] f_mant_a = fmt_a[59:0];
    ...
    wire [7:0] f_exp_b = fmt_b[67:60];
    wire [59:0] f_mant_b = fmt_b[59:0];
    ...
    wire [7:0] f_exp_c = fmt_c[67:60];
    wire [59:0] f_mant_c = fmt_c[59:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -37'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 60'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 60'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 68'b0};
