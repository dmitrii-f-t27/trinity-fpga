...
module corona_compute_fp17_e8m8_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[16];
    wire [7:0] f_exp_a = fmt_a_a[15:8];
    wire [7:0] f_mant_a = fmt_a_a[7:0];
    ...
    wire f_sign_b = fmt_b_b[16];
    wire [7:0] f_exp_b = fmt_b_b[15:8];
    wire [7:0] f_mant_b = fmt_b_b[7:0];
    ...
    wire f_sign_c = fmt_c_c[16];
    wire [7:0] f_exp_c = fmt_c_c[15:8];
    wire [7:0] f_mant_c = fmt_c_c[7:0];
