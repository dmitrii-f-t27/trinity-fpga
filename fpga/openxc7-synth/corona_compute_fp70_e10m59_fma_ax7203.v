...
`timescale 1ns / 1ps
// corona_compute_fp70_e10m59_fma_ax7203 — FP70_E10M59 FMA on AX7203.
module corona_compute_fp70_e10m59_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 59'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 59'd0};
