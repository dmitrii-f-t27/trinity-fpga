...
`timescale 1ns / 1ps
// corona_compute_fp19_e10m8_fma_ax7203 — FP19_E10M8 FMA on AX7203.
module corona_compute_fp19_e10m8_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 8'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 8'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 18'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 10'b0, q_mant[22:15]};
        else q_result={q_sign, tgt_exp_s[9:0], q_mant[22:15]};
    end
