...
module corona_compute_fp121_e8m112_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[120];
    wire [7:0] f_exp_a = fmt_a_a[119:112];
    ...
    wire f_sign_b = fmt_b_b[120];
    wire [7:0] f_exp_b = fmt_b_b[119:112];
    wire [111:0] f_mant_b = fmt_b_b[111:0];
    ...
    wire f_sign_c = fmt_c_c[120];
    wire [7:0] f_exp_c = fmt_c_c[119:112];
    wire [111:0] f_mant_c = fmt_c_c[111:0];
