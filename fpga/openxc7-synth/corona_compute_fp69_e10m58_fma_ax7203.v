...
`timescale 1ns / 1ps
// corona_compute_fp69_e10m58_fma_ax7203 — FP69_E10M58 FMA on AX7203.
module corona_compute_fp69_e10m58_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 58'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 58'd0};
