...
`timescale 1ns / 1ps
// corona_decode_gf8_bfp_ax7203 — IEEE 754 gf8_bfp (half) decode on AX7203.
// gf8_bfp_decode is authored in-repo and EXHAUSTIVELY verified (65536/65536 vs
// the C-library gf8_bfp via struct 'e'). Single-decoder build: CFGMCLK clock,
...
module corona_decode_gf8_bfp_ax7203 (
