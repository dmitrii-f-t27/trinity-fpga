...
`timescale 1ns / 1ps
// corona_compute_fp26_e10m15_fma_ax7203 — FP26_E10M15 FMA on AX7203.
module corona_compute_fp26_e10m15_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 15'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 15'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 25'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 10'b0, q_mant[22:8]};
        else q_result={q_sign, tgt_exp_s[9:0], q_mant[22:8]};
    end
