...
`timescale 1ns / 1ps
// corona_compute_fp103_e12m90_alu_ax7203 — FP103_E12M90 ALU on AX7203.
module corona_compute_fp103_e12m90_alu_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r,op_r; reg [102:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd16: begin a_r[102:96]<=rx_byte;frm<=5'd17; end
                ...
                5'd29: begin b_r[102:96]<=rx_byte;frm<=5'd30; end
    ...
    reg [102:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [102:0] fmt_a=a_reg, fmt_b=b_reg;
