...
module corona_compute_fp110_e8m101_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[109];
    wire [7:0] f_exp_a = fmt_a_a[108:101];
    wire [100:0] f_mant_a = fmt_a_a[100:0];
    ...
    wire f_sign_b = fmt_b_b[109];
    wire [7:0] f_exp_b = fmt_b_b[108:101];
    wire [100:0] f_mant_b = fmt_b_b[100:0];
    ...
    wire f_sign_c = fmt_c_c[109];
    wire [7:0] f_exp_c = fmt_c_c[108:101];
    wire [100:0] f_mant_c = fmt_c_c[100:0];
