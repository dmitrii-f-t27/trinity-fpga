...
module corona_compute_fp113_e8m104_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[112];
    wire [7:0] f_exp_a = fmt_a_a[111:104];
    wire [103:0] f_mant_a = fmt_a_a[103:0];
    ...
    wire f_sign_b = fmt_b_b[112];
    wire [7:0] f_exp_b = fmt_b_b[111:104];
    wire [103:0] f_mant_b = fmt_b_b[103:0];
    ...
    wire f_sign_c = fmt_c_c[112];
    wire [7:0] f_exp_c = fmt_c_c[111:104];
    wire [103:0] f_mant_c = fmt_c_c[103:0];
