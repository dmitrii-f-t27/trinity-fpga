...
`timescale 1ns / 1ps
// corona_compute_fp87_e11m75_fma_ax7203 — FP87_E11M75 FMA on AX7203.
module corona_compute_fp87_e11m75_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 75'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 75'd0};
