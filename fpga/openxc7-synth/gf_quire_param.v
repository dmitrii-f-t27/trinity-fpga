...
module gf_quire_param #(
    ...
    // FLUSH helper: fixed-point → float conversion
    // All declared at module level (yosys doesn't allow local vars in unnamed blocks)
            ...
            if (in_valid) begin
                ...
                if (op_read || op_clear) begin
                    if (!acc_valid || (acc == 0)) begin
                        ...
                        // Fixed-point → float: use module-level vars
                        ...
                        casez (flush_abs)
                            ...
                            72'b01??????????????????????????????????????????????????????????????????: flush_lz = 70;
                            72'b001?????????????????????????????????????????????????????????????????: flush_lz = 69;
                            72'b0001????????????????????????????????????????????????????????????????: flush_lz = 68;
                            72'b00001???????????????????????????????????????????????????????????????: flush_lz = 67;
                            72'b000001??????????????????????????????????????????????????????????????: flush_lz = 66;
                            72'b0000001?????????????????????????????????????????????????????????????: flush_lz = 65;
                            72'b00000001????????????????????????????????????????????????????????????: flush_lz = 64;
                            72'b000000001???????????????????????????????????????????????????????????: flush_lz = 63;
                            72'b0000000001???????????????????????????????????????????????????????????: flush_lz = 62;
                            72'b00000000001?????????????????????????????????????????????????????????: flush_lz = 61;
                            72'b000000000001?????????????????????????????????????????????????????????: flush_lz = 60;
                            72'b0000000000001????????????????????????????????????????????????????????: flush_lz = 59;
                            72'b00000000000001???????????????????????????????????????????????????????: flush_lz = 58;
                            72'b000000000000001??????????????????????????????????????????????????????: flush_lz = 57;
                            72'b0000000000000001??????????????????????????????????????????????????????: flush_lz = 56;
                            72'b00000000000000001????????????????????????????????????????????????????: flush_lz = 55;
                            72'b000000000000000001???????????????????????????????????????????????????: flush_lz = 54;
                            72'b0000000000000000001??????????????????????????????????????????????????: flush_lz = 53;
                            72'b00000000000000000001?????????????????????????????????????????????????: flush_lz = 52;
                            72'b000000000000000000001????????????????????????????????????????????????: flush_lz = 51;
                            72'b0000000000000000000001???????????????????????????????????????????????: flush_lz = 50;
                            72'b00000000000000000000001??????????????????????????????????????????????: flush_lz = 49;
                            72'b000000000000000000000001?????????????????????????????????????????????: flush_lz = 48;
                            72'b0000000000000000000000001????????????????????????????????????????????: flush_lz = 47;
                            72'b00000000000000000000000001???????????????????????????????????????????: flush_lz = 46;
                            72'b000000000000000000000000001??????????????????????????????????????????: flush_lz = 45;
                            72'b0000000000000000000000000001????????????????????????????????????????: flush_lz = 44;
                            72'b00000000000000000000000000001???????????????????????????????????????: flush_lz = 43;
                            72'b000000000000000000000000000001??????????????????????????????????????: flush_lz = 42;
                            72'b0000000000000000000000000000001?????????????????????????????????????: flush_lz = 41;
                            72'b00000000000000000000000000000001????????????????????????????????????: flush_lz = 40;
                            72'b000000000000000000000000000000001???????????????????????????????????: flush_lz = 39;
                            72'b0000000000000000000000000000000001??????????????????????????????????: flush_lz = 38;
                            72'b00000000000000000000000000000000001????????????????????????????????: flush_lz = 37;
                            72'b000000000000000000000000000000000001???????????????????????????????: flush_lz = 36;
                            default: flush_lz = 0;
                        endcase
                        ...
                        if (flush_lz > MANT_BITS)
                            flush_mant = flush_abs >> (flush_lz - MANT_BITS - 1);
                        else
