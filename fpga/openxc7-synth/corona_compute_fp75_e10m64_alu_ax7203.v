...
`timescale 1ns / 1ps
// corona_compute_fp75_e10m64_alu_ax7203 — FP75_E10M64 ALU on AX7203.
module corona_compute_fp75_e10m64_alu_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[73:64];
    ...
    wire [9:0] f_exp_b = fmt_b_b[73:64];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 64'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 64'd0};
