...
`timescale 1ns / 1ps
// corona_compute_fp117_e8m108_to_fp32_ax7203 — FP117_E8M108 TO_FP32 on AX7203.
module corona_compute_fp117_e8m108_to_fp32_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [116:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                5'd17: begin a_r[116:112]<=rx_byte;frm<=5'd18; end
    ...
    reg [116:0] a_reg; reg conv_trigger;
    wire [116:0] fmt_a = a_reg;
