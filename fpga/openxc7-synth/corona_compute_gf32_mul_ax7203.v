...
`timescale 1ns / 1ps
// corona_compute_gf32_mul_ax7203 — GoldenFloat32 MUL on AX7203.
// GF32 format: [S:1][E:8][M:23] = 32 bits (binary32 layout), BIAS=127, HAS_INF=1.
// NOTE: Uses -nodsp in synth (24x24 wide multiply breaks openXC7 DSP routing).
//
// Frame protocol (12 bytes TX):
//   AA 55 fmt a0 a1 a2 a3 b0 b1 b2 b3 trig
// Response (5 bytes RX):
//   A5 r0 r1 r2 r3

module corona_compute_gf32_mul_ax7203 (
    ...
    // ---- Frame FSM: AA 55 fmt a[0..3] b[0..3] trig (12 bytes) ----
