...
`timescale 1ns / 1ps
// corona_compute_fp79_e10m68_alu_ax7203 — FP79_E10M68 ALU on AX7203.
module corona_compute_fp79_e10m68_alu_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a_a[77:68];
    ...
    wire [9:0] f_exp_b = fmt_b_b[77:68];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 68'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 68'd0};
