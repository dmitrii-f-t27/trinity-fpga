...
`timescale 1ns / 1ps
// corona_compute_fp114_e13m100_fma_ax7203 — FP114_E13M100 FMA on AX7203.
module corona_compute_fp114_e13m100_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[112:100];
    ...
    wire [12:0] f_exp_b = fmt_b[112:100];
    ...
    wire [12:0] f_exp_c = fmt_c[112:100];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 100'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 100'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 113'b0};
