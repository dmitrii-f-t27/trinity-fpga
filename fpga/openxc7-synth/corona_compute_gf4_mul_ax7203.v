...
`timescale 1ns / 1ps
// corona_compute_gf4_mul_ax7203 — GoldenFloat4 MUL on AX7203.
// GF4: [S:1][E:1][M:2] = 4 bits, BIAS=0, HAS_INF=0.
module corona_compute_gf4_mul_ax7203 (
    ...
    wire comp_in_ready, comp_out_valid; wire [3:0] comp_result;
    gf_mul_param #(.EXP_BITS(1), .MANT_BITS(2), .HAS_INF(0)) u_comp (
        .clk(mclk), .rst(rst),
