...
module corona_compute_fp36_e8m27_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[35];
    wire [7:0] f_exp_a = fmt_a_a[34:27];
    ...
    wire f_sign_b = fmt_b_b[35];
    wire [7:0] f_exp_b = fmt_b_b[34:27];
    ...
    wire f_sign_c = fmt_c_c[35];
    wire [7:0] f_exp_c = fmt_c_c[34:27];
    wire [26:0] f_mant_c = fmt_c_c[26:0];
