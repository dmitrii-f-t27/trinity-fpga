...
`timescale 1ns / 1ps
// corona_compute_fp40_e11m28_fma_ax7203 — FP40_E11M28 FMA on AX7203.
module corona_compute_fp40_e11m28_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 28'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 28'd0};
