...
`timescale 1ns / 1ps
// corona_compute_fp23_e7m15_fma_ax7203 — FP23_E7M15 FMA on AX7203.
module corona_compute_fp23_e7m15_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 7'd127, 15'd0};
        else if(q_exp >= 8'd192) q_result={q_sign, 7'd127, 15'd0};
        else if(q_exp < 8'd65) q_result={q_sign, 22'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 7'b0, q_mant[22:8]};
        else q_result={q_sign, tgt_exp_s[6:0], q_mant[22:8]};
    end
