...
`timescale 1ns / 1ps
// corona_compute_fp119_e14m104_fma_ax7203 — FP119_E14M104 FMA on AX7203.
module corona_compute_fp119_e14m104_fma_ax7203 (
    ...
    wire [13:0] f_exp_a = fmt_a[117:104];
    ...
    wire [13:0] f_exp_b = fmt_b[117:104];
    ...
    wire [13:0] f_exp_c = fmt_c[117:104];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 14'd16383, 104'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 14'd16383, 104'd0};
