...
`timescale 1ns / 1ps
// corona_compute_fp58_e8m49_fma_ax7203 — FP58_E8M49 FMA on AX7203.
module corona_compute_fp58_e8m49_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a[56:49];
    wire [48:0] f_mant_a = fmt_a[48:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -26'b0};
    ...
    wire [7:0] f_exp_b = fmt_b[56:49];
    wire [48:0] f_mant_b = fmt_b[48:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -26'b0};
    ...
    wire [7:0] f_exp_c = fmt_c[56:49];
    wire [48:0] f_mant_c = fmt_c[48:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -26'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 49'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 49'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 57'b0};
