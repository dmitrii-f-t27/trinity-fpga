...
`timescale 1ns / 1ps
// corona_compute_lns16_fma_ax7203 — LNS16 FMA on AX7203.
module corona_compute_lns16_fma_ax7203 (
    ...
    wire [15:0] lns_val_c = fmt_c;
    wire lns_sign_c = lns_val_c[15];
    wire [14:0] lns_log_c = lns_val_c[14:0];
    wire lns_zero_c = (lns_val_c==16'h0000);
    wire signed [14:0] lns_slog_c = $signed(lns_log_c);
    wire signed [7:0] lns_int_c = lns_slog_c >>> 7;
    ...
    wire [8:0] lns_exp32_c = {1'b0, {1'b0,lns_int_c[6:0]}} + 9'd127;
    reg [31:0] fp32_c;
    always @(*) begin
