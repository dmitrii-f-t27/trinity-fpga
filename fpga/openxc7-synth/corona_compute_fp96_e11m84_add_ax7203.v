...
`timescale 1ns / 1ps
// corona_compute_fp96_e11m84_add_ax7203 — FP96_E11M84 ADD on AX7203.
module corona_compute_fp96_e11m84_add_ax7203 (
    ...
    wire [10:0] f_exp_a = fmt_a_a[94:84];
    ...
    wire [10:0] f_exp_b = fmt_b_b[94:84];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 84'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 84'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 95'b0};
