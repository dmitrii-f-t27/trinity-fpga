...
`timescale 1ns / 1ps
// corona_compute_fp12_fma_ax7203 — FP12 FMA on AX7203.
module corona_compute_fp12_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 6'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 6'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 11'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 5'b0, q_mant[22:17]};
        else q_result={q_sign, tgt_exp_s[4:0], q_mant[22:17]};
    end
