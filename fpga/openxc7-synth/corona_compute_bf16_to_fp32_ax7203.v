...
`timescale 1ns / 1ps
// corona_compute_bf16_to_fp32_ax7203 — BF16 TO_FP32 on AX7203.
module corona_compute_bf16_to_fp32_ax7203 (
    ...
    wire sv=a_reg[15]; wire [7:0] ev=a_reg[14:7]; wire [6:0] mv=a_reg[6:0];
    wire iz=(ev==0)&&(mv==0);
    ...
    always @(*) begin
        ...
        else fr={sv,{8'b0,ev}+9'd0,{16{1'b0}},mv};
    end
    always @(posedge mclk or posedge rst) begin
