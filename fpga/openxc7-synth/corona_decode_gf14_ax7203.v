...
`timescale 1ns / 1ps
// corona_decode_gf14_ax7203 — GoldenFloat14 (1S+5E+8M) decode on AX7203.
...
// (gf14_decode: GF14 code[13:0] -> FP32, standard IEEE-like unpack, no Inf).
module corona_decode_gf14_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero;
    gf14_decode u_dec (.gf14_in(code_r[13:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
