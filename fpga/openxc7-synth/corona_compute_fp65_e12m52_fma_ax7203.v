...
`timescale 1ns / 1ps
// corona_compute_fp65_e12m52_fma_ax7203 — FP65_E12M52 FMA on AX7203.
module corona_compute_fp65_e12m52_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[63:52];
    wire [51:0] f_mant_a = fmt_a[51:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -29'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[63:52];
    wire [51:0] f_mant_b = fmt_b[51:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -29'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[63:52];
    wire [51:0] f_mant_c = fmt_c[51:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -29'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 52'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 52'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 64'b0};
