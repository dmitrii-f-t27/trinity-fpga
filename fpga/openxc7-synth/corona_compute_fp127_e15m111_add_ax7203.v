...
`timescale 1ns / 1ps
// corona_compute_fp127_e15m111_add_ax7203 — FP127_E15M111 ADD on AX7203.
module corona_compute_fp127_e15m111_add_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [126:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [126:0] a_reg,b_reg; reg comp_trigger;
