...
`timescale 1ns / 1ps
// corona_compute_fp4_e2m1_cmp_ax7203 — FP4_E2M1 CMP on AX7203.
module corona_compute_fp4_e2m1_cmp_ax7203 (
    ...
    wire sa=a_reg[3]; wire [1:0] ea=a_reg[2:1]; wire [0:0] ma=a_reg[0:0];
    wire sb=b_reg[3]; wire [1:0] eb=b_reg[2:1]; wire [0:0] mb=b_reg[0:0];
    wire az=(ea==0)&&(ma==0); wire bz=(eb==0)&&(mb==0);
    wire an=(0)&&(ea=={2{1'b1}})&&(ma!=0); wire bn=(0)&&(eb=={2{1'b1}})&&(mb!=0);
    wire [2:0] aa={ea,ma}; wire [2:0] ab={eb,mb};
