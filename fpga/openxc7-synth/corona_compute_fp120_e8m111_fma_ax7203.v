...
module corona_compute_fp120_e8m111_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[118:111];
    wire [110:0] f_mant_a = fmt_a_a[110:0];
    ...
    wire [7:0] f_exp_b = fmt_b_b[118:111];
    wire [110:0] f_mant_b = fmt_b_b[110:0];
    ...
    wire f_sign_c = fmt_c_c[119];
    wire [7:0] f_exp_c = fmt_c_c[118:111];
    wire [110:0] f_mant_c = fmt_c_c[110:0];
