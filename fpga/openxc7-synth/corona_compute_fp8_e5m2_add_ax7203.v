...
`timescale 1ns / 1ps
// corona_compute_fp8_e5m2_add_ax7203 — FP8_E5M2 ADD on AX7203.
module corona_compute_fp8_e5m2_add_ax7203 (
    ...
    wire comp_irdy,comp_ovld; wire [7:0] comp_result;
    gf_adder_param #(.EXP_BITS(5),.MANT_BITS(2),.HAS_INF(1)) u_comp (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={{24{1'b0}},comp_result};
        end
    end
