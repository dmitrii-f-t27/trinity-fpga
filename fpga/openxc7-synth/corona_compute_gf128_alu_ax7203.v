...
`timescale 1ns / 1ps
// corona_compute_gf128_alu_ax7203 — GoldenFloat128 ALU (ADD+MUL) on AX7203.
// GF128: [S:1][E:49][M:78] = 128 bits, HAS_INF=0.
// op: 0x00=ADD, 0x01=MUL
module corona_compute_gf128_alu_ax7203 (
    ...
    // ---- Frame FSM ----
    reg [5:0] frm; reg [7:0] fmt_r; reg [7:0] op_r; reg [127:0] a_r, b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    wire [127:0] comp_result = is_mul ? mul_result : add_result;
