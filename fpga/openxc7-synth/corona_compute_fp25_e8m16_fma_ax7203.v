...
`timescale 1ns / 1ps
// corona_compute_fp25_e8m16_fma_ax7203 — FP25_E8M16 FMA on AX7203.
module corona_compute_fp25_e8m16_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a[23:16];
    wire [15:0] f_mant_a = fmt_a[15:0];
    ...
    wire [22:0] f_mant32_norm_a = {1'b0, f_mant_a, 6'b0};
    reg [31:0] fp32_a;
    always @(*) begin
    ...
    wire [7:0] f_exp_b = fmt_b[23:16];
    wire [15:0] f_mant_b = fmt_b[15:0];
    ...
    wire [22:0] f_mant32_norm_b = {1'b0, f_mant_b, 6'b0};
    reg [31:0] fp32_b;
    always @(*) begin
    ...
    wire [7:0] f_exp_c = fmt_c[23:16];
    wire [15:0] f_mant_c = fmt_c[15:0];
    ...
    wire [22:0] f_mant32_norm_c = {1'b0, f_mant_c, 6'b0};
    reg [31:0] fp32_c;
    always @(*) begin
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 16'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 16'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 24'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 8'b0, q_mant[22:7]};
        else q_result={q_sign, tgt_exp_s[7:0], q_mant[22:7]};
    end
