...
module corona_compute_fp58_e9m48_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[57];
    wire [8:0] f_exp_a = fmt_a_a[56:48];
    wire [47:0] f_mant_a = fmt_a_a[47:0];
    ...
    wire f_sign_b = fmt_b_b[57];
    wire [8:0] f_exp_b = fmt_b_b[56:48];
    wire [47:0] f_mant_b = fmt_b_b[47:0];
    ...
    wire f_sign_c = fmt_c_c[57];
    wire [8:0] f_exp_c = fmt_c_c[56:48];
    wire [47:0] f_mant_c = fmt_c_c[47:0];
