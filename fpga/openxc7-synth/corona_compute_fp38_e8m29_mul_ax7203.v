...
`timescale 1ns / 1ps
// corona_compute_fp38_e8m29_mul_ax7203 — FP38_E8M29 MUL on AX7203.
module corona_compute_fp38_e8m29_mul_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [37:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd7: begin a_r[37:32]<=rx_byte;frm<=4'd8; end
                ...
                4'd12: begin b_r[37:32]<=rx_byte;frm<=4'd13; end
