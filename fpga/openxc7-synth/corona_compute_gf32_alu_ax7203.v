...
`timescale 1ns / 1ps
// corona_compute_gf32_alu_ax7203 — GoldenFloat32 ALU (ADD+MUL) on AX7203.
...
module corona_compute_gf32_alu_ax7203 (
    ...
    // ---- Frame FSM ----
    reg [3:0] frm; reg [7:0] fmt_r; reg [7:0] op_r; reg [31:0] a_r, b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    // ---- GF32 ADD + MUL (both compute in parallel, mux selects) ----
    ...
    wire [31:0] comp_result = is_mul ? mul_result : add_result;
