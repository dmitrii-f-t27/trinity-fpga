...
`timescale 1ns / 1ps
// corona_compute_fp4_e2m1_to_fp32_ax7203 — FP4_E2M1 TO_FP32 on AX7203.
module corona_compute_fp4_e2m1_to_fp32_ax7203 (
    ...
    wire sv=a_reg[3]; wire [1:0] ev=a_reg[2:1]; wire [0:0] mv=a_reg[0:0];
    wire iz=(ev==0)&&(mv==0);
    ...
    always @(*) begin
        ...
        else fr={sv,{8'b0,ev}+9'd126,{22{1'b0}},mv};
    end
    always @(posedge mclk or posedge rst) begin
