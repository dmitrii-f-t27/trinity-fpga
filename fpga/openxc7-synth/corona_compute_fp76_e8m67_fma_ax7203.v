...
module corona_compute_fp76_e8m67_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[75];
    wire [7:0] f_exp_a = fmt_a[74:67];
    wire [66:0] f_mant_a = fmt_a[66:0];
    ...
    wire f_sign_b = fmt_b[75];
    wire [7:0] f_exp_b = fmt_b[74:67];
    wire [66:0] f_mant_b = fmt_b[66:0];
    ...
    wire f_sign_c = fmt_c[75];
    wire [7:0] f_exp_c = fmt_c[74:67];
    wire [66:0] f_mant_c = fmt_c[66:0];
