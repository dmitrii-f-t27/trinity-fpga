...
`timescale 1ns / 1ps
// corona_compute_fp41_e8m32_mul_ax7203 — FP41_E8M32 MUL on AX7203.
module corona_compute_fp41_e8m32_mul_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [40:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd8: begin a_r[40:40]<=rx_byte;frm<=4'd9; end
                ...
                4'd14: begin b_r[40:40]<=rx_byte;frm<=4'd15; end
    ...
    reg [40:0] a_reg,b_reg; reg comp_trigger;
