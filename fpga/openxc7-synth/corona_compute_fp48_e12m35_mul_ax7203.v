...
`timescale 1ns / 1ps
// corona_compute_fp48_e12m35_mul_ax7203 — FP48_E12M35 MUL on AX7203.
module corona_compute_fp48_e12m35_mul_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [47:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd14: begin b_r[47:40]<=rx_byte;frm<=4'd15; end
    ...
    reg [47:0] a_reg,b_reg; reg comp_trigger;
