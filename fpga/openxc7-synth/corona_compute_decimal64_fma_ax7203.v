...
`timescale 1ns / 1ps
// corona_compute_decimal64_fma_ax7203 — DECIMAL64 FMA on AX7203.
module corona_compute_decimal64_fma_ax7203 (
    ...
    wire d64_sign_c = fmt_c[63];
    wire d64_case_b_c = (fmt_c[62:61] == 2'b11);
    wire [9:0] d64_exp_a_c = fmt_c[61:53];
    wire [9:0] d64_exp_b_c = {fmt_c[59:51]};
    wire [51:0] d64_coeff_a_c = fmt_c[51:0];
    wire [51:0] d64_coeff_b_c = {3'b100, fmt_c[48:0]};
    wire [9:0] d64_exp_c = d64_case_b_c ? d64_exp_b_c : d64_exp_a_c;
    wire [51:0] d64_coeff_c = d64_case_b_c ? d64_coeff_b_c : d64_coeff_a_c;
    wire d64_zero_c = (d64_exp_c == 0) && (d64_coeff_c == 0);
    wire d64_special_c = (fmt_c[62:59] == 4'b1111);
    wire signed [11:0] d64_de_c = $signed({2'b0, d64_exp_c}) - 12'sd398;
    wire [11:0] d64_exp32_raw_c = d64_de_c[11] ?
        (12'd127 - (~d64_de_c[10:0] + 11'd1)) :
        ({2'b0, d64_de_c[10:0]} + 12'd127);
    wire [7:0] d64_exp32_c = d64_exp32_raw_c[7:0];
    wire [22:0] d64_mant32_c = d64_coeff_c[51:29];
    reg [31:0] fp32_c;
    always @(*) begin
        if(d64_zero_c || d64_special_c) fp32_c=32'h00000000;
        else fp32_c={d64_sign_c, d64_exp32_c, d64_mant32_c};
    end
