...
module corona_compute_fp68_e9m58_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[67];
    wire [8:0] f_exp_a = fmt_a_a[66:58];
    wire [57:0] f_mant_a = fmt_a_a[57:0];
    ...
    wire f_sign_b = fmt_b_b[67];
    wire [8:0] f_exp_b = fmt_b_b[66:58];
    wire [57:0] f_mant_b = fmt_b_b[57:0];
    ...
    wire f_sign_c = fmt_c_c[67];
    wire [8:0] f_exp_c = fmt_c_c[66:58];
    wire [57:0] f_mant_c = fmt_c_c[57:0];
