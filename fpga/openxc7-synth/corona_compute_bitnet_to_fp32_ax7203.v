...
`timescale 1ns / 1ps
// corona_compute_bitnet_to_fp32_ax7203 — BitNet TO_FP32 on AX7203.
module corona_compute_bitnet_to_fp32_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [1:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    always @(*) begin
        casez(code)
            2'd0: fp32_val = 32'h00000000;
            2'd1: fp32_val = 32'h3F800000;
            2'd2: fp32_val = 32'hBF800000;
            2'd3: fp32_val = 32'h00000000;
