...
module corona_compute_fp5_e3m1_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[4];
    wire [2:0] f_exp_a = fmt_a_a[3:1];
    ...
    wire f_sign_b = fmt_b_b[4];
    wire [2:0] f_exp_b = fmt_b_b[3:1];
    ...
    wire f_sign_c = fmt_c_c[4];
    wire [2:0] f_exp_c = fmt_c_c[3:1];
