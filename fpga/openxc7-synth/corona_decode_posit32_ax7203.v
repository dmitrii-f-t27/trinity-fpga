...
`timescale 1ns / 1ps
// corona_decode_posit32_ax7203 — Posit32 (n=32, es=2) decode on AX7203.
// 32-bit decode frame (4 code bytes). posit32 regime decode + RNE rounding.
module corona_decode_posit32_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero, is_nar;
    posit32_decode u_dec (.posit_in(code_r[31:0]), .fp32_out(result), .is_zero(is_zero), .is_nar(is_nar));
    assign led[2] = |result;
