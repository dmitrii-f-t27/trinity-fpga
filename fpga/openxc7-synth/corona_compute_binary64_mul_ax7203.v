...
`timescale 1ns / 1ps
// corona_compute_binary64_mul_ax7203 — BINARY64 MUL on AX7203.
module corona_compute_binary64_mul_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(11),.MANT_BITS(52),.HAS_INF(1)) u_comp (
