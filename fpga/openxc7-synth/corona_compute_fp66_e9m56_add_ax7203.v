...
`timescale 1ns / 1ps
// corona_compute_fp66_e9m56_add_ax7203 — FP66_E9M56 ADD on AX7203.
module corona_compute_fp66_e9m56_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [65:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [65:0] a_reg,b_reg; reg comp_trigger;
