...
`timescale 1ns / 1ps
// corona_compute_fp77_e8m68_alu_ax7203 — FP77_E8M68 ALU on AX7203.
module corona_compute_fp77_e8m68_alu_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[75:68];
    ...
    wire [7:0] f_exp_b = fmt_b_b[75:68];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 68'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 68'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 76'b0};
