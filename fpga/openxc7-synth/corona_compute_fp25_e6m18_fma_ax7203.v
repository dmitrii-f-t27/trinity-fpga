...
module corona_compute_fp25_e6m18_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[24];
    wire [5:0] f_exp_a = fmt_a_a[23:18];
    wire [17:0] f_mant_a = fmt_a_a[17:0];
    ...
    wire f_sign_b = fmt_b_b[24];
    wire [5:0] f_exp_b = fmt_b_b[23:18];
    wire [17:0] f_mant_b = fmt_b_b[17:0];
    ...
    wire f_sign_c = fmt_c_c[24];
    wire [5:0] f_exp_c = fmt_c_c[23:18];
    wire [17:0] f_mant_c = fmt_c_c[17:0];
