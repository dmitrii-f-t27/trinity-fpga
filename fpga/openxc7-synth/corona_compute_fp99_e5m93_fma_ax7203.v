...
`timescale 1ns / 1ps
// corona_compute_fp99_e5m93_fma_ax7203 — FP99_E5M93 FMA on AX7203.
module corona_compute_fp99_e5m93_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 93'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 93'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 98'b0};
