...
`timescale 1ns / 1ps
// corona_compute_fp113_e13m99_fma_ax7203 — FP113_E13M99 FMA on AX7203.
module corona_compute_fp113_e13m99_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[111:99];
    ...
    wire [12:0] f_exp_b = fmt_b[111:99];
    ...
    wire [12:0] f_exp_c = fmt_c[111:99];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 99'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 99'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 112'b0};
