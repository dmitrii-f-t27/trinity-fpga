...
`timescale 1ns / 1ps
// corona_compute_fp68_e9m58_add_ax7203 — FP68_E9M58 ADD on AX7203.
module corona_compute_fp68_e9m58_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [67:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [67:0] a_reg,b_reg; reg comp_trigger;
