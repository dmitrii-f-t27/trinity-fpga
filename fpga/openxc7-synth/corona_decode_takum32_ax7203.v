...
module corona_decode_takum32_ax7203 (
    ...
    assign led[2] = |result;
    // 8-cycle frame_valid delay (6 pipeline stages + 2 for synchronous BRAM read latency)
    reg frame_valid_d1,frame_valid_d2,frame_valid_d3,frame_valid_d4,frame_valid_d5,frame_valid_d6,frame_valid_d7,frame_valid_d8;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frame_valid_d1<=0;frame_valid_d2<=0;frame_valid_d3<=0;frame_valid_d4<=0;frame_valid_d5<=0;frame_valid_d6<=0;frame_valid_d7<=0;frame_valid_d8<=0; end
        else begin frame_valid_d1<=frame_valid;frame_valid_d2<=frame_valid_d1;frame_valid_d3<=frame_valid_d2;frame_valid_d4<=frame_valid_d3;frame_valid_d5<=frame_valid_d4;frame_valid_d6<=frame_valid_d5;frame_valid_d7<=frame_valid_d6;frame_valid_d8<=frame_valid_d7; end
    end
