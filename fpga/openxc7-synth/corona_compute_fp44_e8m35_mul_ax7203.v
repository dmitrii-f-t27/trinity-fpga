...
`timescale 1ns / 1ps
// corona_compute_fp44_e8m35_mul_ax7203 — FP44_E8M35 MUL on AX7203.
module corona_compute_fp44_e8m35_mul_ax7203 (
    ...
    reg [3:0] frm; reg [7:0] fmt_r; reg [43:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                4'd8: begin a_r[43:40]<=rx_byte;frm<=4'd9; end
                4'd9: begin b_r[7:0]<=rx_byte;frm<=4'd10; end
                4'd10: begin b_r[15:8]<=rx_byte;frm<=4'd11; end
                4'd11: begin b_r[23:16]<=rx_byte;frm<=4'd12; end
                4'd12: begin b_r[31:24]<=rx_byte;frm<=4'd13; end
                4'd13: begin b_r[39:32]<=rx_byte;frm<=4'd14; end
                4'd14: begin b_r[43:40]<=rx_byte;frm<=4'd15; end
    ...
    reg [43:0] a_reg,b_reg; reg comp_trigger;
