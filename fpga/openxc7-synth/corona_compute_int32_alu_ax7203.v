...
`timescale 1ns / 1ps
// corona_compute_int32_alu_ax7203 — INT32 ALU on AX7203.
module corona_compute_int32_alu_ax7203 (
    ...
    wire signed [31:0] sa=a_reg, sb=b_reg;
    wire [31:0] add_r = sa + sb;
    wire [31:0] mul_r = sa * sb;
    wire [31:0] ar = (op_reg==8'h00)?add_r:mul_r;
    always @(posedge mclk or posedge rst) begin
