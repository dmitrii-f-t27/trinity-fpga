...
`timescale 1ns / 1ps
// corona_compute_fp7_e4m2_to_fp32_ax7203 — FP7_E4M2 TO_FP32 on AX7203.
module corona_compute_fp7_e4m2_to_fp32_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [6:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [6:0] a_reg; reg conv_trigger;
    wire [6:0] fmt_a = a_reg;
