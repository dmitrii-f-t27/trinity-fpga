...
`timescale 1ns / 1ps
// corona_compute_fp62_e9m52_add_ax7203 — FP62_E9M52 ADD on AX7203.
module corona_compute_fp62_e9m52_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [61:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [61:0] a_reg,b_reg; reg comp_trigger;
