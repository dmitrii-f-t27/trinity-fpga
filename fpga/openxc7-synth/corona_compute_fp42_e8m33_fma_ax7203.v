...
module corona_compute_fp42_e8m33_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[41];
    wire [7:0] f_exp_a = fmt_a_a[40:33];
    wire [32:0] f_mant_a = fmt_a_a[32:0];
    ...
    wire f_sign_b = fmt_b_b[41];
    wire [7:0] f_exp_b = fmt_b_b[40:33];
    wire [32:0] f_mant_b = fmt_b_b[32:0];
    ...
    wire f_sign_c = fmt_c_c[41];
    wire [7:0] f_exp_c = fmt_c_c[40:33];
    wire [32:0] f_mant_c = fmt_c_c[32:0];
