...
module corona_compute_fp46_e8m37_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[45];
    wire [7:0] f_exp_a = fmt_a_a[44:37];
    wire [36:0] f_mant_a = fmt_a_a[36:0];
    ...
    wire f_sign_b = fmt_b_b[45];
    wire [7:0] f_exp_b = fmt_b_b[44:37];
    wire [36:0] f_mant_b = fmt_b_b[36:0];
    ...
    wire f_sign_c = fmt_c_c[45];
    wire [7:0] f_exp_c = fmt_c_c[44:37];
    wire [36:0] f_mant_c = fmt_c_c[36:0];
