...
module corona_compute_fp100_e8m91_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[99];
    wire [7:0] f_exp_a = fmt_a_a[98:91];
    wire [90:0] f_mant_a = fmt_a_a[90:0];
    ...
    wire f_sign_b = fmt_b_b[99];
    wire [7:0] f_exp_b = fmt_b_b[98:91];
    wire [90:0] f_mant_b = fmt_b_b[90:0];
    ...
    wire f_sign_c = fmt_c_c[99];
    wire [7:0] f_exp_c = fmt_c_c[98:91];
    wire [90:0] f_mant_c = fmt_c_c[90:0];
