...
`timescale 1ns / 1ps
// corona_compute_fp65_e10m54_fma_ax7203 — FP65_E10M54 FMA on AX7203.
module corona_compute_fp65_e10m54_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 54'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 54'd0};
