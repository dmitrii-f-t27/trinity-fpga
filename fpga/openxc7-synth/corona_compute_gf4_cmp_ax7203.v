...
`timescale 1ns / 1ps
// corona_compute_gf4_cmp_ax7203 — GoldenFloat4 comparison on AX7203.
...
module corona_compute_gf4_cmp_ax7203 (
    ...
    wire        sa = a_reg[3];
    wire [0:0] ea = a_reg[2:2];
    wire [1:0] ma = a_reg[1:0];
    wire        sb = b_reg[3];
    wire [0:0] eb = b_reg[2:2];
    wire [1:0] mb = b_reg[1:0];
    ...
    wire [2:0] abs_a = {ea, ma};
    wire [2:0] abs_b = {eb, mb};
