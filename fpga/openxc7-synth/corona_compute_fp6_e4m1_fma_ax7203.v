...
module corona_compute_fp6_e4m1_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[5];
    wire [3:0] f_exp_a = fmt_a_a[4:1];
    ...
    wire f_sign_b = fmt_b_b[5];
    wire [3:0] f_exp_b = fmt_b_b[4:1];
    ...
    wire f_sign_c = fmt_c_c[5];
    wire [3:0] f_exp_c = fmt_c_c[4:1];
