...
`timescale 1ns / 1ps
// corona_compute_fp6_e4m1_fma_ax7203 — FP6_E4M1 FMA on AX7203.
module corona_compute_fp6_e4m1_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[5];
    wire [3:0] f_exp_a = fmt_a[4:1];
    ...
    wire f_sign_b = fmt_b[5];
    wire [3:0] f_exp_b = fmt_b[4:1];
    ...
    wire f_sign_c = fmt_c[5];
    wire [3:0] f_exp_c = fmt_c[4:1];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 4'd15, 1'd0};
        else if(q_exp >= 8'd136) q_result={q_sign, 4'd15, 1'd0};
        else if(q_exp < 8'd121) q_result={q_sign, 5'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 4'b0, q_mant[22:22]};
        else q_result={q_sign, tgt_exp_s[3:0], q_mant[22:22]};
    end
