...
`timescale 1ns / 1ps
// corona_compute_fp4_e2m1_add_ax7203 — FP4_E2M1 ADD on AX7203.
module corona_compute_fp4_e2m1_add_ax7203 (
    ...
    wire comp_irdy,comp_ovld; wire [3:0] comp_result;
    gf_adder_param #(.EXP_BITS(2),.MANT_BITS(1),.HAS_INF(0)) u_comp (
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={{28{1'b0}},comp_result};
        end
    end
