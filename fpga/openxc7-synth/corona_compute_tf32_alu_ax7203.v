...
`timescale 1ns / 1ps
// corona_compute_tf32_alu_ax7203 — TF32 ALU on AX7203.
module corona_compute_tf32_alu_ax7203 (
    ...
    wire add_irdy,add_ovld; wire [18:0] add_res;
    wire mul_irdy,mul_ovld; wire [18:0] mul_res;
