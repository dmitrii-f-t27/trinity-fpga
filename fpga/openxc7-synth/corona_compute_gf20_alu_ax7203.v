...
`timescale 1ns / 1ps
// corona_compute_gf20_alu_ax7203 — GoldenFloat20 ALU (ADD+MUL) on AX7203.
// Instantiates both gf_adder_param and gf_mul_param in parallel, selects via op byte.
// GF20: [S:1][E:7][M:12] = 20 bits, BIAS=63, HAS_INF=0.
//
...
module corona_compute_gf20_alu_ax7203 (
    ...
    // ---- Frame FSM ----
    reg [3:0] frm; reg [7:0] fmt_r; reg [7:0] op_r; reg [19:0] a_r, b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    wire [19:0] comp_result = is_mul ? mul_result : add_result;
