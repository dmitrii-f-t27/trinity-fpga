...
`timescale 1ns / 1ps
// corona_compute_fp107_e8m98_to_fp32_ax7203 — FP107_E8M98 TO_FP32 on AX7203.
module corona_compute_fp107_e8m98_to_fp32_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [106:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
