...
`timescale 1ns / 1ps
// corona_compute_fp16_e8m7_fma_ax7203 — FP16_E8M7 FMA on AX7203.
module corona_compute_fp16_e8m7_fma_ax7203 (
    ...
    wire f_sign_b = fmt_b_b[15];
    wire [7:0] f_exp_b = fmt_b_b[14:7];
    ...
    wire f_sign_c = fmt_c_c[15];
    wire [7:0] f_exp_c = fmt_c_c[14:7];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 7'd0};
        else if(q_exp >= 8'd256) q_result={q_sign, 8'd255, 7'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 15'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 8'b0, q_mant[22:16]};
        else q_result={q_sign, tgt_exp_s[7:0], q_mant[22:16]};
    end
