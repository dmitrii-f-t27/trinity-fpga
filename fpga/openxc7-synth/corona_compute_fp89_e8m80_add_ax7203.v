...
module corona_compute_fp89_e8m80_add_ax7203 (
    ...
    wire f_sign_a = fmt_a[88];
    wire [7:0] f_exp_a = fmt_a[87:80];
    wire [79:0] f_mant_a = fmt_a[79:0];
    ...
    wire f_sign_b = fmt_b[88];
    wire [7:0] f_exp_b = fmt_b[87:80];
    wire [79:0] f_mant_b = fmt_b[79:0];
