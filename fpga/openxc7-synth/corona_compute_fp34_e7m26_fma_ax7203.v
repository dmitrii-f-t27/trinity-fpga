...
`timescale 1ns / 1ps
// corona_compute_fp34_e7m26_fma_ax7203 — FP34_E7M26 FMA on AX7203.
module corona_compute_fp34_e7m26_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 7'd127, 26'd0};
        else if(q_exp >= 8'd192) q_result={q_sign, 7'd127, 26'd0};
        else if(q_exp < 8'd65) q_result={q_sign, 33'b0};
