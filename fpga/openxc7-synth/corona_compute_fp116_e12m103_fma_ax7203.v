...
`timescale 1ns / 1ps
// corona_compute_fp116_e12m103_fma_ax7203 — FP116_E12M103 FMA on AX7203.
module corona_compute_fp116_e12m103_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[114:103];
    ...
    wire [11:0] f_exp_b = fmt_b[114:103];
    ...
    wire [11:0] f_exp_c = fmt_c[114:103];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 103'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 103'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 115'b0};
