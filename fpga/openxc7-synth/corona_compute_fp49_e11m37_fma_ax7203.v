...
`timescale 1ns / 1ps
// corona_compute_fp49_e11m37_fma_ax7203 — FP49_E11M37 FMA on AX7203.
module corona_compute_fp49_e11m37_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 37'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 37'd0};
