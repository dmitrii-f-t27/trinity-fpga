...
`timescale 1ns / 1ps
// corona_compute_fp96_e5m90_add_ax7203 — FP96_E5M90 ADD on AX7203.
module corona_compute_fp96_e5m90_add_ax7203 (
    ...
    wire [4:0] f_exp_a = fmt_a_a[94:90];
    ...
    wire [4:0] f_exp_b = fmt_b_b[94:90];
