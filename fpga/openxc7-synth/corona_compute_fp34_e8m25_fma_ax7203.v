...
module corona_compute_fp34_e8m25_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[33];
    wire [7:0] f_exp_a = fmt_a_a[32:25];
    wire [24:0] f_mant_a = fmt_a_a[24:0];
    ...
    wire f_sign_b = fmt_b_b[33];
    wire [7:0] f_exp_b = fmt_b_b[32:25];
    wire [24:0] f_mant_b = fmt_b_b[24:0];
    ...
    wire f_sign_c = fmt_c_c[33];
    wire [7:0] f_exp_c = fmt_c_c[32:25];
    wire [24:0] f_mant_c = fmt_c_c[24:0];
