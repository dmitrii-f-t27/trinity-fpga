...
`timescale 1ns / 1ps
// corona_compute_binary64_add_ax7203 — BINARY64 ADD on AX7203.
module corona_compute_binary64_add_ax7203 (
    ...
    wire comp_irdy,comp_ovld; wire [63:0] comp_result;
    gf_adder_param #(.EXP_BITS(11),.MANT_BITS(52),.HAS_INF(1)) u_comp (
