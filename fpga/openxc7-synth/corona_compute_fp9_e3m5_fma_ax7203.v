...
`timescale 1ns / 1ps
// corona_compute_fp9_e3m5_fma_ax7203 — FP9_E3M5 FMA on AX7203.
module corona_compute_fp9_e3m5_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 3'd7, 5'd0};
        else if(q_exp >= 8'd132) q_result={q_sign, 3'd7, 5'd0};
        else if(q_exp < 8'd125) q_result={q_sign, 8'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 3'b0, q_mant[22:18]};
        else q_result={q_sign, tgt_exp_s[2:0], q_mant[22:18]};
    end
