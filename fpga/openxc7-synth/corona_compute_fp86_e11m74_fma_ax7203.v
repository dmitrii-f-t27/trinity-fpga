...
`timescale 1ns / 1ps
// corona_compute_fp86_e11m74_fma_ax7203 — FP86_E11M74 FMA on AX7203.
module corona_compute_fp86_e11m74_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 74'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 74'd0};
