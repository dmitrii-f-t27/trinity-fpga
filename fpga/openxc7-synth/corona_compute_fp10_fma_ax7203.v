...
module corona_compute_fp10_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[9];
    wire [3:0] f_exp_a = fmt_a_a[8:5];
    ...
    wire f_sign_b = fmt_b_b[9];
    wire [3:0] f_exp_b = fmt_b_b[8:5];
    ...
    wire f_sign_c = fmt_c_c[9];
    wire [3:0] f_exp_c = fmt_c_c[8:5];
