...
module corona_compute_fp74_e8m65_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[73];
    wire [7:0] f_exp_a = fmt_a[72:65];
    wire [64:0] f_mant_a = fmt_a[64:0];
    ...
    wire f_sign_b = fmt_b[73];
    wire [7:0] f_exp_b = fmt_b[72:65];
    wire [64:0] f_mant_b = fmt_b[64:0];
    ...
    wire f_sign_c = fmt_c[73];
    wire [7:0] f_exp_c = fmt_c[72:65];
    wire [64:0] f_mant_c = fmt_c[64:0];
