...
module corona_compute_fp39_e8m30_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[38];
    wire [7:0] f_exp_a = fmt_a_a[37:30];
    wire [29:0] f_mant_a = fmt_a_a[29:0];
    ...
    wire f_sign_b = fmt_b_b[38];
    wire [7:0] f_exp_b = fmt_b_b[37:30];
    wire [29:0] f_mant_b = fmt_b_b[29:0];
    ...
    wire f_sign_c = fmt_c_c[38];
    wire [7:0] f_exp_c = fmt_c_c[37:30];
    wire [29:0] f_mant_c = fmt_c_c[29:0];
