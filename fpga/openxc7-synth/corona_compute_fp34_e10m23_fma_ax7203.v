...
`timescale 1ns / 1ps
// corona_compute_fp34_e10m23_fma_ax7203 — FP34_E10M23 FMA on AX7203.
module corona_compute_fp34_e10m23_fma_ax7203 (
    ...
    wire [9:0] f_exp_a = fmt_a[32:23];
    wire [22:0] f_mant_a = fmt_a[22:0];
    ...
    wire [9:0] f_exp_b = fmt_b[32:23];
    wire [22:0] f_mant_b = fmt_b[22:0];
    ...
    wire [9:0] f_exp_c = fmt_c[32:23];
    wire [22:0] f_mant_c = fmt_c[22:0];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 23'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 23'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 33'b0};
