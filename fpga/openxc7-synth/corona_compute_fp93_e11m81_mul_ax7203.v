...
`timescale 1ns / 1ps
// corona_compute_fp93_e11m81_mul_ax7203 — FP93_E11M81 MUL on AX7203.
module corona_compute_fp93_e11m81_mul_ax7203 (
    ...
    wire [10:0] f_exp_a = fmt_a_a[91:81];
    ...
    wire [10:0] f_exp_b = fmt_b_b[91:81];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 81'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 81'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 92'b0};
