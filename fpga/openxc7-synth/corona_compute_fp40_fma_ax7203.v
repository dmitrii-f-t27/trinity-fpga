...
`timescale 1ns / 1ps
// corona_compute_fp40_fma_ax7203 — FP40 FMA on AX7203.
module corona_compute_fp40_fma_ax7203 (
    ...
    wire [22:0] f_mant32_norm_a = {1'b0, f_mant_a, -9'b0};
    reg [31:0] fp32_a;
    always @(*) begin
    ...
    wire [22:0] f_mant32_norm_b = {1'b0, f_mant_b, -9'b0};
    reg [31:0] fp32_b;
    always @(*) begin
    ...
    wire [22:0] f_mant32_norm_c = {1'b0, f_mant_c, -9'b0};
    reg [31:0] fp32_c;
    always @(*) begin
    ...
    always @(*) begin
        ...
        else if(q_exp >= 8'd256) q_result={q_sign, 8'd255, 31'd0};
