...
`timescale 1ns / 1ps
// corona_compute_fp115_e13m101_fma_ax7203 — FP115_E13M101 FMA on AX7203.
module corona_compute_fp115_e13m101_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[113:101];
    ...
    wire [12:0] f_exp_b = fmt_b[113:101];
    ...
    wire [12:0] f_exp_c = fmt_c[113:101];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 101'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 101'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 114'b0};
