...
`timescale 1ns / 1ps
// corona_compute_binary64_cmp_ax7203 — BINARY64 CMP on AX7203.
module corona_compute_binary64_cmp_ax7203 (
    ...
    wire sa=a_reg[63]; wire [10:0] ea=a_reg[62:52]; wire [51:0] ma=a_reg[51:0];
    wire sb=b_reg[63]; wire [10:0] eb=b_reg[62:52]; wire [51:0] mb=b_reg[51:0];
    wire az=(ea==0)&&(ma==0); wire bz=(eb==0)&&(mb==0);
    wire an=(ea==11'b11111111111)&&(ma!=0); wire bn=(eb==11'b11111111111)&&(mb!=0);
    wire [62:0] aa={ea,ma}; wire [62:0] ab={eb,mb};
