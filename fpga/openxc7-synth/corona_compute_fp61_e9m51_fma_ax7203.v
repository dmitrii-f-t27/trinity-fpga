...
module corona_compute_fp61_e9m51_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[60];
    wire [8:0] f_exp_a = fmt_a_a[59:51];
    wire [50:0] f_mant_a = fmt_a_a[50:0];
    ...
    wire f_sign_b = fmt_b_b[60];
    wire [8:0] f_exp_b = fmt_b_b[59:51];
    wire [50:0] f_mant_b = fmt_b_b[50:0];
    ...
    wire f_sign_c = fmt_c_c[60];
    wire [8:0] f_exp_c = fmt_c_c[59:51];
    wire [50:0] f_mant_c = fmt_c_c[50:0];
