...
`timescale 1ns / 1ps
// corona_compute_fp126_e15m110_mul_ax7203 — FP126_E15M110 MUL on AX7203.
module corona_compute_fp126_e15m110_mul_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [125:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [125:0] a_reg,b_reg; reg comp_trigger;
