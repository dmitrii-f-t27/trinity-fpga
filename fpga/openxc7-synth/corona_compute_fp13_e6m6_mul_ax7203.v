...
`timescale 1ns / 1ps
// corona_compute_fp13_e6m6_mul_ax7203 — FP13_E6M6 MUL on AX7203.
module corona_compute_fp13_e6m6_mul_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [12:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                3'd4: begin a_r[12:8]<=rx_byte;frm<=3'd5; end
                3'd5: begin b_r[7:0]<=rx_byte;frm<=3'd6; end
                3'd6: begin b_r[12:8]<=rx_byte;frm<=3'd7; end
    ...
    reg [12:0] a_reg,b_reg; reg comp_trigger;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(comp_ovld) result_reg<={19'b0,q_result};
        end
    end
