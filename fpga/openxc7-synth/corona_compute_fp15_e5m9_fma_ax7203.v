...
`timescale 1ns / 1ps
// corona_compute_fp15_e5m9_fma_ax7203 — FP15_E5M9 FMA on AX7203.
module corona_compute_fp15_e5m9_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 9'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 9'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 14'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 5'b0, q_mant[22:14]};
        else q_result={q_sign, tgt_exp_s[4:0], q_mant[22:14]};
    end
