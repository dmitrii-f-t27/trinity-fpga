...
`timescale 1ns / 1ps
// corona_compute_fp83_e13m69_fma_ax7203 — FP83_E13M69 FMA on AX7203.
module corona_compute_fp83_e13m69_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[81:69];
    wire [68:0] f_mant_a = fmt_a[68:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -46'b0};
    ...
    wire [12:0] f_exp_b = fmt_b[81:69];
    wire [68:0] f_mant_b = fmt_b[68:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -46'b0};
    ...
    wire [12:0] f_exp_c = fmt_c[81:69];
    wire [68:0] f_mant_c = fmt_c[68:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -46'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 69'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 69'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 82'b0};
