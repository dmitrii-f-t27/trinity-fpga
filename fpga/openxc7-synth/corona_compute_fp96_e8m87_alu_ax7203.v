...
`timescale 1ns / 1ps
// corona_compute_fp96_e8m87_alu_ax7203 — FP96_E8M87 ALU on AX7203.
module corona_compute_fp96_e8m87_alu_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r,op_r; reg [95:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [95:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
