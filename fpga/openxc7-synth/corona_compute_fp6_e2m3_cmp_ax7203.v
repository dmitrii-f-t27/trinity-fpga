...
`timescale 1ns / 1ps
// corona_compute_fp6_e2m3_cmp_ax7203 — FP6_E2M3 CMP on AX7203.
module corona_compute_fp6_e2m3_cmp_ax7203 (
    ...
    wire sa=a_reg[5]; wire [1:0] ea=a_reg[4:3]; wire [2:0] ma=a_reg[2:0];
    wire sb=b_reg[5]; wire [1:0] eb=b_reg[4:3]; wire [2:0] mb=b_reg[2:0];
