...
`timescale 1ns / 1ps
// corona_compute_fp3_e1m1_to_fp32_ax7203 — FP3_E1M1 TO_FP32 on AX7203.
module corona_compute_fp3_e1m1_to_fp32_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [2:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [2:0] a_reg; reg conv_trigger;
    wire [2:0] fmt_a = a_reg;
