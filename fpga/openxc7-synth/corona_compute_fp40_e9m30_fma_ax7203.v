...
module corona_compute_fp40_e9m30_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[39];
    wire [8:0] f_exp_a = fmt_a_a[38:30];
    ...
    wire f_sign_b = fmt_b_b[39];
    wire [8:0] f_exp_b = fmt_b_b[38:30];
    ...
    wire f_sign_c = fmt_c_c[39];
    wire [8:0] f_exp_c = fmt_c_c[38:30];
