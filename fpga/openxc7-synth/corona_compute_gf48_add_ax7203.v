...
`timescale 1ns / 1ps
// corona_compute_gf48_add_ax7203 — GoldenFloat48 ADD on AX7203.
// GF48: [S:1][E:18][M:29] = 48 bits, BIAS=131071, HAS_INF=1.
// 6 bytes per operand, 16-byte frame.
module corona_compute_gf48_add_ax7203 (
    ...
    // ---- Frame FSM ----
    reg [4:0] frm; reg [7:0] fmt_r; reg [47:0] a_r, b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    wire comp_in_ready, comp_out_valid; wire [47:0] comp_result;
    gf_adder_param #(.EXP_BITS(18), .MANT_BITS(29), .HAS_INF(1)) u_comp (
        .clk(mclk), .rst(rst),
