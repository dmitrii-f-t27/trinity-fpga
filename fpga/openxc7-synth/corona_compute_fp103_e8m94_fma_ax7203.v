...
module corona_compute_fp103_e8m94_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[102];
    wire [7:0] f_exp_a = fmt_a_a[101:94];
    ...
    wire f_sign_b = fmt_b_b[102];
    wire [7:0] f_exp_b = fmt_b_b[101:94];
    ...
    wire f_sign_c = fmt_c_c[102];
    wire [7:0] f_exp_c = fmt_c_c[101:94];
