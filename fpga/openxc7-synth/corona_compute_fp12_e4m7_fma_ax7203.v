...
module corona_compute_fp12_e4m7_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[11];
    wire [3:0] f_exp_a = fmt_a_a[10:7];
    wire [6:0] f_mant_a = fmt_a_a[6:0];
    ...
    wire f_sign_b = fmt_b_b[11];
    wire [3:0] f_exp_b = fmt_b_b[10:7];
    wire [6:0] f_mant_b = fmt_b_b[6:0];
    ...
    wire f_sign_c = fmt_c_c[11];
    wire [3:0] f_exp_c = fmt_c_c[10:7];
    wire [6:0] f_mant_c = fmt_c_c[6:0];
