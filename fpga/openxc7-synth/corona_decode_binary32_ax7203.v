...
`timescale 1ns / 1ps
// corona_decode_binary32_ax7203 — binary32 (FP32) decode on AX7203.
...
// opening the 32-bit-format decode column (binary32, int32, posit32, etc.).
module corona_decode_binary32_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero;
    binary32_decode u_dec (.binary32_in(code_r[31:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
