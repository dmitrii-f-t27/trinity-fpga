...
module corona_compute_gf16_div_ax7203 (
    ...
    always @(*) begin
        ...
        casez(f_mant_a)
                9'b1????????: begin nrm_e_a=8'd96; nrm_m_a=f_mant_a<<15; end
                9'b01???????: begin nrm_e_a=8'd95; nrm_m_a=f_mant_a<<16; end
                9'b001??????: begin nrm_e_a=8'd94; nrm_m_a=f_mant_a<<17; end
                9'b0001?????: begin nrm_e_a=8'd93; nrm_m_a=f_mant_a<<18; end
                9'b00001????: begin nrm_e_a=8'd92; nrm_m_a=f_mant_a<<19; end
                9'b000001???: begin nrm_e_a=8'd91; nrm_m_a=f_mant_a<<20; end
                9'b0000001??: begin nrm_e_a=8'd90; nrm_m_a=f_mant_a<<21; end
                9'b00000001?: begin nrm_e_a=8'd89; nrm_m_a=f_mant_a<<22; end
                9'b000000001: begin nrm_e_a=8'd88; nrm_m_a=f_mant_a<<23; end
    ...
    reg [7:0] nrm_e_b; reg [22:0] nrm_m_b;
    // subnormal normalisation: a priority encoder, because the
    // leading one moves with the mantissa and a fixed shift cannot
    // follow it (the defect recorded in pass 102).
    always @(*) begin
        nrm_e_b=8'd0; nrm_m_b=23'd0;
        casez(f_mant_b)
                9'b1????????: begin nrm_e_b=8'd96; nrm_m_b=f_mant_b<<15; end
                9'b01???????: begin nrm_e_b=8'd95; nrm_m_b=f_mant_b<<16; end
                9'b001??????: begin nrm_e_b=8'd94; nrm_m_b=f_mant_b<<17; end
                9'b0001?????: begin nrm_e_b=8'd93; nrm_m_b=f_mant_b<<18; end
                9'b00001????: begin nrm_e_b=8'd92; nrm_m_b=f_mant_b<<19; end
                9'b000001???: begin nrm_e_b=8'd91; nrm_m_b=f_mant_b<<20; end
                9'b0000001??: begin nrm_e_b=8'd90; nrm_m_b=f_mant_b<<21; end
                9'b00000001?: begin nrm_e_b=8'd89; nrm_m_b=f_mant_b<<22; end
                9'b000000001: begin nrm_e_b=8'd88; nrm_m_b=f_mant_b<<23; end
                default: begin nrm_e_b=8'd0; nrm_m_b=23'd0; end
        endcase
    end
    reg [31:0] fp32_b;
    always @(*) begin
        if(f_zero_b) fp32_b={f_sign_b, 31'b0};   // -0 keeps its sign
        else if(f_inf_b) fp32_b=f_sign_b?32'hFF800000:32'h7F800000;
        else if(f_nan_b) fp32_b=32'h7FC00000;
        else if(f_sub_b) fp32_b={f_sign_b, nrm_e_b, nrm_m_b};
    ...
    wire [9:0] sub_shift = ({1'b1, q_mant[22:14]}) >> (1 - tgt_exp_s);
    reg [15:0] q_result;
    always @(*) begin
        if(q_nan) q_result=16'h7E01;   // canonical qNaN
        ...
        else if(tgt_exp_s < 1) q_result={q_sign, 6'b0, sub_shift[8:0]};   // subnormal result: shift the implicit one back in
