...
`timescale 1ns / 1ps
// corona_compute_fp60_e9m50_add_ax7203 — FP60_E9M50 ADD on AX7203.
module corona_compute_fp60_e9m50_add_ax7203 (
    ...
    reg [4:0] frm; reg [7:0] fmt_r; reg [59:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [59:0] a_reg,b_reg; reg comp_trigger;
