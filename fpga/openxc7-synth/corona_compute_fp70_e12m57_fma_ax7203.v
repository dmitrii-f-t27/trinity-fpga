...
`timescale 1ns / 1ps
// corona_compute_fp70_e12m57_fma_ax7203 — FP70_E12M57 FMA on AX7203.
module corona_compute_fp70_e12m57_fma_ax7203 (
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -34'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[68:57];
    wire [56:0] f_mant_b = fmt_b[56:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -34'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[68:57];
    wire [56:0] f_mant_c = fmt_c[56:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -34'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 57'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 57'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 69'b0};
