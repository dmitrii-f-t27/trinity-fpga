...
`timescale 1ns / 1ps
// corona_compute_fp101_e5m95_fma_ax7203 — FP101_E5M95 FMA on AX7203.
module corona_compute_fp101_e5m95_fma_ax7203 (
    ...
    wire [4:0] f_exp_b = fmt_b[99:95];
    wire [94:0] f_mant_b = fmt_b[94:0];
    wire f_zero_b = (f_exp_b == 0) && ((f_mant_b == 0));
    wire f_inf_b = (f_exp_b == 31) && ((f_mant_b == 0));
    wire f_nan_b = (f_exp_b == 31) && ((f_mant_b != 0));
    wire f_sub_b = (f_exp_b == 0) && ((f_mant_b != 0));
    wire signed [14:0] f_de_b = $signed({1'b0, f_exp_b}) - 15'sd15 + 15'sd127;
    ...
    wire [4:0] f_exp_c = fmt_c[99:95];
    wire [94:0] f_mant_c = fmt_c[94:0];
    wire f_zero_c = (f_exp_c == 0) && ((f_mant_c == 0));
    wire f_inf_c = (f_exp_c == 31) && ((f_mant_c == 0));
    wire f_nan_c = (f_exp_c == 31) && ((f_mant_c != 0));
    wire f_sub_c = (f_exp_c == 0) && ((f_mant_c != 0));
    wire signed [14:0] f_de_c = $signed({1'b0, f_exp_c}) - 15'sd15 + 15'sd127;
    wire [7:0] f_exp32_c = (f_de_c > 15'sd254) ? 8'd254 : (f_de_c < 0) ? 8'd0 : f_de_c[7:0];
    ...
    always @(*) begin
        ...
        else if(f_sub_c) fp32_c={f_sign_c, 8'd113, f_mant32_norm_c};
    ...
    wire signed [14:0] tgt_exp_s = $signed({1'b0, q_exp}) - 15'sd127 + 15'sd15;
    reg [100:0] q_result;
    always @(*) begin
        if(q_nan) q_result=101'd0;
        else if(q_zero) q_result=101'd0;
        else if(q_inf) q_result={q_sign, 5'd31, 95'd0};
        else if(q_exp >= 8'd144) q_result={q_sign, 5'd31, 95'd0};
        else if(q_exp < 8'd113) q_result={q_sign, 100'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 5'b0, q_mant[22:0]};
        else q_result={q_sign, tgt_exp_s[4:0], q_mant[22:0]};
    end
