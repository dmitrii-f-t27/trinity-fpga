...
`timescale 1ns / 1ps
// corona_decode_cray_float_ax7203 — Cray float → FP32 decode on AX7203.
// cray_float_decode is authored in-repo. 8-byte code frame (64-bit input).
// Frame: AA 55 fmt b0 b1 b2 b3 b4 b5 b6 b7 trig -> A5 r0 r1 r2 r3.
module corona_decode_cray_float_ax7203 (
    ...
    cray_float_decode u_dec (.cray_in(code_r), .fp32_out(result), .is_zero(zero_flag));
    assign led[2] = |result;
