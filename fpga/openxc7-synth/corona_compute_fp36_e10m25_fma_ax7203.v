...
`timescale 1ns / 1ps
// corona_compute_fp36_e10m25_fma_ax7203 — FP36_E10M25 FMA on AX7203.
module corona_compute_fp36_e10m25_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 25'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 25'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 35'b0};
