...
`timescale 1ns / 1ps
// corona_compute_fp19_e8m10_fma_ax7203 — FP19_E8M10 FMA on AX7203.
module corona_compute_fp19_e8m10_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 10'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 10'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 18'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 8'b0, q_mant[22:13]};
        else q_result={q_sign, tgt_exp_s[7:0], q_mant[22:13]};
    end
