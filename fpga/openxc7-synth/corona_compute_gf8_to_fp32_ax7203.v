...
`timescale 1ns / 1ps
// corona_compute_gf8_to_fp32_ax7203 — GF8 to IEEE binary32 converter.
// Input: GF8 [S:1][E:3][M:4] (bias=3, HAS_INF=0)
...
module corona_compute_gf8_to_fp32_ax7203 (
    ...
    wire        gf_sign = a_reg[7];
    wire [2:0] gf_exp  = a_reg[6:4];
    wire [3:0] gf_mant = a_reg[3:0];
    ...
    wire [22:0] fp32_mant_norm = {gf_mant, 19'b0};
    ...
    always @(*) begin
        if (gf_zero)
            ...
            fp32_result = {gf_sign, 8'b0, {gf_mant, 19'b0}};
        else
