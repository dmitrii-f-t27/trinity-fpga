...
`timescale 1ns / 1ps
// corona_compute_fp8_e5m2_mul_ax7203 — FP8_E5M2 MUL on AX7203.
module corona_compute_fp8_e5m2_mul_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(5),.MANT_BITS(2),.HAS_INF(1)) u_comp (
