...
`timescale 1ns / 1ps
// corona_compute_bf16_cmp_ax7203 — BF16 CMP on AX7203.
module corona_compute_bf16_cmp_ax7203 (
    ...
    wire sa=a_reg[15]; wire [7:0] ea=a_reg[14:7]; wire [6:0] ma=a_reg[6:0];
    wire sb=b_reg[15]; wire [7:0] eb=b_reg[14:7]; wire [6:0] mb=b_reg[6:0];
