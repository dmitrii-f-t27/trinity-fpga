...
`timescale 1ns / 1ps
// corona_compute_fp17_e6m10_fma_ax7203 — FP17_E6M10 FMA on AX7203.
module corona_compute_fp17_e6m10_fma_ax7203 (
    ...
    wire [5:0] f_exp_a = fmt_a[15:10];
    wire [9:0] f_mant_a = fmt_a[9:0];
    ...
    wire [5:0] f_exp_b = fmt_b[15:10];
    wire [9:0] f_mant_b = fmt_b[9:0];
    ...
    wire [5:0] f_exp_c = fmt_c[15:10];
    wire [9:0] f_mant_c = fmt_c[9:0];
    ...
    wire [22:0] f_mant32_norm_c = {1'b0, f_mant_c, 12'b0};
    reg [31:0] fp32_c;
    always @(*) begin
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 6'd63, 10'd0};
        else if(q_exp >= 8'd160) q_result={q_sign, 6'd63, 10'd0};
        else if(q_exp < 8'd97) q_result={q_sign, 16'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 6'b0, q_mant[22:13]};
        else q_result={q_sign, tgt_exp_s[5:0], q_mant[22:13]};
    end
