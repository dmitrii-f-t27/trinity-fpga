...
`timescale 1ns / 1ps
// corona_compute_lns8_fma_ax7203 — LNS8 FMA on AX7203.
module corona_compute_lns8_fma_ax7203 (
    ...
    wire [7:0] lns_val_a = fmt_a;
    wire lns_sign_a = lns_val_a[7];
    wire [6:0] log_val_a = lns_val_a[6:0];
    wire lns_zero_a = (lns_val_a==8'h00);
    wire [2:0] int_part_a = log_val_a[6:4];
    wire [3:0] frac_part_a = log_val_a[3:0];
    reg [8:0] frac_lut_a;
    always @(*) begin
        case(frac_part_a)
            4'd0: frac_lut_a=9'd256; 4'd1: frac_lut_a=9'd267;
            4'd2: frac_lut_a=9'd279; 4'd3: frac_lut_a=9'd292;
            4'd4: frac_lut_a=9'd304; 4'd5: frac_lut_a=9'd318;
            4'd6: frac_lut_a=9'd332; 4'd7: frac_lut_a=9'd347;
            4'd8: frac_lut_a=9'd362; 4'd9: frac_lut_a=9'd378;
            4'd10: frac_lut_a=9'd395; 4'd11: frac_lut_a=9'd412;
            4'd12: frac_lut_a=9'd431; 4'd13: frac_lut_a=9'd450;
            4'd14: frac_lut_a=9'd470; default: frac_lut_a=9'd490;
        endcase
    end
    wire [7:0] lns_fp32_exp_a = {5'd0,int_part_a} + 8'd127;
    ...
    wire lns_sign_b = lns_val_b[7];
    wire [6:0] log_val_b = lns_val_b[6:0];
    wire lns_zero_b = (lns_val_b==8'h00);
    wire [2:0] int_part_b = log_val_b[6:4];
    wire [3:0] frac_part_b = log_val_b[3:0];
    reg [8:0] frac_lut_b;
    always @(*) begin
        case(frac_part_b)
            4'd0: frac_lut_b=9'd256; 4'd1: frac_lut_b=9'd267;
            4'd2: frac_lut_b=9'd279; 4'd3: frac_lut_b=9'd292;
            4'd4: frac_lut_b=9'd304; 4'd5: frac_lut_b=9'd318;
            4'd6: frac_lut_b=9'd332; 4'd7: frac_lut_b=9'd347;
            4'd8: frac_lut_b=9'd362; 4'd9: frac_lut_b=9'd378;
            4'd10: frac_lut_b=9'd395; 4'd11: frac_lut_b=9'd412;
            4'd12: frac_lut_b=9'd431; 4'd13: frac_lut_b=9'd450;
            4'd14: frac_lut_b=9'd470; default: frac_lut_b=9'd490;
        endcase
    end
    wire [7:0] lns_fp32_exp_b = {5'd0,int_part_b} + 8'd127;
    ...
    wire [7:0] lns_val_c = fmt_c;
    wire lns_sign_c = lns_val_c[7];
    wire [6:0] log_val_c = lns_val_c[6:0];
    wire lns_zero_c = (lns_val_c==8'h00);
    wire [2:0] int_part_c = log_val_c[6:4];
    wire [3:0] frac_part_c = log_val_c[3:0];
    reg [8:0] frac_lut_c;
    always @(*) begin
        case(frac_part_c)
            4'd0: frac_lut_c=9'd256; 4'd1: frac_lut_c=9'd267;
            4'd2: frac_lut_c=9'd279; 4'd3: frac_lut_c=9'd292;
            4'd4: frac_lut_c=9'd304; 4'd5: frac_lut_c=9'd318;
            4'd6: frac_lut_c=9'd332; 4'd7: frac_lut_c=9'd347;
            4'd8: frac_lut_c=9'd362; 4'd9: frac_lut_c=9'd378;
            4'd10: frac_lut_c=9'd395; 4'd11: frac_lut_c=9'd412;
            4'd12: frac_lut_c=9'd431; 4'd13: frac_lut_c=9'd450;
            4'd14: frac_lut_c=9'd470; default: frac_lut_c=9'd490;
        endcase
    end
    wire [7:0] lns_fp32_exp_c = {5'd0,int_part_c} + 8'd127;
    wire [22:0] lns_fp32_mant_c = (frac_lut_c - 9'd256) << 14;
    reg [31:0] fp32_c;
    always @(*) begin
        if(lns_zero_c) fp32_c={lns_sign_c, 31'b0};
        else fp32_c={lns_sign_c,lns_fp32_exp_c,lns_fp32_mant_c[22:0]};
    end
    ...
    wire [3:0] q_log_int = q_exp[7:4] - 4'd7;  // exp-127 → log int part (0-7)
    // Fractional: find nearest frac_lut entry for mantissa
    // Simplified: use top 4 bits of mantissa as frac_part
    wire [3:0] q_log_frac = q_mant[22:19];
    reg [7:0] q_result;
    always @(*) begin
        if(q_nan) q_result=8'h00;
        else if(q_zero) q_result=8'h00;
        else q_result={q_sign,{q_exp[6:4],q_mant[22:19]}};
    end
