...
`timescale 1ns / 1ps
// corona_compute_fp98_e11m86_fma_ax7203 — FP98_E11M86 FMA on AX7203.
module corona_compute_fp98_e11m86_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 86'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 86'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 97'b0};
