...
`timescale 1ns / 1ps
// corona_compute_fp90_e13m76_mul_ax7203 — FP90_E13M76 MUL on AX7203.
module corona_compute_fp90_e13m76_mul_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a_a[88:76];
    ...
    wire [12:0] f_exp_b = fmt_b_b[88:76];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 76'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 76'd0};
