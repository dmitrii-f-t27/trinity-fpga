...
`timescale 1ns / 1ps
// corona_compute_fp92_e8m83_fma_ax7203 — FP92_E8M83 FMA on AX7203.
module corona_compute_fp92_e8m83_fma_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [91:0] a_r,b_r,c_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;c_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                6'd14: begin a_r[91:88]<=rx_byte;frm<=6'd15; end
                ...
                6'd26: begin b_r[91:88]<=rx_byte;frm<=6'd27; end
                ...
                6'd38: begin c_r[91:88]<=rx_byte;frm<=6'd39; end
    ...
    reg [91:0] a_reg,b_reg,c_reg; reg comp_trigger;
    wire [91:0] fmt_a=a_reg, fmt_b=b_reg, fmt_c=c_reg;
    ...
    wire f_sign_c = fmt_c[91];
    wire [7:0] f_exp_c = fmt_c[90:83];
    wire [82:0] f_mant_c = fmt_c[82:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -60'b0};
