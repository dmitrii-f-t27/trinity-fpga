...
`timescale 1ns / 1ps
// corona_compute_fp31_e8m22_to_fp32_ax7203 — FP31_E8M22 TO_FP32 on AX7203.
module corona_compute_fp31_e8m22_to_fp32_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [30:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                3'd6: begin a_r[30:24]<=rx_byte;frm<=3'd7; end
    ...
    reg [30:0] a_reg; reg conv_trigger;
    wire [30:0] fmt_a = a_reg;
