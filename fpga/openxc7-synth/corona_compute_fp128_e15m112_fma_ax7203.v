...
`timescale 1ns / 1ps
// corona_compute_fp128_e15m112_fma_ax7203 — FP128_E15M112 FMA on AX7203.
module corona_compute_fp128_e15m112_fma_ax7203 (
    ...
    wire [14:0] f_exp_b = fmt_b[126:112];
    ...
    wire [14:0] f_exp_c = fmt_c[126:112];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 15'd32767, 112'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 15'd32767, 112'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 127'b0};
