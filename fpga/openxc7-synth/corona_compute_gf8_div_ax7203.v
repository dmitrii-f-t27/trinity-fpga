...
module corona_compute_gf8_div_ax7203 (
    ...
    always @(*) begin
        ...
        casez(f_mant_b)
                4'b1???: begin nrm_e_b=8'd124; nrm_m_b=f_mant_b<<20; end
                4'b01??: begin nrm_e_b=8'd123; nrm_m_b=f_mant_b<<21; end
                4'b001?: begin nrm_e_b=8'd122; nrm_m_b=f_mant_b<<22; end
                4'b0001: begin nrm_e_b=8'd121; nrm_m_b=f_mant_b<<23; end
