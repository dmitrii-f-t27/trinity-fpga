...
`timescale 1ns / 1ps
// corona_compute_gf128_add_ax7203 — GoldenFloat128 ADD on AX7203.
// GF128: [S:1][E:49][M:78] = 128 bits, BIAS=281474976710655, HAS_INF=1.
// 16 bytes per operand, 36-byte frame.
module corona_compute_gf128_add_ax7203 (
    ...
    gf_adder_param #(.EXP_BITS(49), .MANT_BITS(78), .HAS_INF(1)) u_comp (
        .clk(mclk), .rst(rst),
