...
`timescale 1ns / 1ps
// corona_compute_q_format_fma_ax7203 — Q_FORMAT FMA on AX7203.
module corona_compute_q_format_fma_ax7203 (
    ...
    wire [15:0] qf_val_c = fmt_c;
    wire signed [15:0] qf_sint_c = qf_val_c;
    wire qf_neg_c = qf_sint_c[15];
    wire [14:0] qf_abs_c = qf_neg_c ? -qf_sint_c[14:0] : qf_sint_c[14:0];
    wire qf_zero_c = (qf_val_c==16'h0000);
    reg [3:0] qf_lop_c;
    always @(*) begin
        casez(qf_abs_c)
            15'b1??????????????: qf_lop_c=4'd14;
            15'b01?????????????: qf_lop_c=4'd13;
            15'b001????????????: qf_lop_c=4'd12;
            15'b0001???????????: qf_lop_c=4'd11;
            15'b00001??????????: qf_lop_c=4'd10;
            15'b000001?????????: qf_lop_c=4'd9;
            15'b0000001????????: qf_lop_c=4'd8;
            15'b00000001???????: qf_lop_c=4'd7;
            15'b000000001??????: qf_lop_c=4'd6;
            15'b0000000001?????: qf_lop_c=4'd5;
            15'b00000000001????: qf_lop_c=4'd4;
            15'b000000000001???: qf_lop_c=4'd3;
            15'b0000000000001??: qf_lop_c=4'd2;
            15'b00000000000001?: qf_lop_c=4'd1;
            default: qf_lop_c=4'd0;
        endcase
    end
    // FP32 exp = 127 + (lop - 15) = 112 + lop
    wire [7:0] qf_exp_c = 8'd112 + {4'b0,qf_lop_c};
    reg [22:0] qf_mant_c;
    always @(*) begin
        case(qf_lop_c)
            4'd14: qf_mant_c={qf_abs_c[13:0],9'b0};
            4'd13: qf_mant_c={qf_abs_c[12:0],10'b0};
            4'd12: qf_mant_c={qf_abs_c[11:0],11'b0};
            4'd11: qf_mant_c={qf_abs_c[10:0],12'b0};
            4'd10: qf_mant_c={qf_abs_c[9:0],13'b0};
            4'd9: qf_mant_c={qf_abs_c[8:0],14'b0};
            4'd8: qf_mant_c={qf_abs_c[7:0],15'b0};
            4'd7: qf_mant_c={qf_abs_c[6:0],16'b0};
            4'd6: qf_mant_c={qf_abs_c[5:0],17'b0};
            4'd5: qf_mant_c={qf_abs_c[4:0],18'b0};
            4'd4: qf_mant_c={qf_abs_c[3:0],19'b0};
            4'd3: qf_mant_c={qf_abs_c[2:0],20'b0};
            4'd2: qf_mant_c={qf_abs_c[1:0],21'b0};
            4'd1: qf_mant_c={qf_abs_c[0],22'b0};
            default: qf_mant_c=23'b0;
        endcase
    end
    reg [31:0] fp32_c;
    always @(*) begin
        if(qf_zero_c) fp32_c=32'h00000000;
        else fp32_c={qf_neg_c,qf_exp_c,qf_mant_c};
    end
