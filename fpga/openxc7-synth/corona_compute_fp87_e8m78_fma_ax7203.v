...
module corona_compute_fp87_e8m78_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[86];
    wire [7:0] f_exp_a = fmt_a[85:78];
    ...
    wire f_sign_b = fmt_b[86];
    wire [7:0] f_exp_b = fmt_b[85:78];
    ...
    wire f_sign_c = fmt_c[86];
    wire [7:0] f_exp_c = fmt_c[85:78];
