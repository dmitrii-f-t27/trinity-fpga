...
`timescale 1ns / 1ps
// corona_compute_fp32_e8m23_fma_ax7203 — FP32_E8M23 FMA on AX7203.
module corona_compute_fp32_e8m23_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[31];
    wire [7:0] f_exp_a = fmt_a[30:23];
    ...
    wire f_sign_b = fmt_b[31];
    wire [7:0] f_exp_b = fmt_b[30:23];
    ...
    wire f_sign_c = fmt_c[31];
    wire [7:0] f_exp_c = fmt_c[30:23];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 8'd255, 23'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 23'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 31'b0};
