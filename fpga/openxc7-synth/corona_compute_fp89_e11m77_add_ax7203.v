...
`timescale 1ns / 1ps
// corona_compute_fp89_e11m77_add_ax7203 — FP89_E11M77 ADD on AX7203.
module corona_compute_fp89_e11m77_add_ax7203 (
    ...
    wire [10:0] f_exp_a = fmt_a_a[87:77];
    ...
    wire [10:0] f_exp_b = fmt_b_b[87:77];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 77'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 77'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 88'b0};
