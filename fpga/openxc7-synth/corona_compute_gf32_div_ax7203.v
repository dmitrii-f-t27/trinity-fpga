...
`timescale 1ns / 1ps
// corona_compute_gf32_div_ax7203 — GF32 DIV on AX7203.
module corona_compute_gf32_div_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 7'd127, 24'd0};
        else if(q_exp >= 8'd192) q_result={q_sign, 7'd127, 24'd0};
        else if(q_exp < 8'd65) q_result={q_sign, 31'b0};
