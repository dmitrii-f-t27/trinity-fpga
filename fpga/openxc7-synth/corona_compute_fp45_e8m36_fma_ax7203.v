...
module corona_compute_fp45_e8m36_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[44];
    wire [7:0] f_exp_a = fmt_a_a[43:36];
    wire [35:0] f_mant_a = fmt_a_a[35:0];
    ...
    wire f_sign_b = fmt_b_b[44];
    wire [7:0] f_exp_b = fmt_b_b[43:36];
    wire [35:0] f_mant_b = fmt_b_b[35:0];
    ...
    wire f_sign_c = fmt_c_c[44];
    wire [7:0] f_exp_c = fmt_c_c[43:36];
    wire [35:0] f_mant_c = fmt_c_c[35:0];
