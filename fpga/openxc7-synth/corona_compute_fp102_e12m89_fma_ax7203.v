...
`timescale 1ns / 1ps
// corona_compute_fp102_e12m89_fma_ax7203 — FP102_E12M89 FMA on AX7203.
module corona_compute_fp102_e12m89_fma_ax7203 (
    ...
    wire [11:0] f_exp_a = fmt_a[100:89];
    ...
    wire [11:0] f_exp_b = fmt_b[100:89];
    ...
    wire [11:0] f_exp_c = fmt_c[100:89];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 89'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 89'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 101'b0};
