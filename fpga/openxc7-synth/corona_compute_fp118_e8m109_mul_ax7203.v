...
`timescale 1ns / 1ps
// corona_compute_fp118_e8m109_mul_ax7203 — FP118_E8M109 MUL on AX7203.
module corona_compute_fp118_e8m109_mul_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [117:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [117:0] a_reg,b_reg; reg comp_trigger;
    wire [117:0] fmt_a=a_reg, fmt_b=b_reg;
