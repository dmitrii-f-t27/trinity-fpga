...
`timescale 1ns / 1ps
// corona_compute_cray_float_alu_ax7203 — CRAY ALU on AX7203.
module corona_compute_cray_float_alu_ax7203 (
    ...
    reg [31:0] fp32_a;
    always @(*) begin
        if(cr_zero_a) fp32_a=32'h00000000;
    ...
    reg [31:0] fp32_b;
    always @(*) begin
        if(cr_zero_b) fp32_b=32'h00000000;
