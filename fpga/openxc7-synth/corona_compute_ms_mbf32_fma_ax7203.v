...
`timescale 1ns / 1ps
// corona_compute_ms_mbf32_fma_ax7203 — MS_MBF32 FMA on AX7203.
module corona_compute_ms_mbf32_fma_ax7203 (
    ...
    wire [31:0] mbf_val_a = fmt_a;
    wire mbf_sign_a = mbf_val_a[31];
    wire [7:0] mbf_exp_a = mbf_val_a[30:23];
    wire [22:0] mbf_mant_a = mbf_val_a[22:0];
    ...
    wire [31:0] mbf_val_b = fmt_b;
    wire mbf_sign_b = mbf_val_b[31];
    wire [7:0] mbf_exp_b = mbf_val_b[30:23];
    wire [22:0] mbf_mant_b = mbf_val_b[22:0];
    ...
    wire [31:0] mbf_val_c = fmt_c;
    wire mbf_sign_c = mbf_val_c[31];
    wire [7:0] mbf_exp_c = mbf_val_c[30:23];
    wire [22:0] mbf_mant_c = mbf_val_c[22:0];
    wire mbf_zero_c = (mbf_val_c==32'h0);
    reg [31:0] fp32_c;
    always @(*) begin
        if(mbf_zero_c) fp32_c={mbf_sign_c, 31'b0};
        else if(mbf_exp_c<=8'd2) fp32_c={mbf_sign_c,31'b0};
        else fp32_c={mbf_sign_c,mbf_exp_c-8'd2,mbf_mant_c};
    end
