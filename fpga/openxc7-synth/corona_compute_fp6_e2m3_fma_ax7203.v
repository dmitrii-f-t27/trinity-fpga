...
`timescale 1ns / 1ps
// corona_compute_fp6_e2m3_fma_ax7203 — FP6_E2M3 FMA on AX7203.
module corona_compute_fp6_e2m3_fma_ax7203 (
    ...
    wire mul_irdy,mul_ovld; wire [5:0] mul_result;
    wire add_irdy,add_ovld; wire [5:0] add_result;
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(add_ovld) result_reg<={{26{1'b0}},add_result};
        end
    end
