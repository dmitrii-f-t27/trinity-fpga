...
module corona_compute_fp117_e8m108_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[116];
    wire [7:0] f_exp_a = fmt_a_a[115:108];
    wire [107:0] f_mant_a = fmt_a_a[107:0];
    ...
    wire f_sign_b = fmt_b_b[116];
    wire [7:0] f_exp_b = fmt_b_b[115:108];
    wire [107:0] f_mant_b = fmt_b_b[107:0];
    ...
    wire f_sign_c = fmt_c_c[116];
    wire [7:0] f_exp_c = fmt_c_c[115:108];
    wire [107:0] f_mant_c = fmt_c_c[107:0];
