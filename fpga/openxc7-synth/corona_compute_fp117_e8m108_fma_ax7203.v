...
`timescale 1ns / 1ps
// corona_compute_fp117_e8m108_fma_ax7203 — FP117_E8M108 FMA on AX7203.
module corona_compute_fp117_e8m108_fma_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [116:0] a_r,b_r,c_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;a_r<=0;b_r<=0;c_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                6'd17: begin a_r[116:112]<=rx_byte;frm<=6'd18; end
                6'd18: begin b_r[7:0]<=rx_byte;frm<=6'd19; end
                6'd19: begin b_r[15:8]<=rx_byte;frm<=6'd20; end
                6'd20: begin b_r[23:16]<=rx_byte;frm<=6'd21; end
                6'd21: begin b_r[31:24]<=rx_byte;frm<=6'd22; end
                6'd22: begin b_r[39:32]<=rx_byte;frm<=6'd23; end
                6'd23: begin b_r[47:40]<=rx_byte;frm<=6'd24; end
                6'd24: begin b_r[55:48]<=rx_byte;frm<=6'd25; end
                6'd25: begin b_r[63:56]<=rx_byte;frm<=6'd26; end
                6'd26: begin b_r[71:64]<=rx_byte;frm<=6'd27; end
                6'd27: begin b_r[79:72]<=rx_byte;frm<=6'd28; end
                6'd28: begin b_r[87:80]<=rx_byte;frm<=6'd29; end
                6'd29: begin b_r[95:88]<=rx_byte;frm<=6'd30; end
                6'd30: begin b_r[103:96]<=rx_byte;frm<=6'd31; end
                6'd31: begin b_r[111:104]<=rx_byte;frm<=6'd32; end
                6'd32: begin b_r[116:112]<=rx_byte;frm<=6'd33; end
                6'd33: begin c_r[7:0]<=rx_byte;frm<=6'd34; end
                6'd34: begin c_r[15:8]<=rx_byte;frm<=6'd35; end
                6'd35: begin c_r[23:16]<=rx_byte;frm<=6'd36; end
                6'd36: begin c_r[31:24]<=rx_byte;frm<=6'd37; end
                6'd37: begin c_r[39:32]<=rx_byte;frm<=6'd38; end
                6'd38: begin c_r[47:40]<=rx_byte;frm<=6'd39; end
                6'd39: begin c_r[55:48]<=rx_byte;frm<=6'd40; end
                6'd40: begin c_r[63:56]<=rx_byte;frm<=6'd41; end
                6'd41: begin c_r[71:64]<=rx_byte;frm<=6'd42; end
                6'd42: begin c_r[79:72]<=rx_byte;frm<=6'd43; end
                6'd43: begin c_r[87:80]<=rx_byte;frm<=6'd44; end
                6'd44: begin c_r[95:88]<=rx_byte;frm<=6'd45; end
                6'd45: begin c_r[103:96]<=rx_byte;frm<=6'd46; end
                6'd46: begin c_r[111:104]<=rx_byte;frm<=6'd47; end
                6'd47: begin c_r[116:112]<=rx_byte;frm<=6'd48; end
                6'd48: begin frame_valid<=1;frm<=0; end
            endcase end
        end
    end
    assign led[1]=frame_valid;

    reg [116:0] a_reg,b_reg,c_reg; reg comp_trigger;
    wire [116:0] fmt_a=a_reg, fmt_b=b_reg, fmt_c=c_reg;
    wire f_sign_a = fmt_a[116];
    wire [7:0] f_exp_a = fmt_a[115:108];
    wire [107:0] f_mant_a = fmt_a[107:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -85'b0};
    ...
    wire f_sign_b = fmt_b[116];
    wire [7:0] f_exp_b = fmt_b[115:108];
    wire [107:0] f_mant_b = fmt_b[107:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -85'b0};
    ...
    wire f_sign_c = fmt_c[116];
    wire [7:0] f_exp_c = fmt_c[115:108];
    wire [107:0] f_mant_c = fmt_c[107:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -85'b0};
    ...
    reg [116:0] q_result;
    always @(*) begin
        if(q_nan) q_result=117'd0;
        else if(q_zero) q_result=117'd0;
        else if(q_inf) q_result={q_sign, 8'd255, 108'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 108'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 116'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 8'b0, q_mant[22:0]};
        else q_result={q_sign, tgt_exp_s[7:0], q_mant[22:0]};
    end
    reg [116:0] result_reg; reg result_ready;
    always @(posedge mclk or posedge rst) begin
