...
`timescale 1ns / 1ps
// corona_compute_fp31_e11m19_fma_ax7203 — FP31_E11M19 FMA on AX7203.
module corona_compute_fp31_e11m19_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 19'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 19'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 30'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 11'b0, q_mant[22:4]};
        else q_result={q_sign, tgt_exp_s[10:0], q_mant[22:4]};
    end
