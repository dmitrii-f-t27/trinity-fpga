...
`timescale 1ns / 1ps
// corona_decode_q4_ax7203 — Q4 fixed-point decode on AX7203.
// Frame: AA 55 fmt code_lo code_hi trig -> A5 r0 r1 r2 r3 (32-bit FP32 LE).
module corona_decode_q4_ax7203 (
    ...
    wire [31:0] result;
    wire is_zero;
    q4_decode u_dec (.q4_in(code_r[3:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
