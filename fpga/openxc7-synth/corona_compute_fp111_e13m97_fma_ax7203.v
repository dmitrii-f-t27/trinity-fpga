...
`timescale 1ns / 1ps
// corona_compute_fp111_e13m97_fma_ax7203 — FP111_E13M97 FMA on AX7203.
module corona_compute_fp111_e13m97_fma_ax7203 (
    ...
    wire [12:0] f_exp_a = fmt_a[109:97];
    ...
    wire [12:0] f_exp_b = fmt_b[109:97];
    ...
    wire [12:0] f_exp_c = fmt_c[109:97];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 13'd8191, 97'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 13'd8191, 97'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 110'b0};
