...
module corona_compute_fp73_e8m64_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[72];
    wire [7:0] f_exp_a = fmt_a[71:64];
    wire [63:0] f_mant_a = fmt_a[63:0];
    ...
    wire f_sign_b = fmt_b[72];
    wire [7:0] f_exp_b = fmt_b[71:64];
    wire [63:0] f_mant_b = fmt_b[63:0];
    ...
    wire f_sign_c = fmt_c[72];
    wire [7:0] f_exp_c = fmt_c[71:64];
    wire [63:0] f_mant_c = fmt_c[63:0];
