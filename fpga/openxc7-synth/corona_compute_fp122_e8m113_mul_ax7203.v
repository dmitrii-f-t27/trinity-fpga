...
`timescale 1ns / 1ps
// corona_compute_fp122_e8m113_mul_ax7203 — FP122_E8M113 MUL on AX7203.
module corona_compute_fp122_e8m113_mul_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r; reg [121:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [121:0] a_reg,b_reg; reg comp_trigger;
