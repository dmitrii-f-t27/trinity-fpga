...
`timescale 1ns / 1ps
// corona_compute_ms_mbf64_fma_ax7203 — MS_MBF64 FMA on AX7203.
module corona_compute_ms_mbf64_fma_ax7203 (
    ...
    wire mb_sign_a = fmt_a[63];
    wire [7:0] mb_exp_a = fmt_a[62:55];
    wire [54:0] mb_mant_a = fmt_a[54:0];
    wire mb_zero_a = (mb_exp_a == 8'd0);
    wire [7:0] mb_exp32_a = mb_exp_a - 8'd2;
    ...
    wire [7:0] mb_exp_b = fmt_b[62:55];
    wire [54:0] mb_mant_b = fmt_b[54:0];
    wire mb_zero_b = (mb_exp_b == 8'd0);
    wire [7:0] mb_exp32_b = mb_exp_b - 8'd2;
    ...
    wire mb_sign_c = fmt_c[63];
    wire [7:0] mb_exp_c = fmt_c[62:55];
    wire [54:0] mb_mant_c = fmt_c[54:0];
    wire mb_zero_c = (mb_exp_c == 8'd0);
    wire [7:0] mb_exp32_c = mb_exp_c - 8'd2;
    wire [22:0] mb_mant32_c = mb_mant_c[54:32];
    reg [31:0] fp32_c;
    always @(*) begin
        if(mb_zero_c) fp32_c={mb_sign_c, 31'b0};
        else fp32_c={mb_sign_c, mb_exp32_c, mb_mant32_c};
    end
    ...
    always @(*) begin
        ...
        else q_result={q_sign, q_exp + 8'd2, q_mant, 32'b0};
    end
