...
module corona_compute_fp79_e8m70_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a[78];
    wire [7:0] f_exp_a = fmt_a[77:70];
    ...
    wire f_sign_b = fmt_b[78];
    wire [7:0] f_exp_b = fmt_b[77:70];
    ...
    wire f_sign_c = fmt_c[78];
    wire [7:0] f_exp_c = fmt_c[77:70];
