...
`timescale 1ns / 1ps
// corona_compute_fp47_e10m36_fma_ax7203 — FP47_E10M36 FMA on AX7203.
module corona_compute_fp47_e10m36_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 10'd1023, 36'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 10'd1023, 36'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 46'b0};
