...
module corona_compute_fp13_e6m6_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[12];
    wire [5:0] f_exp_a = fmt_a_a[11:6];
    wire [5:0] f_mant_a = fmt_a_a[5:0];
    ...
    wire f_sign_b = fmt_b_b[12];
    wire [5:0] f_exp_b = fmt_b_b[11:6];
    wire [5:0] f_mant_b = fmt_b_b[5:0];
    ...
    wire f_sign_c = fmt_c_c[12];
    wire [5:0] f_exp_c = fmt_c_c[11:6];
    wire [5:0] f_mant_c = fmt_c_c[5:0];
