...
module corona_compute_fp33_e8m24_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[32];
    wire [7:0] f_exp_a = fmt_a_a[31:24];
    ...
    wire f_sign_b = fmt_b_b[32];
    wire [7:0] f_exp_b = fmt_b_b[31:24];
    ...
    wire f_sign_c = fmt_c_c[32];
    wire [7:0] f_exp_c = fmt_c_c[31:24];
    wire [23:0] f_mant_c = fmt_c_c[23:0];
