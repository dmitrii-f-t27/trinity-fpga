...
`timescale 1ns / 1ps
// corona_compute_fp13_e6m6_to_fp32_ax7203 — FP13_E6M6 TO_FP32 on AX7203.
module corona_compute_fp13_e6m6_to_fp32_ax7203 (
    ...
    reg [2:0] frm; reg [7:0] fmt_r; reg [12:0] a_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    reg [12:0] a_reg; reg conv_trigger;
    wire [12:0] fmt_a = a_reg;
