...
`timescale 1ns / 1ps
// corona_compute_fp10_e5m4_fma_ax7203 — FP10_E5M4 FMA on AX7203.
module corona_compute_fp10_e5m4_fma_ax7203 (
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 5'd31, 4'd0};
        else if(q_exp >= 8'd128) q_result={q_sign, 5'd31, 4'd0};
        else if(q_exp < 8'd97) q_result={q_sign, 9'b0};
        else if(tgt_exp_s < 1) q_result={q_sign, 5'b0, q_mant[22:19]};
        else q_result={q_sign, tgt_exp_s[4:0], q_mant[22:19]};
    end
