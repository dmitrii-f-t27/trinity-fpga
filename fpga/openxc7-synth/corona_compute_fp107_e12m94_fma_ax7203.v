...
`timescale 1ns / 1ps
// corona_compute_fp107_e12m94_fma_ax7203 — FP107_E12M94 FMA on AX7203.
module corona_compute_fp107_e12m94_fma_ax7203 (
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -71'b0};
    ...
    wire [11:0] f_exp_b = fmt_b[105:94];
    wire [93:0] f_mant_b = fmt_b[93:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -71'b0};
    ...
    wire [11:0] f_exp_c = fmt_c[105:94];
    wire [93:0] f_mant_c = fmt_c[93:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -71'b0};
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 12'd4095, 94'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 12'd4095, 94'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 106'b0};
