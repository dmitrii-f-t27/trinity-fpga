...
`timescale 1ns / 1ps
// corona_compute_fp107_e8m98_alu_ax7203 — FP107_E8M98 ALU on AX7203.
module corona_compute_fp107_e8m98_alu_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r,op_r; reg [106:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                6'd17: begin a_r[106:104]<=rx_byte;frm<=6'd18; end
                ...
                6'd31: begin b_r[106:104]<=rx_byte;frm<=6'd32; end
    ...
    reg [106:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [106:0] fmt_a=a_reg, fmt_b=b_reg;
