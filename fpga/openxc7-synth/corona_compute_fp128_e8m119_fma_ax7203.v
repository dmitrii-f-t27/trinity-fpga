...
`timescale 1ns / 1ps
// corona_compute_fp128_e8m119_fma_ax7203 — FP128_E8M119 FMA on AX7203.
module corona_compute_fp128_e8m119_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a[126:119];
    wire [118:0] f_mant_a = fmt_a[118:0];
    ...
    wire [22:0] f_mant32_a = {f_mant_a, -96'b0};
    ...
    wire f_sign_b = fmt_b[127];
    wire [7:0] f_exp_b = fmt_b[126:119];
    wire [118:0] f_mant_b = fmt_b[118:0];
    ...
    wire [22:0] f_mant32_b = {f_mant_b, -96'b0};
    ...
    wire f_sign_c = fmt_c[127];
    wire [7:0] f_exp_c = fmt_c[126:119];
    wire [118:0] f_mant_c = fmt_c[118:0];
    ...
    wire [22:0] f_mant32_c = {f_mant_c, -96'b0};
    ...
    reg [127:0] q_result;
    always @(*) begin
        if(q_nan) q_result=128'd0;
        else if(q_zero) q_result=128'd0;
        else if(q_inf) q_result={q_sign, 8'd255, 119'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 8'd255, 119'd0};
        else if(q_exp < 8'd1) q_result={q_sign, 127'b0};
