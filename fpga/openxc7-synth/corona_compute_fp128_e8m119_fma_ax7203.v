...
module corona_compute_fp128_e8m119_fma_ax7203 (
    ...
    wire [7:0] f_exp_a = fmt_a_a[126:119];
    wire [118:0] f_mant_a = fmt_a_a[118:0];
    ...
    wire f_sign_b = fmt_b_b[127];
    wire [7:0] f_exp_b = fmt_b_b[126:119];
    wire [118:0] f_mant_b = fmt_b_b[118:0];
    ...
    wire f_sign_c = fmt_c_c[127];
    wire [7:0] f_exp_c = fmt_c_c[126:119];
    wire [118:0] f_mant_c = fmt_c_c[118:0];
