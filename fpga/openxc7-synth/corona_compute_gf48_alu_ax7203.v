...
`timescale 1ns / 1ps
// corona_compute_gf48_alu_ax7203 — GoldenFloat48 ALU (ADD+MUL) on AX7203.
// GF48: [S:1][E:18][M:29] = 48 bits, HAS_INF=1.
// op: 0x00=ADD, 0x01=MUL
module corona_compute_gf48_alu_ax7203 (
    ...
    // ---- Frame FSM ----
    reg [4:0] frm; reg [7:0] fmt_r; reg [7:0] op_r; reg [47:0] a_r, b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
    ...
    wire [47:0] add_result, mul_result;
    ...
    wire [47:0] comp_result = is_mul ? mul_result : add_result;
