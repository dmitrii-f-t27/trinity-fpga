...
module corona_compute_fp122_e8m113_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[121];
    wire [7:0] f_exp_a = fmt_a_a[120:113];
    wire [112:0] f_mant_a = fmt_a_a[112:0];
    ...
    wire f_sign_b = fmt_b_b[121];
    wire [7:0] f_exp_b = fmt_b_b[120:113];
    wire [112:0] f_mant_b = fmt_b_b[112:0];
    ...
    wire f_sign_c = fmt_c_c[121];
    wire [7:0] f_exp_c = fmt_c_c[120:113];
    wire [112:0] f_mant_c = fmt_c_c[112:0];
