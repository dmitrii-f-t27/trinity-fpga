...
module corona_compute_fp28_e8m19_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[27];
    wire [7:0] f_exp_a = fmt_a_a[26:19];
    ...
    wire f_sign_b = fmt_b_b[27];
    wire [7:0] f_exp_b = fmt_b_b[26:19];
    ...
    wire f_sign_c = fmt_c_c[27];
    wire [7:0] f_exp_c = fmt_c_c[26:19];
    wire [18:0] f_mant_c = fmt_c_c[18:0];
