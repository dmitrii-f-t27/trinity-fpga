...
`timescale 1ns / 1ps
// corona_compute_fp122_e8m113_alu_ax7203 — FP122_E8M113 ALU on AX7203.
module corona_compute_fp122_e8m113_alu_ax7203 (
    ...
    reg [5:0] frm; reg [7:0] fmt_r,op_r; reg [121:0] a_r,b_r; reg frame_valid;
    always @(posedge mclk or posedge rst) begin
        if(rst) begin frm<=0;fmt_r<=0;op_r<=0;a_r<=0;b_r<=0;frame_valid<=0; end
            ...
            if(rx_new) begin case(frm)
                ...
                6'd19: begin a_r[121:120]<=rx_byte;frm<=6'd20; end
                ...
                6'd35: begin b_r[121:120]<=rx_byte;frm<=6'd36; end
    ...
    reg [121:0] a_reg,b_reg; reg [7:0] op_reg; reg comp_trigger;
    wire [121:0] fmt_a=a_reg, fmt_b=b_reg;
