...
`timescale 1ns / 1ps
// corona_compute_fp92_e11m80_mul_ax7203 — FP92_E11M80 MUL on AX7203.
module corona_compute_fp92_e11m80_mul_ax7203 (
    ...
    wire [10:0] f_exp_a = fmt_a_a[90:80];
    ...
    wire [10:0] f_exp_b = fmt_b_b[90:80];
    ...
    always @(*) begin
        ...
        else if(q_inf) q_result={q_sign, 11'd2047, 80'd0};
        else if(q_exp >= 8'd254) q_result={q_sign, 11'd2047, 80'd0};
        else if(q_exp < 8'd0) q_result={q_sign, 91'b0};
