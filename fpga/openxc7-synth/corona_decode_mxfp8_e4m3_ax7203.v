...
`timescale 1ns / 1ps
// corona_decode_mxfp8_e4m3_ax7203 — OCP MX FP8 E4M3 decode on AX7203.
...
// (mxfp8_e4m3_decode: 1S+4E+3M -> FP32, subnormal normalize, NaN=S.1111.111).
module corona_decode_mxfp8_e4m3_ax7203 (
    ...
    wire [31:0] result;
    wire        is_zero, is_nan;
    mxfp8_e4m3_decode u_dec (.e4m3_in(code_r[7:0]), .fp32_out(result),
