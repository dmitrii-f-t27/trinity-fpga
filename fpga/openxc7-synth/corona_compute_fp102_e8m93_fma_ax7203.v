...
module corona_compute_fp102_e8m93_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[101];
    wire [7:0] f_exp_a = fmt_a_a[100:93];
    ...
    wire f_sign_b = fmt_b_b[101];
    wire [7:0] f_exp_b = fmt_b_b[100:93];
    ...
    wire f_sign_c = fmt_c_c[101];
    wire [7:0] f_exp_c = fmt_c_c[100:93];
