...
`timescale 1ns / 1ps
// corona_compute_fp8_e5m2_alu_ax7203 — FP8_E5M2 ALU on AX7203.
module corona_compute_fp8_e5m2_alu_ax7203 (
    ...
    wire add_irdy,add_ovld; wire [7:0] add_res;
    wire mul_irdy,mul_ovld; wire [7:0] mul_res;
