...
`timescale 1ns / 1ps
// corona_decode_ibm_hfp64_ax7203 — IBM HFP double (64-bit) decode on AX7203.
// 64-bit decode frame: AA 55 fmt code[0..7] trig (12 bytes) -> A5 FP32 LE.
module corona_decode_ibm_hfp64_ax7203 (
    ...
    ibm_hfp64_decode u_dec (.ibm_in(code_r[63:0]), .fp32_out(result), .is_zero(is_zero));
    assign led[2] = |result;
