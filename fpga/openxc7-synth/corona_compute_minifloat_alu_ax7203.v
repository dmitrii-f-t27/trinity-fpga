...
`timescale 1ns / 1ps
// corona_compute_minifloat_alu_ax7203 — MINIFLOAT ALU on AX7203.
module corona_compute_minifloat_alu_ax7203 (
    ...
    wire cs=fp32_result[31]; wire [7:0] ce=fp32_result[30:23]; wire [22:0] cm=fp32_result[22:0];
    wire [8:0] mf_e={1'b0,ce}-9'd124;
    reg [7:0] mf_result;
    always @(*) begin
        if(fp32_result==32'h0) mf_result=8'h00;
        else if(fp32_result==32'h7FC00000) mf_result=8'h7F;
        else if(fp32_result[30:23]>=8'd131) mf_result={cs,3'd6,4'd8};
    ...
    always @(posedge mclk or posedge rst) begin
        if(rst) begin result_reg<=0;result_ready<=0; end
            ...
            if(ovld) result_reg<={24'b0,mf_result};
        end
    end
