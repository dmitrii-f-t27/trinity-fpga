...
module corona_compute_fp29_e8m20_fma_ax7203 (
    ...
    wire f_sign_a = fmt_a_a[28];
    wire [7:0] f_exp_a = fmt_a_a[27:20];
    wire [19:0] f_mant_a = fmt_a_a[19:0];
    ...
    wire f_sign_b = fmt_b_b[28];
    wire [7:0] f_exp_b = fmt_b_b[27:20];
    wire [19:0] f_mant_b = fmt_b_b[19:0];
    ...
    wire f_sign_c = fmt_c_c[28];
    wire [7:0] f_exp_c = fmt_c_c[27:20];
    wire [19:0] f_mant_c = fmt_c_c[19:0];
