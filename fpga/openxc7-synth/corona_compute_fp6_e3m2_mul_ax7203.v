...
`timescale 1ns / 1ps
// corona_compute_fp6_e3m2_mul_ax7203 — FP6_E3M2 MUL on AX7203.
module corona_compute_fp6_e3m2_mul_ax7203 (
    ...
    gf_mul_param #(.EXP_BITS(3),.MANT_BITS(2),.HAS_INF(0)) u_comp (
