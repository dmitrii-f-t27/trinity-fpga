...
`timescale 1ns / 1ps
// gf8_clean_ax7203 — GF8 ADD compute-conformance (GoldenFloat8: 1S+3E+4M).
// gf_adder_param #(3,4) for 8-bit GF8 operands (low 8 bits of 16-bit protocol word).
module gf8_clean_ax7203 (
    ...
    wire [7:0] add_a=op_a[7:0]; wire [7:0] add_b=op_b[7:0];
