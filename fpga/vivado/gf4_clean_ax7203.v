...
`timescale 1ns / 1ps
// gf4_clean_ax7203 — GF4 ADD compute-conformance (GoldenFloat4: 1S+1E+2M).
// Same UART/RX/TX/frame as gf16_clean, but uses gf_adder_param #(1,2) for
