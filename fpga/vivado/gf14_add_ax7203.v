...
`timescale 1ns / 1ps
// gf14_add_ax7203 — GF14 ADD compute-conformance (GoldenFloat14: 1S+5E+8M, HAS_INF=0).
// Same 16-bit UART/RX/TX/frame as gf16_sub, but 14-bit operands (code[13:0]),
// no sign flip (ADD), and gf_adder_param #(5,8). Golden = gf_ref.gf_add(GF14, a, b).
module gf14_add_ax7203 (
    ...
    // GF14 ADD (no sign flip): 14-bit operands.
    wire [13:0] add_a = op_a[13:0];
    wire [13:0] add_b = op_b[13:0];
