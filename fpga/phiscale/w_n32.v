...
module w_n32 (input wire clk, input wire rst_n, output wire [3:0] led);
  // 320-bit LFSR: N=32 needs 32*8 = 256 bits of sample plus 64 of weight.
  // The first version used a 128-bit register and sliced lf[255:0] from it.
