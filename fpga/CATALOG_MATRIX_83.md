...
- **Total Tier-E HW (rigorous, §1.1): 65/83** (decode 35 + compute 30; 2026-07-02). Remaining HW needs NEW RTL: decimal32/64/128 (BID wide-datapath C×10^exp→FP32), double_double/quad_double (multi-component FP); takum16/32/64 need libtakum (unavailable locally); ~15 structural formats unreachable. **Honest HW ceiling ≈ 65 + hard-RTL investment. SW-bitexact = 69/83** (t27 PRs merged).
