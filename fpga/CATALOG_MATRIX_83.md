...
- **Total Tier-E HW (rigorous, §1.1): 69/83** (decode 39 + compute 30; 2026-07-02). **decimal64 + decimal32 + double_double + takum16 PROVEN on HW** (4 track-b templates: decimal table+multiply, FP-add->FP32, BRAM-LUT; heap+sa routing + -nodsp). Remaining: quad_double (core draft), decimal128. ~15 structural formats unreachable; takum32/64 need witnesses. **SW-bitexact = 69/83** (t27 PRs merged).
