...
- **Total Tier-E HW (rigorous, §1.1): 66/83** (decode 36 + compute 30; 2026-07-02). **decimal64 PROVEN on HW** (first track-b new-RTL cell; BID table+multiply, heap+sa routing + -nodsp) → track-b IS viable on openXC7. Remaining new-RTL now pursuable: decimal32 (synthing), decimal128, double_double/quad_double, takum16 (BRAM-LUT). ~15 structural formats still unreachable; takum32/64 need witnesses. **SW-bitexact = 69/83** (t27 PRs merged).
