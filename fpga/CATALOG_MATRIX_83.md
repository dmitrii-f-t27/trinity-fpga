...
- **Total Tier-E HW (rigorous, §1.1): 70/83** (decode 40 + compute 30; 2026-07-02). **decimal64 + decimal32 + double_double + takum16 + quad_double PROVEN on HW** (5 track-b cells; 3 templates: decimal table+multiply, FP-add->FP32, BRAM-LUT). Remaining: decimal128 (~400-bit, openXC7-routing-risky). ~15 structural unreachable; takum32/64 need witnesses. **SW-bitexact = 69/83** (t27 PRs merged).
