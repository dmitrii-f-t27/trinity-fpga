...
- **Total Tier-E HW (rigorous, §1.1): 68/83** (decode 38 + compute 30; 2026-07-02). **decimal64 + decimal32 + double_double PROVEN on HW** (3 track-b templates: decimal table+multiply, FP-add->FP32; heap+sa routing + -nodsp). Remaining: takum16 (BRAM-LUT, synthing), quad_double, decimal128. ~15 structural formats unreachable; takum32/64 need witnesses. **SW-bitexact = 69/83** (t27 PRs merged).
