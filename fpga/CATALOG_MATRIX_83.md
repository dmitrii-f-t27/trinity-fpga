...
- **Total Tier-E HW (rigorous, §1.1): 67/83** (decode 37 + compute 30; 2026-07-02). **decimal64 + decimal32 PROVEN on HW** (track-b BID table+multiply, heap+sa routing + -nodsp) → track-b IS viable on openXC7. Remaining new-RTL now pursuable: decimal128, double_double/quad_double, takum16 (BRAM-LUT). ~15 structural formats still unreachable; takum32/64 need witnesses. **SW-bitexact = 69/83** (t27 PRs merged).
